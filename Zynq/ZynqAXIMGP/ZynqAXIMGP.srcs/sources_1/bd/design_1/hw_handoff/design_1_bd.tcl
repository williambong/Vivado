...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.PCW_QSPI_GRP_IO1_ENABLE {1} CONFIG.PCW_USE_M_AXI_GP1 {1} CONFIG.PCW_USE_S_AXI_GP1 {0} CONFIG.preset {ZC706}  ] $processing_system7_0

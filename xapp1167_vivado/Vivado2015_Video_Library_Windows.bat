@echo off
set VIVADO_HLS_HOME=C:\opt\winprog\Xilinx\Vivado_HLS\2015.2
set VIVADO_HOME=C:\opt\winprog\Xilinx\Vivado\2015.2

call %VIVADO_HOME%\settings64.bat
PATH=%VIVADO_HLS_HOME%\bin;%VIVADO_HLS_HOME%\msys\bin;%PATH%
rem PATH=%PATH%;%VIVADO_HLS_HOME%\Win_x86\tools\opencv
PATH=%PATH%;%VIVADO_HLS_HOME%\win64\tools\opencv

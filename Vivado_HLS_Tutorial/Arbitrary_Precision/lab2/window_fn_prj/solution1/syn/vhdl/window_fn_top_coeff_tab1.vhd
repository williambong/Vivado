...
entity window_fn_top_coeff_tab1_rom is 
    generic(
             dwidth     : integer := 17; 
             awidth     : integer := 5; 
             mem_size    : integer := 32
...
architecture rtl of window_fn_top_coeff_tab1_rom is 
...
entity window_fn_top_coeff_tab1 is
    generic (
...
architecture arch of window_fn_top_coeff_tab1 is
    component window_fn_top_coeff_tab1_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    window_fn_top_coeff_tab1_rom_U :  component window_fn_top_coeff_tab1_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,

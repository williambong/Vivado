...
#ifndef __window_fn_top_mul_17ns_8s_24_3__HH__
#define __window_fn_top_mul_17ns_8s_24_3__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(window_fn_top_mul_17ns_8s_24_3) {
    ...
    SC_CTOR(window_fn_top_mul_17ns_8s_24_3):  ACMP_mul_us_U ("ACMP_mul_us_U") {

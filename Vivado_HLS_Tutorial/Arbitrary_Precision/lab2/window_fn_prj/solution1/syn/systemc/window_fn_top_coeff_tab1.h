...
#ifndef __window_fn_top_coeff_tab1_H__
#define __window_fn_top_coeff_tab1_H__
...
struct window_fn_top_coeff_tab1_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(window_fn_top_coeff_tab1_ram) {
...
SC_MODULE(window_fn_top_coeff_tab1) {
...
window_fn_top_coeff_tab1_ram* meminst;


SC_CTOR(window_fn_top_coeff_tab1) {
meminst = new window_fn_top_coeff_tab1_ram("window_fn_top_coeff_tab1_ram");

; ModuleID = 'D:/opt/source/Vivado/Vivado_HLS_Tutorial/Introduction/lab1/fir_prj/solution1/.autopilot/db/a.o.3.bc'
...
; <label>:4                                       ; preds = %2
  %tmp_7 = trunc i5 %i to i4, !dbg !38            ; [#uses=1 type=i4] [debug line = 60:26]
  %tmp_2 = add i4 -1, %tmp_7, !dbg !49            ; [#uses=1 type=i4] [debug line = 65:4]
  %tmp_3 = zext i4 %tmp_2 to i64, !dbg !49        ; [#uses=1 type=i64] [debug line = 65:4]
...
!20 = metadata !{i32 786473, metadata !"fir.c", metadata !"d:/opt/source/Vivado/Vivado_HLS_Tutorial/Introduction/lab1", null} ; [ DW_TAG_file_type ]

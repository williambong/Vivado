; ModuleID = 'D:/opt/source/Vivado/Vivado_HLS_Tutorial/Introduction/lab1/fir_prj/solution1/.autopilot/db/a.o.2.bc'
...
; <label>:5                                       ; preds = %3
  %tmp.2 = add i4 %i.cast1, -1, !dbg !54          ; [#uses=1 type=i4] [debug line = 65:4]
  %tmp.3 = zext i4 %tmp.2 to i64, !dbg !54        ; [#uses=1 type=i64] [debug line = 65:4]
...
!0 = metadata !{i32 786449, i32 0, i32 1, metadata !"D:/opt/source/Vivado/Vivado_HLS_Tutorial/Introduction/lab1/fir_prj/solution1/.autopilot/db/fir.pragma.2.c", metadata !"d:/opt/source/Vivado/Vivado_HLS_Tutorial/Introduction/lab1", metadata !"clang version 3.1 ", i1 true, i1 false, metadata !"", i32 0, null, null, null, metadata !1} ; [ DW_TAG_compile_unit ]
...
!5 = metadata !{i32 786473, metadata !"fir.c", metadata !"d:/opt/source/Vivado/Vivado_HLS_Tutorial/Introduction/lab1", null} ; [ DW_TAG_file_type ]

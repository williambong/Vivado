...
fir::fir(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    fir_mul_32s_32s_32_6_U0->din0(grp_fu_173_p0);
    fir_mul_32s_32s_32_6_U0->din1(grp_fu_173_p1);
    fir_mul_32s_32s_32_6_U0->ce(grp_fu_173_ce);
    fir_mul_32s_32s_32_6_U0->dout(grp_fu_173_p2);
    ...
    sc_trace(mVcdFile, i_cast_reg_191, "i_cast_reg_191");
...
void fir::thread_ap_clk_no_reset_() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st9_fsm_8.read())) {
        acc_reg_91 = acc_1_fu_179_p2.read();
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st3_fsm_2.read()) && 
         esl_seteq<1,1,1>(tmp_1_reg_200.read(), ap_const_lv1_0))) {
    ...
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st9_fsm_8.read())) {
        i_reg_104 = i_1_reg_219.read();
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st1_fsm_0.read()) && 
                !esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_0))) {
        i_reg_104 = ap_const_lv5_A;
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st3_fsm_2.read())) {
        i_1_reg_219 = i_1_fu_167_p2.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st2_fsm_1.read())) {
        i_cast_reg_191 = i_cast_fu_126_p1.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st2_fsm_1.read()) && esl_seteq<1,1,1>(tmp_fu_130_p3.read(), ap_const_lv1_0))) {
        tmp_1_reg_200 = tmp_1_fu_138_p2.read();
    }
}

void fir::thread_acc_1_fu_179_p2() {
    acc_1_fu_179_p2 = (!grp_fu_173_p2.read().is_01() || !acc_reg_91.read().is_01())? sc_lv<32>(): (sc_bigint<32>(grp_fu_173_p2.read()) + sc_biguint<32>(acc_reg_91.read()));
}
...
void fir::thread_ap_sig_bdd_82() {
    ap_sig_bdd_82 = esl_seteq<1,1,1>(ap_const_lv1_1, ap_CS_fsm.read().range(2, 2));
}
...
void fir::thread_tmp_4_fu_159_p1() {
    tmp_4_fu_159_p1 = esl_zext<64,32>(i_cast_reg_191.read());
}

void fir::thread_tmp_5_fu_163_p1() {
    tmp_5_fu_163_p1 = esl_zext<64,32>(i_cast_reg_191.read());
}

...
fir::fir(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    fir_mul_32s_32s_32_3_U0->din0(grp_fu_173_p0);
    fir_mul_32s_32s_32_3_U0->din1(grp_fu_173_p1);
    fir_mul_32s_32s_32_3_U0->ce(grp_fu_173_ce);
    fir_mul_32s_32s_32_3_U0->dout(grp_fu_173_p2);

    SC_METHOD(thread_ap_clk_no_reset_);
    dont_initialize();
    sensitive << ( ap_clk.pos() );

    SC_METHOD(thread_acc_1_fu_178_p2);
    sensitive << ( tmp_6_reg_227 );
    ...
    SC_METHOD(thread_i_cast_fu_126_p1);
    sensitive << ( i_reg_104 );
    ...
    sensitive << ( tmp_fu_130_p3 );
    sensitive << ( ap_sig_cseq_ST_st3_fsm_2 );
    sensitive << ( tmp_3_fu_154_p1 );
    sensitive << ( tmp_4_fu_159_p1 );
    ...
    sensitive << ( tmp_7_fu_144_p1 );

    SC_METHOD(thread_tmp_3_fu_154_p1);
    sensitive << ( tmp_2_fu_148_p2 );

    SC_METHOD(thread_tmp_4_fu_159_p1);
    sensitive << ( i_cast_reg_189 );

    SC_METHOD(thread_tmp_5_fu_163_p1);
    sensitive << ( i_cast_reg_189 );

    SC_METHOD(thread_tmp_7_fu_144_p1);
    sensitive << ( i_reg_104 );
    ...
    sc_trace(mVcdFile, i_cast_fu_126_p1, "i_cast_fu_126_p1");
    sc_trace(mVcdFile, i_cast_reg_189, "i_cast_reg_189");
    ...
    sc_trace(mVcdFile, tmp_3_fu_154_p1, "tmp_3_fu_154_p1");
    sc_trace(mVcdFile, tmp_4_fu_159_p1, "tmp_4_fu_159_p1");
    sc_trace(mVcdFile, tmp_5_fu_163_p1, "tmp_5_fu_163_p1");
    sc_trace(mVcdFile, tmp_7_fu_144_p1, "tmp_7_fu_144_p1");
...
void fir::thread_ap_clk_no_reset_() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st8_fsm_7.read())) {
        acc_reg_91 = acc_1_fu_178_p2.read();
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st3_fsm_2.read()) && 
         esl_seteq<1,1,1>(tmp_1_reg_198.read(), ap_const_lv1_0))) {
        data1_reg_116 = shift_reg_q0.read();
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st2_fsm_1.read()) && 
                esl_seteq<1,1,1>(tmp_fu_130_p3.read(), ap_const_lv1_0) && 
                !esl_seteq<1,1,1>(tmp_1_fu_138_p2.read(), ap_const_lv1_0))) {
        data1_reg_116 = x.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st8_fsm_7.read())) {
        i_reg_104 = i_1_reg_217.read();
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st1_fsm_0.read()) && 
                !esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_0))) {
        i_reg_104 = ap_const_lv5_A;
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st4_fsm_3.read())) {
        c_load_reg_222 = c_q0.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st3_fsm_2.read())) {
        i_1_reg_217 = i_1_fu_167_p2.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st2_fsm_1.read())) {
        i_cast_reg_189 = i_cast_fu_126_p1.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st2_fsm_1.read()) && esl_seteq<1,1,1>(tmp_fu_130_p3.read(), ap_const_lv1_0))) {
        tmp_1_reg_198 = tmp_1_fu_138_p2.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st7_fsm_6.read())) {
        tmp_6_reg_227 = grp_fu_173_p2.read();
    }
}

void fir::thread_acc_1_fu_178_p2() {
    acc_1_fu_178_p2 = (!tmp_6_reg_227.read().is_01() || !acc_reg_91.read().is_01())? sc_lv<32>(): (sc_bigint<32>(tmp_6_reg_227.read()) + sc_biguint<32>(acc_reg_91.read()));
}
...
void fir::thread_c_address0() {
    c_address0 =  (sc_lv<4>) (tmp_5_fu_163_p1.read());
}
...
void fir::thread_grp_fu_173_ce() {
    grp_fu_173_ce = ap_const_logic_1;
}

void fir::thread_grp_fu_173_p0() {
    grp_fu_173_p0 = c_load_reg_222.read();
}

void fir::thread_grp_fu_173_p1() {
    grp_fu_173_p1 = data1_reg_116.read();
}

void fir::thread_i_1_fu_167_p2() {
    i_1_fu_167_p2 = (!i_reg_104.read().is_01() || !ap_const_lv5_1F.is_01())? sc_lv<5>(): (sc_biguint<5>(i_reg_104.read()) + sc_bigint<5>(ap_const_lv5_1F));
}

void fir::thread_i_cast_fu_126_p1() {
    i_cast_fu_126_p1 = esl_sext<32,5>(i_reg_104.read());
}

void fir::thread_shift_reg_address0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st3_fsm_2.read())) {
        shift_reg_address0 =  (sc_lv<4>) (tmp_4_fu_159_p1.read());
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st2_fsm_1.read()) && 
                esl_seteq<1,1,1>(tmp_fu_130_p3.read(), ap_const_lv1_0) && 
                !esl_seteq<1,1,1>(tmp_1_fu_138_p2.read(), ap_const_lv1_0))) {
        shift_reg_address0 = ap_const_lv4_0;
                ...
                esl_seteq<1,1,1>(tmp_fu_130_p3.read(), ap_const_lv1_0) && 
                esl_seteq<1,1,1>(tmp_1_fu_138_p2.read(), ap_const_lv1_0))) {
        shift_reg_address0 =  (sc_lv<4>) (tmp_3_fu_154_p1.read());
    } else {
...
void fir::thread_tmp_1_fu_138_p2() {
    tmp_1_fu_138_p2 = (!i_reg_104.read().is_01() || !ap_const_lv5_0.is_01())? sc_lv<1>(): sc_lv<1>(i_reg_104.read() == ap_const_lv5_0);
}

void fir::thread_tmp_2_fu_148_p2() {
    tmp_2_fu_148_p2 = (!ap_const_lv4_F.is_01() || !tmp_7_fu_144_p1.read().is_01())? sc_lv<4>(): (sc_bigint<4>(ap_const_lv4_F) + sc_biguint<4>(tmp_7_fu_144_p1.read()));
}

void fir::thread_tmp_3_fu_154_p1() {
    tmp_3_fu_154_p1 = esl_zext<64,4>(tmp_2_fu_148_p2.read());
}

void fir::thread_tmp_4_fu_159_p1() {
    tmp_4_fu_159_p1 = esl_zext<64,32>(i_cast_reg_189.read());
}

void fir::thread_tmp_5_fu_163_p1() {
    tmp_5_fu_163_p1 = esl_zext<64,32>(i_cast_reg_189.read());
}

void fir::thread_tmp_7_fu_144_p1() {
    tmp_7_fu_144_p1 = i_reg_104.read().range(4-1, 0);
}

void fir::thread_tmp_fu_130_p3() {
    tmp_fu_130_p3 = i_reg_104.read().range(4, 4);
}
...
void fir::thread_ap_NS_fsm() {
    switch (ap_CS_fsm.read().to_uint64()) {
        case 1 : 
            ...
            break;
        case 2 : 
            if (!esl_seteq<1,1,1>(tmp_fu_130_p3.read(), ap_const_lv1_0)) {
                ap_NS_fsm = ap_ST_st1_fsm_0;
            } else {

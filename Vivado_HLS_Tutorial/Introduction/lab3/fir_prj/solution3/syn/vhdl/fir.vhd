...
architecture behav of fir is 
    ...
    "fir,hls_ip_2015_2,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7k160tfbg484-2,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.430000,HLS_SYN_LAT=15,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=44,HLS_SYN_FF=977,HLS_SYN_LUT=253}";
...
begin
    fir_mul_32s_32s_32_3_U0 : component fir_mul_32s_32s_32_3
    generic map (
        ID => 1,
        NUM_STAGE => 3,
        din0_WIDTH => 32,
    ...
    grp_fu_208_p0 <= reg_188;
    grp_fu_208_p1 <= shift_reg_9;
    grp_fu_224_ce <= ap_const_logic_1;
    grp_fu_224_p0 <= reg_192;
    grp_fu_224_p1 <= shift_reg_8;
    grp_fu_240_ce <= ap_const_logic_1;
    grp_fu_240_p0 <= reg_196;
    grp_fu_240_p1 <= shift_reg_7;
    grp_fu_256_ce <= ap_const_logic_1;
    grp_fu_256_p0 <= reg_200;
    grp_fu_256_p1 <= shift_reg_6;
    grp_fu_272_ce <= ap_const_logic_1;
    grp_fu_272_p0 <= reg_188;
    grp_fu_272_p1 <= shift_reg_5;
    grp_fu_292_ce <= ap_const_logic_1;
    grp_fu_292_p0 <= reg_192;
    grp_fu_292_p1 <= shift_reg_4;
    grp_fu_308_ce <= ap_const_logic_1;
    grp_fu_308_p0 <= c_load_6_reg_491;
    grp_fu_308_p1 <= shift_reg_3;
    grp_fu_323_ce <= ap_const_logic_1;
    grp_fu_323_p0 <= reg_188;
    grp_fu_323_p1 <= shift_reg_2;

    -- grp_fu_348_ce assign process. --
    grp_fu_348_ce_assign_proc : process(x_ap_vld_in_sig, ap_sig_cseq_ST_st13_fsm_12, ap_sig_cseq_ST_st15_fsm_14, ap_sig_cseq_ST_st14_fsm_13)
    begin
    ...
    grp_fu_348_p0 <= reg_196;
    grp_fu_348_p1 <= shift_reg_1;

    -- grp_fu_364_ce assign process. --
    grp_fu_364_ce_assign_proc : process(x_ap_vld_in_sig, ap_sig_cseq_ST_st13_fsm_12, ap_sig_cseq_ST_st15_fsm_14, ap_sig_cseq_ST_st14_fsm_13)
    begin
        if ((((ap_const_logic_1 = ap_sig_cseq_ST_st13_fsm_12) and not((x_ap_vld_in_sig = ap_const_logic_0))) or (ap_const_logic_1 = ap_sig_cseq_ST_st15_fsm_14) or (ap_const_logic_1 = ap_sig_cseq_ST_st14_fsm_13))) then 
    ...
    grp_fu_364_p0 <= reg_200;
    grp_fu_364_p1 <= shift_reg_0;

    -- grp_fu_376_ce assign process. --
    grp_fu_376_ce_assign_proc : process(x_ap_vld_in_sig, ap_sig_cseq_ST_st13_fsm_12, ap_sig_cseq_ST_st15_fsm_14, ap_sig_cseq_ST_st14_fsm_13)
    begin
        if ((((ap_const_logic_1 = ap_sig_cseq_ST_st13_fsm_12) and not((x_ap_vld_in_sig = ap_const_logic_0))) or (ap_const_logic_1 = ap_sig_cseq_ST_st15_fsm_14) or (ap_const_logic_1 = ap_sig_cseq_ST_st14_fsm_13))) then 
    ...
    grp_fu_376_p0 <= reg_188;
    grp_fu_376_p1 <= x_in_sig;
    tmp1_fu_278_p2 <= std_logic_vector(signed(tmp_6_1_reg_456) + signed(tmp_6_reg_451));
    tmp2_fu_333_p2 <= std_logic_vector(signed(tmp3_fu_329_p2) + signed(tmp_6_2_reg_501));
    tmp3_fu_329_p2 <= std_logic_vector(signed(tmp_6_3_reg_506) + signed(tmp_6_4_reg_511));
    tmp4_fu_403_p2 <= std_logic_vector(signed(tmp7_fu_398_p2) + signed(tmp5_fu_390_p2));
    tmp5_fu_390_p2 <= std_logic_vector(signed(tmp6_reg_581) + signed(tmp_6_5_reg_551));
    tmp6_fu_382_p2 <= std_logic_vector(signed(tmp_6_6_reg_556) + signed(tmp_6_7_reg_561));
    tmp7_fu_398_p2 <= std_logic_vector(signed(tmp8_fu_394_p2) + signed(tmp_6_8_reg_586));
    tmp8_fu_394_p2 <= std_logic_vector(signed(tmp_6_9_reg_591) + signed(tmp_6_s_reg_596));
    tmp_fu_386_p2 <= std_logic_vector(signed(tmp2_reg_541) + signed(tmp1_reg_486));
    ...
    y <= std_logic_vector(signed(tmp4_fu_403_p2) + signed(tmp_fu_386_p2));

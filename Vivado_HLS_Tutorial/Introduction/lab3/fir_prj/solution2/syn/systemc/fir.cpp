...
fir::fir(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    fir_mul_32s_32s_32_3_U0->din0(grp_fu_185_p0);
    fir_mul_32s_32s_32_3_U0->din1(grp_fu_185_p1);
    fir_mul_32s_32s_32_3_U0->ce(grp_fu_185_ce);
    fir_mul_32s_32s_32_3_U0->dout(grp_fu_185_p2);

    SC_METHOD(thread_ap_clk_no_reset_);
    dont_initialize();
    sensitive << ( ap_clk.pos() );

    SC_METHOD(thread_acc_1_fu_190_p2);
    ...
    sensitive << ( ap_sig_cseq_ST_st2_fsm_1 );
    sensitive << ( tmp_1_fu_150_p2 );
    sensitive << ( tmp_fu_142_p3 );
    sensitive << ( ap_sig_cseq_ST_st3_fsm_2 );
    sensitive << ( tmp_3_fu_166_p1 );
    sensitive << ( tmp_4_fu_171_p1 );
    ...
    SC_METHOD(thread_tmp_1_fu_150_p2);
    sensitive << ( ap_sig_cseq_ST_st2_fsm_1 );
    sensitive << ( tmp_fu_142_p3 );
    sensitive << ( i_reg_116 );

    SC_METHOD(thread_tmp_2_fu_160_p2);
    sensitive << ( tmp_7_fu_156_p1 );

    SC_METHOD(thread_tmp_3_fu_166_p1);
    sensitive << ( tmp_2_fu_160_p2 );

    SC_METHOD(thread_tmp_4_fu_171_p1);
    sensitive << ( i_cast_reg_201 );

    SC_METHOD(thread_tmp_5_fu_175_p1);
    sensitive << ( i_cast_reg_201 );

    SC_METHOD(thread_tmp_7_fu_156_p1);
    sensitive << ( i_reg_116 );
    ...
    sc_trace(mVcdFile, i_cast_reg_201, "i_cast_reg_201");
    sc_trace(mVcdFile, ap_sig_cseq_ST_st2_fsm_1, "ap_sig_cseq_ST_st2_fsm_1");
    sc_trace(mVcdFile, ap_sig_bdd_74, "ap_sig_bdd_74");
    sc_trace(mVcdFile, tmp_1_fu_150_p2, "tmp_1_fu_150_p2");
    ...
    sc_trace(mVcdFile, c_load_reg_234, "c_load_reg_234");
    ...
    sc_trace(mVcdFile, acc_1_fu_190_p2, "acc_1_fu_190_p2");
    ...
    sc_trace(mVcdFile, tmp_3_fu_166_p1, "tmp_3_fu_166_p1");
    sc_trace(mVcdFile, tmp_4_fu_171_p1, "tmp_4_fu_171_p1");
    sc_trace(mVcdFile, tmp_5_fu_175_p1, "tmp_5_fu_175_p1");
    sc_trace(mVcdFile, tmp_7_fu_156_p1, "tmp_7_fu_156_p1");
    sc_trace(mVcdFile, tmp_2_fu_160_p2, "tmp_2_fu_160_p2");
...
void fir::thread_ap_clk_no_reset_() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st8_fsm_7.read())) {
        acc_reg_103 = acc_1_fu_190_p2.read();
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st3_fsm_2.read()) && 
        ...
        data1_reg_128 = shift_reg_q0.read();
                ...
                esl_seteq<1,1,1>(tmp_fu_142_p3.read(), ap_const_lv1_0) && 
                !esl_seteq<1,1,1>(tmp_1_fu_150_p2.read(), ap_const_lv1_0))) {
        data1_reg_128 = x_in_sig.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st8_fsm_7.read())) {
        i_reg_116 = i_1_reg_229.read();
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st1_fsm_0.read()) && 
                !ap_sig_bdd_64.read())) {
    ...
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st4_fsm_3.read())) {
        c_load_reg_234 = c_q0.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st3_fsm_2.read())) {
        i_1_reg_229 = i_1_fu_179_p2.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st2_fsm_1.read())) {
        i_cast_reg_201 = i_cast_fu_138_p1.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st2_fsm_1.read()) && esl_seteq<1,1,1>(tmp_fu_142_p3.read(), ap_const_lv1_0))) {
        tmp_1_reg_210 = tmp_1_fu_150_p2.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st7_fsm_6.read())) {
        tmp_6_reg_239 = grp_fu_185_p2.read();
    }
}

void fir::thread_acc_1_fu_190_p2() {
    acc_1_fu_190_p2 = (!tmp_6_reg_239.read().is_01() || !acc_reg_103.read().is_01())? sc_lv<32>(): (sc_bigint<32>(tmp_6_reg_239.read()) + sc_biguint<32>(acc_reg_103.read()));
}
...
void fir::thread_c_address0() {
    c_address0 =  (sc_lv<4>) (tmp_5_fu_175_p1.read());
}
...
void fir::thread_grp_fu_185_ce() {
    grp_fu_185_ce = ap_const_logic_1;
}

void fir::thread_grp_fu_185_p0() {
    grp_fu_185_p0 = c_load_reg_234.read();
}

void fir::thread_grp_fu_185_p1() {
    grp_fu_185_p1 = data1_reg_128.read();
}

void fir::thread_i_1_fu_179_p2() {
    i_1_fu_179_p2 = (!i_reg_116.read().is_01() || !ap_const_lv5_1F.is_01())? sc_lv<5>(): (sc_biguint<5>(i_reg_116.read()) + sc_bigint<5>(ap_const_lv5_1F));
}

void fir::thread_i_cast_fu_138_p1() {
    i_cast_fu_138_p1 = esl_sext<32,5>(i_reg_116.read());
}

void fir::thread_shift_reg_address0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st3_fsm_2.read())) {
        shift_reg_address0 =  (sc_lv<4>) (tmp_4_fu_171_p1.read());
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st2_fsm_1.read()) && 
                esl_seteq<1,1,1>(tmp_fu_142_p3.read(), ap_const_lv1_0) && 
                !esl_seteq<1,1,1>(tmp_1_fu_150_p2.read(), ap_const_lv1_0))) {
        shift_reg_address0 = ap_const_lv4_0;
                ...
                esl_seteq<1,1,1>(tmp_fu_142_p3.read(), ap_const_lv1_0) && 
                esl_seteq<1,1,1>(tmp_1_fu_150_p2.read(), ap_const_lv1_0))) {
        shift_reg_address0 =  (sc_lv<4>) (tmp_3_fu_166_p1.read());
    } else {
...
void fir::thread_tmp_1_fu_150_p2() {
    tmp_1_fu_150_p2 = (!i_reg_116.read().is_01() || !ap_const_lv5_0.is_01())? sc_lv<1>(): sc_lv<1>(i_reg_116.read() == ap_const_lv5_0);
}

void fir::thread_tmp_2_fu_160_p2() {
    tmp_2_fu_160_p2 = (!ap_const_lv4_F.is_01() || !tmp_7_fu_156_p1.read().is_01())? sc_lv<4>(): (sc_bigint<4>(ap_const_lv4_F) + sc_biguint<4>(tmp_7_fu_156_p1.read()));
}

void fir::thread_tmp_3_fu_166_p1() {
    tmp_3_fu_166_p1 = esl_zext<64,4>(tmp_2_fu_160_p2.read());
}

void fir::thread_tmp_4_fu_171_p1() {
    tmp_4_fu_171_p1 = esl_zext<64,32>(i_cast_reg_201.read());
}

void fir::thread_tmp_5_fu_175_p1() {
    tmp_5_fu_175_p1 = esl_zext<64,32>(i_cast_reg_201.read());
}

void fir::thread_tmp_7_fu_156_p1() {
    tmp_7_fu_156_p1 = i_reg_116.read().range(4-1, 0);
}

void fir::thread_tmp_fu_142_p3() {
    tmp_fu_142_p3 = i_reg_116.read().range(4, 4);
}
...
void fir::thread_ap_NS_fsm() {
    switch (ap_CS_fsm.read().to_uint64()) {
        case 1 : 
            ...
            break;
        case 2 : 
            if (!esl_seteq<1,1,1>(tmp_fu_142_p3.read(), ap_const_lv1_0)) {
                ap_NS_fsm = ap_ST_st1_fsm_0;
            } else {

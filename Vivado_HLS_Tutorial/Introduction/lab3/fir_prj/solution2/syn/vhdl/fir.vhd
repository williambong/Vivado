...
architecture behav of fir is 
    ...
    "fir,hls_ip_2015_2,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7k160tfbg484-2,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.430000,HLS_SYN_LAT=78,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=4,HLS_SYN_FF=276,HLS_SYN_LUT=193}";
    ...
    signal i_cast_reg_201 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal i_1_reg_229 : STD_LOGIC_VECTOR (4 downto 0);
    signal c_load_reg_234 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_sig_cseq_ST_st4_fsm_3 : STD_LOGIC;
    signal ap_sig_bdd_107 : BOOLEAN;
    signal grp_fu_185_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_6_reg_239 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((ap_const_logic_1 = ap_sig_cseq_ST_st1_fsm_0) and not(ap_sig_bdd_64))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_sig_cseq_ST_st3_fsm_2) and (tmp_1_reg_210 = ap_const_lv1_0))) then 
    ...
    ap_NS_fsm_assign_proc : process (ap_CS_fsm, ap_sig_bdd_64, tmp_fu_142_p3)
    begin
        case ap_CS_fsm is
    ...
    acc_1_fu_190_p2 <= std_logic_vector(signed(tmp_6_reg_239) + signed(acc_reg_103));
    ...
    begin
                ap_sig_bdd_172 <= (ap_const_lv1_1 = ap_CS_fsm(4 downto 4));
    end process;
    ...
    ap_sig_bdd_64_assign_proc : process(ap_start, x_ap_vld_in_sig)
    begin
                ap_sig_bdd_64 <= ((x_ap_vld_in_sig = ap_const_logic_0) or (ap_start = ap_const_logic_0));
    end process;
    ...
    ap_sig_cseq_ST_st5_fsm_4_assign_proc : process(ap_sig_bdd_172)
    begin
    ...
    grp_fu_185_p0 <= c_load_reg_234;
    grp_fu_185_p1 <= data1_reg_128;
    ...
    shift_reg_we0_assign_proc : process(ap_sig_cseq_ST_st2_fsm_1, tmp_1_fu_150_p2, tmp_1_reg_210, tmp_fu_142_p3, ap_sig_cseq_ST_st3_fsm_2)
    begin
        if ((((ap_const_logic_1 = ap_sig_cseq_ST_st3_fsm_2) and (tmp_1_reg_210 = ap_const_lv1_0)) or ((ap_const_logic_1 = ap_sig_cseq_ST_st2_fsm_1) and (tmp_fu_142_p3 = ap_const_lv1_0) and not((tmp_1_fu_150_p2 = ap_const_lv1_0))))) then 
    ...
    tmp_4_fu_171_p1 <= std_logic_vector(resize(unsigned(i_cast_reg_201),64));
    tmp_5_fu_175_p1 <= std_logic_vector(resize(unsigned(i_cast_reg_201),64));

...
printf("\n\{ BEGIN @main\n");
if (AESL_DEBUG_TRACE)
printf("\n  %%1 = tail call i32 @adders(i32 10, i32 20, i32 30) nounwind, !dbg !1 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_17_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%2 = tail call %%struct._iobuf* @__iob_func() nounwind, !dbg !1 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_21_count);
  llvm_cbe_tmp__2 = (l_struct_OC__iobuf *) /*tail*/ __iob_func();
if (AESL_DEBUG_TRACE) {
printf("\nReturn  = 0x%X",llvm_cbe_tmp__2);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%3 = getelementptr inbounds %%struct._iobuf* %%2, i64 1, !dbg !1 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_22_count);
  llvm_cbe_tmp__3 = (l_struct_OC__iobuf *)(&llvm_cbe_tmp__2[(((signed long long )1ull))]);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  %%4 = tail call i32 (%%struct._iobuf*, i8*, ...)* @fprintf(%%struct._iobuf* %%3, i8* getelementptr inbounds ([16 x i8]* @aesl_internal_.str, i64 0, i64 0), i32 10, i32 20, i32 30, i32 %%1) nounwind, !dbg !1 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_23_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%5 = tail call i32 @adders(i32 20, i32 30, i32 40) nounwind, !dbg !1 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_41_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%6 = tail call %%struct._iobuf* @__iob_func() nounwind, !dbg !1 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_45_count);
  llvm_cbe_tmp__6 = (l_struct_OC__iobuf *) /*tail*/ __iob_func();
if (AESL_DEBUG_TRACE) {
printf("\nReturn  = 0x%X",llvm_cbe_tmp__6);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%7 = getelementptr inbounds %%struct._iobuf* %%6, i64 1, !dbg !1 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_46_count);
  llvm_cbe_tmp__7 = (l_struct_OC__iobuf *)(&llvm_cbe_tmp__6[(((signed long long )1ull))]);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  %%8 = tail call i32 (%%struct._iobuf*, i8*, ...)* @fprintf(%%struct._iobuf* %%7, i8* getelementptr inbounds ([16 x i8]* @aesl_internal_.str, i64 0, i64 0), i32 20, i32 30, i32 40, i32 %%5) nounwind, !dbg !1 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_47_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%9 = tail call i32 @adders(i32 30, i32 40, i32 50) nounwind, !dbg !1 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_65_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%10 = tail call %%struct._iobuf* @__iob_func() nounwind, !dbg !1 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_69_count);
  llvm_cbe_tmp__10 = (l_struct_OC__iobuf *) /*tail*/ __iob_func();
if (AESL_DEBUG_TRACE) {
printf("\nReturn  = 0x%X",llvm_cbe_tmp__10);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%11 = getelementptr inbounds %%struct._iobuf* %%10, i64 1, !dbg !1 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_70_count);
  llvm_cbe_tmp__11 = (l_struct_OC__iobuf *)(&llvm_cbe_tmp__10[(((signed long long )1ull))]);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  %%12 = tail call i32 (%%struct._iobuf*, i8*, ...)* @fprintf(%%struct._iobuf* %%11, i8* getelementptr inbounds ([16 x i8]* @aesl_internal_.str, i64 0, i64 0), i32 30, i32 40, i32 50, i32 %%9) nounwind, !dbg !1 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_71_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%13 = tail call i32 @adders(i32 40, i32 50, i32 60) nounwind, !dbg !1 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_89_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%14 = tail call %%struct._iobuf* @__iob_func() nounwind, !dbg !1 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_93_count);
  llvm_cbe_tmp__14 = (l_struct_OC__iobuf *) /*tail*/ __iob_func();
if (AESL_DEBUG_TRACE) {
printf("\nReturn  = 0x%X",llvm_cbe_tmp__14);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%15 = getelementptr inbounds %%struct._iobuf* %%14, i64 1, !dbg !1 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_94_count);
  llvm_cbe_tmp__15 = (l_struct_OC__iobuf *)(&llvm_cbe_tmp__14[(((signed long long )1ull))]);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  %%16 = tail call i32 (%%struct._iobuf*, i8*, ...)* @fprintf(%%struct._iobuf* %%15, i8* getelementptr inbounds ([16 x i8]* @aesl_internal_.str, i64 0, i64 0), i32 40, i32 50, i32 60, i32 %%13) nounwind, !dbg !1 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_95_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%17 = tail call i32 @adders(i32 50, i32 60, i32 70) nounwind, !dbg !1 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_113_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%18 = tail call %%struct._iobuf* @__iob_func() nounwind, !dbg !1 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_117_count);
  llvm_cbe_tmp__18 = (l_struct_OC__iobuf *) /*tail*/ __iob_func();
if (AESL_DEBUG_TRACE) {
printf("\nReturn  = 0x%X",llvm_cbe_tmp__18);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%19 = getelementptr inbounds %%struct._iobuf* %%18, i64 1, !dbg !1 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_118_count);
  llvm_cbe_tmp__19 = (l_struct_OC__iobuf *)(&llvm_cbe_tmp__18[(((signed long long )1ull))]);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  %%20 = tail call i32 (%%struct._iobuf*, i8*, ...)* @fprintf(%%struct._iobuf* %%19, i8* getelementptr inbounds ([16 x i8]* @aesl_internal_.str, i64 0, i64 0), i32 50, i32 60, i32 70, i32 %%17) nounwind, !dbg !1 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_119_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%25 = tail call i64 @fwrite(i8* getelementptr inbounds ([29 x i8]* @aesl_internal_.str1, i64 0, i64 0), i64 28, i64 1, %%struct._iobuf* %%24), !dbg !3 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_141_count);

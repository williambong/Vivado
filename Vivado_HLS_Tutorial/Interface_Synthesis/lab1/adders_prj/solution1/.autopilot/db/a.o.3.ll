; ModuleID = 'D:/opt/source/Vivado/Vivado_HLS_Tutorial/Interface_Synthesis/lab1/adders_prj/solution1/.autopilot/db/a.o.3.bc'
...
define i32 @adders(i32 %in1, i32 %in2, i32 %in3) nounwind uwtable readnone {
  ...
  call void (...)* @_ssdm_op_SpecInterface(i32 %in3, [8 x i8]* @p_str, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str1, [1 x i8]* @p_str1, [1 x i8]* @p_str1) nounwind, !dbg !33 ; [debug line = 51:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %in2, [8 x i8]* @p_str, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str1, [1 x i8]* @p_str1, [1 x i8]* @p_str1) nounwind, !dbg !35 ; [debug line = 52:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %in1, [8 x i8]* @p_str, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str1, [1 x i8]* @p_str1, [1 x i8]* @p_str1) nounwind, !dbg !36 ; [debug line = 53:1]
  %tmp1 = add i32 %in1_read, %in3_read, !dbg !37  ; [#uses=1 type=i32] [debug line = 58:2]
  %sum = add i32 %tmp1, %in2_read, !dbg !37       ; [#uses=1 type=i32] [debug line = 58:2]
  call void @llvm.dbg.value(metadata !{i32 %sum}, i64 0, metadata !38), !dbg !37 ; [debug line = 58:2] [debug variable = sum]
  ret i32 %sum, !dbg !39                          ; [debug line = 60:2]
}
...
!22 = metadata !{i32 786473, metadata !"adders.c", metadata !"d:/opt/source/Vivado/Vivado_HLS_Tutorial/Interface_Synthesis/lab1", null} ; [ DW_TAG_file_type ]
...
!33 = metadata !{i32 51, i32 1, metadata !34, null}
...
!37 = metadata !{i32 58, i32 2, metadata !34, null}
!38 = metadata !{i32 786688, metadata !34, metadata !"sum", metadata !22, i32 56, metadata !25, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!39 = metadata !{i32 60, i32 2, metadata !34, null}

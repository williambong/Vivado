...
adders::adders(sc_module_name name) : sc_module(name), mVcdFile(0) {
    adders_add_32ns_32ns_32_8_U0 = new adders_add_32ns_32ns_32_8<1,8,32,32,32>("adders_add_32ns_32ns_32_8_U0");
    adders_add_32ns_32ns_32_8_U0->clk(ap_clk);
    adders_add_32ns_32ns_32_8_U0->reset(ap_rst);
    adders_add_32ns_32ns_32_8_U0->din0(grp_fu_40_p0);
    adders_add_32ns_32ns_32_8_U0->din1(grp_fu_40_p1);
    adders_add_32ns_32ns_32_8_U0->ce(grp_fu_40_ce);
    adders_add_32ns_32ns_32_8_U0->dout(grp_fu_40_p2);
    ...
    adders_add_32ns_32ns_32_8_U1->din0(grp_fu_46_p0);
    adders_add_32ns_32ns_32_8_U1->din1(grp_fu_46_p1);
    adders_add_32ns_32ns_32_8_U1->ce(grp_fu_46_ce);
    adders_add_32ns_32ns_32_8_U1->dout(grp_fu_46_p2);
    ...
    SC_METHOD(thread_grp_fu_46_p0);
    sensitive << ( tmp1_reg_61 );
    ...
    sc_trace(mVcdFile, tmp1_reg_61, "tmp1_reg_61");
    ...
    sc_trace(mVcdFile, grp_fu_46_p0, "grp_fu_46_p0");
...
adders::~adders() {
    ...
    delete adders_add_32ns_32ns_32_8_U0;
...
void adders::thread_grp_fu_40_ce() {
    grp_fu_40_ce = ap_const_logic_1;
}

void adders::thread_grp_fu_40_p0() {
    grp_fu_40_p0 = in1.read();
}

void adders::thread_grp_fu_40_p1() {
    grp_fu_40_p1 = in3.read();
}

void adders::thread_grp_fu_46_ce() {
    grp_fu_46_ce = ap_const_logic_1;
}

void adders::thread_grp_fu_46_p0() {
    grp_fu_46_p0 = tmp1_reg_61.read();
}

void adders::thread_grp_fu_46_p1() {
    grp_fu_46_p1 = in2.read();
}

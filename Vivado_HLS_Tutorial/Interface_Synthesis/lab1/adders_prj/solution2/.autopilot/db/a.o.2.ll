; ModuleID = 'D:/opt/source/Vivado/Vivado_HLS_Tutorial/Interface_Synthesis/lab1/adders_prj/solution2/.autopilot/db/a.o.2.bc'
...
define i32 @adders(i32 %in1, i32 %in2, i32 %in3) nounwind uwtable readnone {
  ...
  call void (...)* @_ssdm_op_SpecInterface(i32 0, [13 x i8]* @.str, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !38 ; [debug line = 49:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %in3, [8 x i8]* @.str2, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !40 ; [debug line = 52:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %in2, [8 x i8]* @.str2, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !41 ; [debug line = 53:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %in1, [8 x i8]* @.str2, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !42 ; [debug line = 54:1]
  %tmp1 = add i32 %in3, %in1, !dbg !43            ; [#uses=1 type=i32] [debug line = 59:2]
  %sum = add i32 %tmp1, %in2, !dbg !43            ; [#uses=1 type=i32] [debug line = 59:2]
  call void @llvm.dbg.value(metadata !{i32 %sum}, i64 0, metadata !44), !dbg !43 ; [debug line = 59:2] [debug variable = sum]
  ret i32 %sum, !dbg !45                          ; [debug line = 61:2]
}
...
!38 = metadata !{i32 49, i32 1, metadata !39, null}
...
!42 = metadata !{i32 54, i32 1, metadata !39, null}
!43 = metadata !{i32 59, i32 2, metadata !39, null}
!44 = metadata !{i32 786688, metadata !39, metadata !"sum", metadata !6, i32 57, metadata !9, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!45 = metadata !{i32 61, i32 2, metadata !39, null}

...
if (AESL_DEBUG_TRACE)
printf("\n  %%2 = srem i32 %%storemerge1, 8, !dbg !3 for 0x%I64xth hint within @array_io  --> \n", ++aesl_llvm_cbe_12_count);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  store i32 %%10, i32* %%4, align 4, !dbg !3 for 0x%I64xth hint within @array_io  --> \n", ++aesl_llvm_cbe_27_count);
  *llvm_cbe_tmp__3 = llvm_cbe_tmp__9;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__9);
if (AESL_DEBUG_TRACE)
printf("\n  %%11 = trunc i32 %%10 to i16, !dbg !2 for 0x%I64xth hint within @array_io  --> \n", ++aesl_llvm_cbe_28_count);
  llvm_cbe_tmp__10 = (unsigned short )((unsigned short )llvm_cbe_tmp__9&65535U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__10);
if (AESL_DEBUG_TRACE)
printf("\n  %%12 = getelementptr inbounds i16* %%d_o, i64 %%6, !dbg !2 for 0x%I64xth hint within @array_io  --> \n", ++aesl_llvm_cbe_29_count);
  llvm_cbe_tmp__11 = (signed short *)(&llvm_cbe_d_o[(((signed long long )llvm_cbe_tmp__5))]);
if (AESL_DEBUG_TRACE) {
printf("\n = 0x%I64X",((signed long long )llvm_cbe_tmp__5));
}
if (AESL_DEBUG_TRACE)
printf("\n  store i16 %%11, i16* %%12, align 2, !dbg !2 for 0x%I64xth hint within @array_io  --> \n", ++aesl_llvm_cbe_30_count);
  *llvm_cbe_tmp__11 = llvm_cbe_tmp__10;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__10);
if (AESL_DEBUG_TRACE)
printf("\n  %%13 = add nsw i32 %%storemerge1, 1, !dbg !3 for 0x%I64xth hint within @array_io  --> \n", ++aesl_llvm_cbe_31_count);

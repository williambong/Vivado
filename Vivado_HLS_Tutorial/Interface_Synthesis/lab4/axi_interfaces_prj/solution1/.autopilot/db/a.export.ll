...
@p_str3 = private unnamed_addr constant [9 x i8] c"For_Loop\00", align 1
...
; <label>:1                                       ; preds = %rewind_header, %rewind_init
  ...
  %tmp = call i32 (...)* @_ssdm_op_SpecRegionBegin([9 x i8]* @p_str3) nounwind
  ...
  %empty_2 = call i32 (...)* @_ssdm_op_SpecRegionEnd([9 x i8]* @p_str3, i32 %tmp) nounwind

; ModuleID = 'D:/opt/source/Vivado/Vivado_HLS_Tutorial/Interface_Synthesis/lab4/axi_interfaces_prj/solution2/.autopilot/db/a.g.1.bc'
...
define void @axi_interfaces(i16* %d_o, i16* %d_i) nounwind uwtable {
  ...
  call void (...)* @_ssdm_op_SpecInterface(i32 0, i8* getelementptr inbounds ([10 x i8]* @.str, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)), !dbg !31 ; [debug line = 58:1]
  call void (...)* @_ssdm_op_SpecInterface(i16* %d_i, i8* getelementptr inbounds ([5 x i8]* @.str2, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)), !dbg !31 ; [debug line = 58:1]
  call void (...)* @_ssdm_SpecArrayPartition(i16* %d_i, i32 1, i8* getelementptr inbounds ([7 x i8]* @.str3, i64 0, i64 0), i32 8, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)), !dbg !31 ; [debug line = 58:1]
  call void (...)* @_ssdm_op_SpecInterface(i16* %d_o, i8* getelementptr inbounds ([5 x i8]* @.str2, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)), !dbg !31 ; [debug line = 58:1]
  call void (...)* @_ssdm_SpecArrayPartition(i16* %d_o, i32 1, i8* getelementptr inbounds ([7 x i8]* @.str3, i64 0, i64 0), i32 8, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)), !dbg !31 ; [debug line = 58:1]
...
; <label>:2                                       ; preds = %1
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([9 x i8]* @.str4, i64 0, i64 0)), !dbg !34 ; [debug line = 64:35]
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([9 x i8]* @.str4, i64 0, i64 0)) nounwind, !dbg !34 ; [#uses=1 type=i32] [debug line = 64:35]
  ...
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([9 x i8]* @.str4, i64 0, i64 0), i32 %rbegin) nounwind, !dbg !42 ; [#uses=0 type=i32] [debug line = 68:2]

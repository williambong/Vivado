...
printf("\n\{ BEGIN @main\n");
if (AESL_DEBUG_TRACE)
printf("\n  store i32 30, i32* %%ioC, align 4, !dbg !2 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_16_count);
  *(&llvm_cbe_ioC) = 30u;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", 30u);
if (AESL_DEBUG_TRACE)
printf("\n  call void @adders_io(i32 10, i32 20, i32* %%ioC) nounwind, !dbg !1 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_27_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  store i32 40, i32* %%ioC, align 4, !dbg !3 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_56_count);
  *(&llvm_cbe_ioC) = 40u;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", 40u);
if (AESL_DEBUG_TRACE)
printf("\n  call void @adders_io(i32 20, i32 30, i32* %%ioC) nounwind, !dbg !1 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_67_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  store i32 50, i32* %%ioC, align 4, !dbg !3 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_96_count);
  *(&llvm_cbe_ioC) = 50u;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", 50u);
if (AESL_DEBUG_TRACE)
printf("\n  call void @adders_io(i32 30, i32 40, i32* %%ioC) nounwind, !dbg !1 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_107_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  store i32 60, i32* %%ioC, align 4, !dbg !3 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_136_count);
  *(&llvm_cbe_ioC) = 60u;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", 60u);
if (AESL_DEBUG_TRACE)
printf("\n  call void @adders_io(i32 40, i32 50, i32* %%ioC) nounwind, !dbg !1 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_147_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  store i32 70, i32* %%ioC, align 4, !dbg !3 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_176_count);
  *(&llvm_cbe_ioC) = 70u;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", 70u);
if (AESL_DEBUG_TRACE)
printf("\n  call void @adders_io(i32 50, i32 60, i32* %%ioC) nounwind, !dbg !1 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_187_count);
...
printf("\n = 0x%X\n", llvm_cbe_tmp__21);
if (AESL_DEBUG_TRACE)
printf("\n  store i32 80, i32* %%ioC, align 4, !dbg !3 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_221_count);
  *(&llvm_cbe_ioC) = 80u;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", 80u);
...
llvm_cbe_tmp__28:
if (AESL_DEBUG_TRACE)
printf("\n  %%24 = call %%struct._iobuf* @__iob_func() nounwind, !dbg !4 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_227_count);
  llvm_cbe_tmp__22 = (l_struct_OC__iobuf *)__iob_func();
if (AESL_DEBUG_TRACE) {
printf("\nReturn  = 0x%X",llvm_cbe_tmp__22);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%25 = getelementptr inbounds %%struct._iobuf* %%24, i64 1, !dbg !4 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_228_count);
  llvm_cbe_tmp__23 = (l_struct_OC__iobuf *)(&llvm_cbe_tmp__22[(((signed long long )1ull))]);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  %%26 = call i64 @fwrite(i8* getelementptr inbounds ([29 x i8]* @aesl_internal_.str1, i64 0, i64 0), i64 28, i64 1, %%struct._iobuf* %%25), !dbg !4 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_229_count);
...
llvm_cbe_tmp__29:
if (AESL_DEBUG_TRACE)
printf("\n  %%28 = call %%struct._iobuf* @__iob_func() nounwind, !dbg !4 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_231_count);
  llvm_cbe_tmp__25 = (l_struct_OC__iobuf *)__iob_func();
if (AESL_DEBUG_TRACE) {
printf("\nReturn  = 0x%X",llvm_cbe_tmp__25);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%29 = getelementptr inbounds %%struct._iobuf* %%28, i64 2, !dbg !4 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_232_count);
  llvm_cbe_tmp__26 = (l_struct_OC__iobuf *)(&llvm_cbe_tmp__25[(((signed long long )2ull))]);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  %%30 = call i64 @fwrite(i8* getelementptr inbounds ([29 x i8]* @aesl_internal_.str2, i64 0, i64 0), i64 28, i64 1, %%struct._iobuf* %%29), !dbg !4 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_233_count);

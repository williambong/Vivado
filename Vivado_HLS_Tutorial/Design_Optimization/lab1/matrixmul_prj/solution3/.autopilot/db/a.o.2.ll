; ModuleID = 'D:/opt/source/Vivado/Vivado_HLS_Tutorial/Design_Optimization/lab1/matrixmul_prj/solution3/.autopilot/db/a.o.2.bc'
...
; <label>:1                                       ; preds = %8, %0
  ...
  br i1 %exitcond2, label %10, label %3, !dbg !48 ; [debug line = 54:22]
...
; <label>:3                                       ; preds = %1
  ...
  %tmp = zext i2 %i to i64, !dbg !53              ; [#uses=4 type=i64] [debug line = 57:10]
...
; <label>:4                                       ; preds = %6, %3
  ...
  br i1 %exitcond1, label %8, label %6, !dbg !56  ; [debug line = 56:25]
...
; <label>:6                                       ; preds = %4
  ...
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, [1 x i8]* @.str2) nounwind, !dbg !58 ; [debug line = 57:1]
  %tmp.2 = zext i2 %j to i64, !dbg !53            ; [#uses=4 type=i64] [debug line = 57:10]
  %res.addr = getelementptr [3 x [3 x i16]]* %res, i64 0, i64 %tmp, i64 %tmp.2, !dbg !53 ; [#uses=1 type=i16*] [debug line = 57:10]
  %a.addr = getelementptr [3 x [3 x i8]]* %a, i64 0, i64 %tmp, i64 0, !dbg !59 ; [#uses=1 type=i8*] [debug line = 60:13]
  %a.load = load i8* %a.addr, align 1, !dbg !59   ; [#uses=1 type=i8] [debug line = 60:13]
  %tmp.5 = sext i8 %a.load to i16, !dbg !59       ; [#uses=1 type=i16] [debug line = 60:13]
  %b.addr = getelementptr [3 x [3 x i8]]* %b, i64 0, i64 0, i64 %tmp.2, !dbg !59 ; [#uses=1 type=i8*] [debug line = 60:13]
  %b.load = load i8* %b.addr, align 1, !dbg !59   ; [#uses=1 type=i8] [debug line = 60:13]
  %tmp.6 = sext i8 %b.load to i16, !dbg !59       ; [#uses=1 type=i16] [debug line = 60:13]
  %tmp.7 = mul i16 %tmp.6, %tmp.5, !dbg !59       ; [#uses=1 type=i16] [debug line = 60:13]
  %a.addr.1 = getelementptr [3 x [3 x i8]]* %a, i64 0, i64 %tmp, i64 1, !dbg !59 ; [#uses=1 type=i8*] [debug line = 60:13]
  %a.load.1 = load i8* %a.addr.1, align 1, !dbg !59 ; [#uses=1 type=i8] [debug line = 60:13]
  %tmp.5.1 = sext i8 %a.load.1 to i16, !dbg !59   ; [#uses=1 type=i16] [debug line = 60:13]
  %b.addr.1 = getelementptr [3 x [3 x i8]]* %b, i64 0, i64 1, i64 %tmp.2, !dbg !59 ; [#uses=1 type=i8*] [debug line = 60:13]
  %b.load.1 = load i8* %b.addr.1, align 1, !dbg !59 ; [#uses=1 type=i8] [debug line = 60:13]
  %tmp.6.1 = sext i8 %b.load.1 to i16, !dbg !59   ; [#uses=1 type=i16] [debug line = 60:13]
  %tmp.7.1 = mul i16 %tmp.6.1, %tmp.5.1, !dbg !59 ; [#uses=1 type=i16] [debug line = 60:13]
  %a.addr.2 = getelementptr [3 x [3 x i8]]* %a, i64 0, i64 %tmp, i64 2, !dbg !59 ; [#uses=1 type=i8*] [debug line = 60:13]
  %a.load.2 = load i8* %a.addr.2, align 1, !dbg !59 ; [#uses=1 type=i8] [debug line = 60:13]
  %tmp.5.2 = sext i8 %a.load.2 to i16, !dbg !59   ; [#uses=1 type=i16] [debug line = 60:13]
  %b.addr.2 = getelementptr [3 x [3 x i8]]* %b, i64 0, i64 2, i64 %tmp.2, !dbg !59 ; [#uses=1 type=i8*] [debug line = 60:13]
  %b.load.2 = load i8* %b.addr.2, align 1, !dbg !59 ; [#uses=1 type=i8] [debug line = 60:13]
  %tmp.6.2 = sext i8 %b.load.2 to i16, !dbg !59   ; [#uses=1 type=i16] [debug line = 60:13]
  %tmp.7.2 = mul i16 %tmp.6.2, %tmp.5.2, !dbg !59 ; [#uses=1 type=i16] [debug line = 60:13]
  %tmp1 = add i16 %tmp.7.2, %tmp.7, !dbg !59      ; [#uses=1 type=i16] [debug line = 60:13]
  %tmp.8.2 = add i16 %tmp.7.1, %tmp1, !dbg !59    ; [#uses=1 type=i16] [debug line = 60:13]
  store i16 %tmp.8.2, i16* %res.addr, align 2, !dbg !59 ; [debug line = 60:13]
  %7 = call i32 (...)* @_ssdm_op_SpecRegionEnd([4 x i8]* @.str1, i32 %tmp.3) nounwind, !dbg !62 ; [#uses=0 type=i32] [debug line = 62:7]
  %j.1 = add i2 %j, 1, !dbg !63                   ; [#uses=1 type=i2] [debug line = 56:34]
  call void @llvm.dbg.value(metadata !{i2 %j.1}, i64 0, metadata !64), !dbg !63 ; [debug line = 56:34] [debug variable = j]
  br label %4, !dbg !63                           ; [debug line = 56:34]

; <label>:8                                       ; preds = %4
  %9 = call i32 (...)* @_ssdm_op_SpecRegionEnd([4 x i8]* @.str, i32 %tmp.1) nounwind, !dbg !66 ; [#uses=0 type=i32] [debug line = 63:4]
  %i.1 = add i2 %i, 1, !dbg !67                   ; [#uses=1 type=i2] [debug line = 54:31]
  call void @llvm.dbg.value(metadata !{i2 %i.1}, i64 0, metadata !68), !dbg !67 ; [debug line = 54:31] [debug variable = i]
  br label %1, !dbg !67                           ; [debug line = 54:31]

; <label>:10                                      ; preds = %1
  ret void, !dbg !69                              ; [debug line = 65:1]
}
...
!58 = metadata !{i32 57, i32 1, metadata !54, null}
!59 = metadata !{i32 60, i32 13, metadata !60, null}
!60 = metadata !{i32 786443, metadata !61, i32 59, i32 46, metadata !6, i32 6} ; [ DW_TAG_lexical_block ]
!61 = metadata !{i32 786443, metadata !54, i32 59, i32 19, metadata !6, i32 5} ; [ DW_TAG_lexical_block ]
!62 = metadata !{i32 62, i32 7, metadata !54, null}
!63 = metadata !{i32 56, i32 34, metadata !55, null}
!64 = metadata !{i32 786688, metadata !55, metadata !"j", metadata !6, i32 56, metadata !65, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!65 = metadata !{i32 786468, null, metadata !"int", null, i32 0, i64 32, i64 32, i64 0, i32 0, i32 5} ; [ DW_TAG_base_type ]
!66 = metadata !{i32 63, i32 4, metadata !52, null}
!67 = metadata !{i32 54, i32 31, metadata !49, null}
!68 = metadata !{i32 786688, metadata !49, metadata !"i", metadata !6, i32 54, metadata !65, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!69 = metadata !{i32 65, i32 1, metadata !50, null}

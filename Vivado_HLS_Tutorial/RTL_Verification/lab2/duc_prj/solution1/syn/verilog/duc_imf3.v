...
reg    ap_sig_bdd_26;
reg   [5:0] i_2 = 6'b000000;
reg   [17:0] in_1 = 18'b000000000000000000;
reg   [5:0] j = 6'b000000;
wire   [2:0] c_1_0_address0;
reg    c_1_0_ce0;
wire   [17:0] c_1_0_q0;
reg   [0:0] init_2 = 1'b1;
...
reg   [17:0] c_1_0_load_reg_395;
reg   [0:0] c_1_1_load_reg_405;
wire   [0:0] tmp_14_fu_187_p2;
reg   [0:0] tmp_14_reg_415;
...
wire   [37:0] tmp_15_fu_226_p3;
reg   [37:0] tmp_15_reg_447;
reg    ap_sig_cseq_ST_st5_fsm_4;
reg    ap_sig_bdd_141;
wire   [37:0] tmp_16_fu_233_p3;
reg   [37:0] tmp_16_reg_452;
...
reg    ap_sig_bdd_154;
reg   [17:0] tmp_12_reg_467;
wire  signed [37:0] grp_fu_337_p3;
reg  signed [37:0] acc0_reg_472;
reg    ap_sig_cseq_ST_st7_fsm_6;
reg    ap_sig_bdd_167;
reg   [17:0] tmp_11_reg_477;
reg   [17:0] d_assign_reg_122;
wire   [63:0] tmp_s_fu_157_p1;
wire   [63:0] tmp_8_fu_181_p1;
wire   [63:0] tmp_10_fu_279_p1;
reg    ap_sig_cseq_ST_st8_fsm_7;
reg    ap_sig_bdd_186;
wire   [5:0] inc_2_fu_325_p3;
wire   [5:0] tmp_19_fu_311_p3;
wire   [0:0] or_cond5_fu_295_p2;
wire   [6:0] tmp_7_fu_174_p3;
wire   [34:0] p_shl_fu_203_p3;
wire  signed [34:0] tmp_i_cast_fu_199_p1;
wire   [0:0] or_cond_fu_221_p2;
wire  signed [37:0] tmp_26_i6_fu_246_p1;
wire   [6:0] tmp_9_fu_273_p3;
wire   [0:0] tmp_17_fu_290_p2;
wire   [5:0] tmp_18_fu_306_p2;
...
always @(posedge ap_clk)
begin
    if (((ap_const_logic_1 == ap_sig_cseq_ST_st8_fsm_7) & ~(tmp_14_reg_415 == ap_const_lv1_0))) begin
        j <= tmp_19_fu_311_p3;
    end
end
...
always @(posedge ap_clk)
begin
    if (((ap_const_logic_1 == ap_sig_cseq_ST_st4_fsm_3) & ~(c_1_1_load_reg_405 == ap_const_lv1_0))) begin
...
begin
    if (((ap_const_logic_1 == ap_sig_cseq_ST_st7_fsm_6) & ~(tmp_reg_353 == ap_const_lv1_0))) begin
        tmp_11_reg_477 <= {{grp_fu_337_p3[ap_const_lv32_22 : ap_const_lv32_11]}};
    end
end
...
begin
    if (((ap_const_logic_1 == ap_sig_cseq_ST_st6_fsm_5) & (tmp_reg_353 == ap_const_lv1_0))) begin
        tmp_12_reg_467 <= {{acc1_fu_249_p2[ap_const_lv32_22 : ap_const_lv32_11]}};
    end
end
...
always @ (ap_sig_cseq_ST_st3_fsm_2 or tmp_8_fu_181_p1 or tmp_10_fu_279_p1 or ap_sig_cseq_ST_st8_fsm_7)
begin
    if ((ap_const_logic_1 == ap_sig_cseq_ST_st8_fsm_7)) begin
        shift_reg_p0_address0 = tmp_10_fu_279_p1;
    end else if ((ap_const_logic_1 == ap_sig_cseq_ST_st3_fsm_2)) begin
        shift_reg_p0_address0 = tmp_8_fu_181_p1;
    end else begin
...
begin
    if ((ap_const_logic_1 == ap_sig_cseq_ST_st8_fsm_7)) begin
        shift_reg_p1_address0 = tmp_10_fu_279_p1;
    end else if ((ap_const_logic_1 == ap_sig_cseq_ST_st3_fsm_2)) begin
        shift_reg_p1_address0 = tmp_8_fu_181_p1;
    end else begin
...
assign acc1_fu_249_p2 = ($signed(tmp_16_reg_452) + $signed(tmp_26_i6_fu_246_p1));
assign ap_return = ((tmp_reg_353[0:0]===1'b1)? tmp_11_reg_477: tmp_12_reg_467);
...
assign c_1_0_address0 = tmp_s_fu_157_p1;
assign c_1_1_address0 = tmp_s_fu_157_p1;
assign ch_4_fu_166_p3 = j[ap_const_lv32_3];
assign grp_fu_337_ce = ap_const_logic_1;
assign grp_fu_337_p0 = d_assign_reg_122;
assign grp_fu_337_p1 = c_1_0_load_reg_395;
assign grp_fu_337_p2 = tmp_15_reg_447;
assign inc_2_fu_325_p3 = ((tmp_14_reg_415[0:0]===1'b1)? ap_const_lv6_0: inc_reg_368);
assign inc_fu_152_p2 = (i_2_load_reg_345 + ap_const_lv6_1);
assign m_1_fu_240_p3 = ((c_1_1_load_reg_405[0:0]===1'b1)? mt_reg_442: ap_const_lv35_0);
assign mt_fu_211_p2 = ($signed(p_shl_fu_203_p3) - $signed(tmp_i_cast_fu_199_p1));
assign or_cond5_fu_295_p2 = (tmp_14_reg_415 & tmp_17_fu_290_p2);
assign or_cond_fu_221_p2 = (init_2 | tmp_14_reg_415);
...
assign tmp_10_fu_279_p1 = tmp_9_fu_273_p3;
assign tmp_14_fu_187_p2 = (i_2_load_reg_345 == ap_const_lv6_5? 1'b1: 1'b0);
assign tmp_15_fu_226_p3 = ((or_cond_fu_221_p2[0:0]===1'b1)? ap_const_lv38_0: shift_reg_p0_load_reg_422);
assign tmp_16_fu_233_p3 = ((or_cond_fu_221_p2[0:0]===1'b1)? ap_const_lv38_0: shift_reg_p1_load_reg_437);
assign tmp_17_fu_290_p2 = (p_Val2_s_reg_384 == ap_const_lv6_F? 1'b1: 1'b0);
assign tmp_18_fu_306_p2 = (p_Val2_s_reg_384 + ap_const_lv6_1);
assign tmp_19_fu_311_p3 = ((tmp_17_fu_290_p2[0:0]===1'b1)? ap_const_lv6_0: tmp_18_fu_306_p2);
assign tmp_26_i6_fu_246_p1 = $signed(m_1_reg_457);
assign tmp_7_fu_174_p3 = {{inc_reg_368}, {ch_4_fu_166_p3}};
assign tmp_8_fu_181_p1 = tmp_7_fu_174_p3;
assign tmp_9_fu_273_p3 = {{i_2_load_reg_345}, {ch_4_reg_390}};
assign tmp_fu_136_p2 = (i_2 == ap_const_lv6_0? 1'b1: 1'b0);
assign tmp_i_cast_fu_199_p1 = $signed(d_assign_reg_122);
assign tmp_s_fu_157_p1 = i_2_load_reg_345;

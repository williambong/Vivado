...
architecture behav of duc is 
    ...
    signal shift_reg_p_2_d0 : STD_LOGIC_VECTOR (37 downto 0);
    ...
    signal i_4_load_reg_677 : STD_LOGIC_VECTOR (4 downto 0);
    signal ap_sig_cseq_ST_st7_fsm_6 : STD_LOGIC;
    signal ap_sig_bdd_161 : BOOLEAN;
    signal inc_5_fu_429_p2 : STD_LOGIC_VECTOR (4 downto 0);
    signal inc_5_reg_687 : STD_LOGIC_VECTOR (4 downto 0);
    signal c_2_load_reg_698 : STD_LOGIC_VECTOR (17 downto 0);
    signal ap_sig_cseq_ST_st8_fsm_7 : STD_LOGIC;
    signal ap_sig_bdd_173 : BOOLEAN;
    signal ch_3_load_reg_703 : STD_LOGIC_VECTOR (0 downto 0);
    signal sel_tmp1_i7_fu_456_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal sel_tmp1_i7_reg_714 : STD_LOGIC_VECTOR (0 downto 0);
    signal sel_tmp2_i8_fu_461_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal sel_tmp2_i8_reg_720 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_sig_cseq_ST_st9_fsm_8 : STD_LOGIC;
    signal ap_sig_bdd_190 : BOOLEAN;
    signal shift_reg_p_2_load_reg_730 : STD_LOGIC_VECTOR (37 downto 0);
    ...
    signal tmp_19_fu_307_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_21_fu_370_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_i3_fu_435_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_s_fu_451_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_25_fu_514_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal inc_4_fu_401_p3 : STD_LOGIC_VECTOR (5 downto 0);
    signal tmp_i_fu_273_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_i_15_fu_381_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal inc_6_fu_562_p3 : STD_LOGIC_VECTOR (4 downto 0);
    signal tmp_i1_fu_417_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_41_i_fu_529_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_42_i_fu_540_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_18_fu_300_p3 : STD_LOGIC_VECTOR (6 downto 0);
    ...
    signal tmp_20_fu_364_p3 : STD_LOGIC_VECTOR (6 downto 0);
    signal tmp_23_fu_444_p3 : STD_LOGIC_VECTOR (5 downto 0);
    signal sel_tmp4_i1_fu_480_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal sel_tmp3_i9_fu_474_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_22_fu_497_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_24_fu_508_p3 : STD_LOGIC_VECTOR (5 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_sig_cseq_ST_st13_fsm_12) and not((ap_const_lv1_0 = sel_tmp1_i7_reg_714)))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_sig_cseq_ST_st7_fsm_6) and not((ap_const_lv1_0 = tmp_i1_fu_417_p2)))) then
                in_3 <= acc_1_reg_671(34 downto 17);
            end if;
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_sig_cseq_ST_st13_fsm_12) and not((ap_const_lv1_0 = sel_tmp1_i7_reg_714)) and not((ap_const_lv1_0 = ch_3_load_reg_703)))) then
    ...
    c_2_address0 <= tmp_i3_fu_435_p1(5 - 1 downto 0);

    -- c_2_ce0 assign process. --
    c_2_ce0_assign_proc : process(ap_sig_cseq_ST_st7_fsm_6)
    begin
        if ((ap_const_logic_1 = ap_sig_cseq_ST_st7_fsm_6)) then 
    ...
    grp_fu_581_p0 <= c_2_load_reg_698;
    grp_fu_581_p1 <= in_3;
    grp_fu_581_p2 <= s_assign_reg_750;
    inc_4_fu_401_p3 <= 
        ap_const_lv6_0 when (sel_tmp1_i_reg_630(0) = '1') else 
        inc_reg_603;
    inc_5_fu_429_p2 <= std_logic_vector(unsigned(i_4) + unsigned(ap_const_lv5_1));
    inc_6_fu_562_p3 <= 
        ap_const_lv5_0 when (sel_tmp1_i7_reg_714(0) = '1') else 
        inc_5_reg_687;
    inc_fu_285_p2 <= std_logic_vector(unsigned(i) + unsigned(ap_const_lv6_1));
    s_assign_fu_501_p3 <= 
        ap_const_lv38_0 when (tmp_22_fu_497_p2(0) = '1') else 
        shift_reg_p_2_load_reg_730;
    sel_tmp1_i7_fu_456_p2 <= "1" when (i_4_load_reg_677 = ap_const_lv5_17) else "0";
    sel_tmp1_i_fu_312_p2 <= "1" when (i_load_reg_593 = ap_const_lv6_2F) else "0";
    sel_tmp2_i8_fu_461_p2 <= "1" when (i_4_load_reg_677 = ap_const_lv5_B) else "0";
    sel_tmp2_i_fu_317_p2 <= "1" when (i_load_reg_593 = ap_const_lv6_17) else "0";
    sel_tmp3_i9_fu_474_p2 <= (init_4 xor ap_const_lv1_1);
    sel_tmp3_i_fu_330_p2 <= (init xor ap_const_lv1_1);
    sel_tmp4_i1_fu_480_p2 <= (sel_tmp1_i7_reg_714 or sel_tmp2_i8_reg_720);
    sel_tmp4_i_fu_336_p2 <= (sel_tmp1_i_reg_630 or sel_tmp2_i_reg_636);
    sel_tmp5_i1_fu_484_p2 <= (sel_tmp4_i1_fu_480_p2 and sel_tmp3_i9_fu_474_p2);
    sel_tmp5_i_fu_340_p2 <= (sel_tmp4_i_fu_336_p2 and sel_tmp3_i_fu_330_p2);

    -- shift_reg_p_2_address0 assign process. --
    shift_reg_p_2_address0_assign_proc : process(ap_sig_cseq_ST_st8_fsm_7, ap_sig_cseq_ST_st13_fsm_12, tmp_s_fu_451_p1, tmp_25_fu_514_p1)
    begin
        if ((ap_const_logic_1 = ap_sig_cseq_ST_st13_fsm_12)) then 
            shift_reg_p_2_address0 <= tmp_25_fu_514_p1(6 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_sig_cseq_ST_st8_fsm_7)) then 
            shift_reg_p_2_address0 <= tmp_s_fu_451_p1(6 - 1 downto 0);
        else 
    ...
    shift_reg_p_2_ce0_assign_proc : process(ap_sig_cseq_ST_st8_fsm_7, ap_sig_cseq_ST_st13_fsm_12)
    begin
    ...
    shift_reg_p_2_d0 <= sum_reg_755;

    -- shift_reg_p_2_we0 assign process. --
    shift_reg_p_2_we0_assign_proc : process(ap_sig_cseq_ST_st13_fsm_12)
    begin
        if (((ap_const_logic_1 = ap_sig_cseq_ST_st13_fsm_12))) then 
    ...
    shift_reg_p_address0_assign_proc : process(ap_sig_cseq_ST_st2_fsm_1, ap_sig_cseq_ST_st7_fsm_6, tmp_19_fu_307_p1, tmp_21_fu_370_p1)
    begin
        if ((ap_const_logic_1 = ap_sig_cseq_ST_st7_fsm_6)) then 
            shift_reg_p_address0 <= tmp_21_fu_370_p1(7 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_sig_cseq_ST_st2_fsm_1)) then 
            shift_reg_p_address0 <= tmp_19_fu_307_p1(7 - 1 downto 0);
        else 
    ...
    tmp_18_fu_300_p3 <= (inc_reg_603 & ch);
    tmp_19_fu_307_p1 <= std_logic_vector(resize(unsigned(tmp_18_fu_300_p3),64));
    tmp_20_fu_364_p3 <= (i_load_reg_593 & ch_load_reg_619);
    tmp_21_fu_370_p1 <= std_logic_vector(resize(unsigned(tmp_20_fu_364_p3),64));
    tmp_22_fu_497_p2 <= (sel_tmp5_i1_reg_735 or init_4);
    tmp_23_fu_444_p3 <= (inc_5_reg_687 & ch_3);
    tmp_24_fu_508_p3 <= (i_4_load_reg_677 & ch_3_load_reg_703);
    tmp_25_fu_514_p1 <= std_logic_vector(resize(unsigned(tmp_24_fu_508_p3),64));
    tmp_2_i_fu_291_p1 <= std_logic_vector(resize(unsigned(i),64));
    tmp_41_i_fu_529_p2 <= (ch_3_load_reg_703 xor cnt_1);
    tmp_42_i_fu_540_p2 <= (cnt_1 xor ap_const_lv1_1);
    tmp_5_i_fu_357_p3 <= 
        ap_const_lv38_0 when (tmp_fu_353_p2(0) = '1') else 
        shift_reg_p_load_reg_646;
    tmp_fu_353_p2 <= (sel_tmp5_i_reg_651 or init);
    tmp_i1_fu_417_p2 <= "1" when (i_4 = ap_const_lv5_0) else "0";
    tmp_i3_fu_435_p1 <= std_logic_vector(resize(unsigned(i_4),64));
    tmp_i_15_fu_381_p2 <= (ch_load_reg_619 xor ap_const_lv1_1);
    tmp_i_fu_273_p2 <= "1" when (i = ap_const_lv6_0) else "0";
    tmp_s_fu_451_p1 <= std_logic_vector(resize(unsigned(tmp_23_fu_444_p3),64));
end behav;

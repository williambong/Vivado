...
llvm_cbe_tmp__27:
if (AESL_DEBUG_TRACE)
printf("\n  %%5 = add i5 %%1, 1, !dbg !5 for 0x%I64xth hint within @imf1  --> \n", ++aesl_llvm_cbe_10_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%6 = zext i5 %%1 to i64, !dbg !5 for 0x%I64xth hint within @imf1  --> \n", ++aesl_llvm_cbe_14_count);
  llvm_cbe_tmp__3 = (unsigned long long )((unsigned long long )(unsigned char )llvm_cbe_tmp__1&31U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__3);
if (AESL_DEBUG_TRACE)
printf("\n  %%7 = getelementptr inbounds [24 x i18]* @aesl_internal_imf1.c, i64 0, i64 %%6, !dbg !5 for 0x%I64xth hint within @imf1  --> \n", ++aesl_llvm_cbe_15_count);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  %%8 = load i18* %%7, align 4, !dbg !5 for 0x%I64xth hint within @imf1  --> \n", ++aesl_llvm_cbe_16_count);
  llvm_cbe_tmp__5 = (unsigned int )*llvm_cbe_tmp__4;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__5);
if (AESL_DEBUG_TRACE)
printf("\n  %%9 = load i18* @aesl_internal_imf1.in, align 4, !dbg !5 for 0x%I64xth hint within @imf1  --> \n", ++aesl_llvm_cbe_17_count);
  llvm_cbe_tmp__6 = (unsigned int )*(&aesl_internal_imf1_OC_in);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__6);
if (AESL_DEBUG_TRACE)
printf("\n  %%10 = load i1* @aesl_internal_imf1.init, align 1, !dbg !5 for 0x%I64xth hint within @imf1  --> \n", ++aesl_llvm_cbe_18_count);
...
llvm_cbe_tmp__29:
if (AESL_DEBUG_TRACE)
printf("\n  %%12 = load i1* @aesl_internal_imf1.ch, align 1, !dbg !5 for 0x%I64xth hint within @imf1  --> \n", ++aesl_llvm_cbe_21_count);
  llvm_cbe_tmp__8 = (bool )((*(&aesl_internal_imf1_OC_ch))&1);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__8);
if (AESL_DEBUG_TRACE)
printf("\n  %%13 = zext i1 %%12 to i64, !dbg !5 for 0x%I64xth hint within @imf1  --> \n", ++aesl_llvm_cbe_22_count);
  llvm_cbe_tmp__9 = (unsigned long long )((unsigned long long )(bool )llvm_cbe_tmp__8&1U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__9);
if (AESL_DEBUG_TRACE)
printf("\n  %%14 = zext i5 %%5 to i64, !dbg !5 for 0x%I64xth hint within @imf1  --> \n", ++aesl_llvm_cbe_23_count);
  llvm_cbe_tmp__10 = (unsigned long long )((unsigned long long )(unsigned char )llvm_cbe_tmp__2&31U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__10);
if (AESL_DEBUG_TRACE)
printf("\n  %%15 = getelementptr inbounds [25 x [2 x i38]]* @aesl_internal_imf1.shift_reg_p, i64 0, i64 %%14, i64 %%13, !dbg !5 for 0x%I64xth hint within @imf1  --> \n", ++aesl_llvm_cbe_24_count);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  %%16 = load i38* %%15, align 8, !dbg !5 for 0x%I64xth hint within @imf1  --> \n", ++aesl_llvm_cbe_25_count);
...
llvm_cbe_tmp__28:
if (AESL_DEBUG_TRACE)
printf("\n  %%18 = phi i38 [ %%16, %%11 ], [ 0, %%switch.early.test ], [ 0, %%4 ], [ 0, %%switch.early.test ], !dbg !5 for 0x%I64xth hint within @imf1  --> \n", ++aesl_llvm_cbe_27_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%19 = tail call i38 @mac1(i18 signext %%8, i18 signext %%9, i38 %%18) nounwind, !dbg !5 for 0x%I64xth hint within @imf1  --> \n", ++aesl_llvm_cbe_28_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%20 = load i1* @aesl_internal_imf1.ch, align 1, !dbg !5 for 0x%I64xth hint within @imf1  --> \n", ++aesl_llvm_cbe_32_count);
  llvm_cbe_tmp__15 = (bool )((*(&aesl_internal_imf1_OC_ch))&1);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__15);
if (AESL_DEBUG_TRACE)
printf("\n  %%21 = zext i1 %%20 to i64, !dbg !5 for 0x%I64xth hint within @imf1  --> \n", ++aesl_llvm_cbe_33_count);
  llvm_cbe_tmp__16 = (unsigned long long )((unsigned long long )(bool )llvm_cbe_tmp__15&1U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__16);
if (AESL_DEBUG_TRACE)
printf("\n  %%22 = load i5* @aesl_internal_imf1.i, align 1, !dbg !5 for 0x%I64xth hint within @imf1  --> \n", ++aesl_llvm_cbe_34_count);
  llvm_cbe_tmp__17 = (unsigned char )*(&aesl_internal_imf1_OC_i);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__17);
if (AESL_DEBUG_TRACE)
printf("\n  %%23 = zext i5 %%22 to i64, !dbg !5 for 0x%I64xth hint within @imf1  --> \n", ++aesl_llvm_cbe_35_count);
  llvm_cbe_tmp__18 = (unsigned long long )((unsigned long long )(unsigned char )llvm_cbe_tmp__17&31U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__18);
if (AESL_DEBUG_TRACE)
printf("\n  %%24 = getelementptr inbounds [25 x [2 x i38]]* @aesl_internal_imf1.shift_reg_p, i64 0, i64 %%23, i64 %%21, !dbg !5 for 0x%I64xth hint within @imf1  --> \n", ++aesl_llvm_cbe_36_count);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  store i38 %%19, i38* %%24, align 8, !dbg !5 for 0x%I64xth hint within @imf1  --> \n", ++aesl_llvm_cbe_37_count);
...
llvm_cbe_tmp__32:
if (AESL_DEBUG_TRACE)
printf("\n  store i1 false, i1* @aesl_internal_imf1.init, align 1, !dbg !6 for 0x%I64xth hint within @imf1  --> \n", ++aesl_llvm_cbe_41_count);
...
llvm_cbe_tmp__33:
if (AESL_DEBUG_TRACE)
printf("\n  %%29 = load i1* @aesl_internal_imf1.cnt, align 1, !dbg !6 for 0x%I64xth hint within @imf1  --> \n", ++aesl_llvm_cbe_43_count);
  llvm_cbe_tmp__20 = (bool )((*(&aesl_internal_imf1_OC_cnt))&1);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__20);
if (AESL_DEBUG_TRACE)
printf("\n  %%30 = xor i1 %%20, %%29, !dbg !6 for 0x%I64xth hint within @imf1  --> \n", ++aesl_llvm_cbe_44_count);
  llvm_cbe_tmp__21 = (bool )((llvm_cbe_tmp__15 ^ llvm_cbe_tmp__20)&1);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__21);
if (AESL_DEBUG_TRACE)
printf("\n  store i1 %%30, i1* @aesl_internal_imf1.ch, align 1, !dbg !6 for 0x%I64xth hint within @imf1  --> \n", ++aesl_llvm_cbe_45_count);
  *(&aesl_internal_imf1_OC_ch) = ((llvm_cbe_tmp__21) & 1ull);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__21);
if (AESL_DEBUG_TRACE)
printf("\n  %%31 = xor i1 %%29, true, !dbg !6 for 0x%I64xth hint within @imf1  --> \n", ++aesl_llvm_cbe_46_count);
  llvm_cbe_tmp__22 = (bool )((llvm_cbe_tmp__20 ^ 1)&1);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__22);
if (AESL_DEBUG_TRACE)
printf("\n  store i1 %%31, i1* @aesl_internal_imf1.cnt, align 1, !dbg !6 for 0x%I64xth hint within @imf1  --> \n", ++aesl_llvm_cbe_47_count);
...
llvm_cbe_tmp__35:
if (AESL_DEBUG_TRACE)
printf("\n  %%34 = lshr i38 %%19, 17, !dbg !4 for 0x%I64xth hint within @imf1  --> \n", ++aesl_llvm_cbe_50_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%35 = trunc i38 %%34 to i18, !dbg !4 for 0x%I64xth hint within @imf1  --> \n", ++aesl_llvm_cbe_51_count);
  llvm_cbe_tmp__24 = (unsigned int )((unsigned int )llvm_cbe_tmp__23&262143U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__24);
if (AESL_DEBUG_TRACE)
printf("\n  store i18 %%35, i18* %%y, align 4, !dbg !4 for 0x%I64xth hint within @imf1  --> \n", ++aesl_llvm_cbe_52_count);
...
llvm_cbe_tmp__34:
if (AESL_DEBUG_TRACE)
printf("\n  %%37 = select i1 %%25, i5 0, i5 %%5, !dbg !5 for 0x%I64xth hint within @imf1  --> \n", ++aesl_llvm_cbe_54_count);
...
printf("\n = 0x%X\n", llvm_cbe_tmp__25);
if (AESL_DEBUG_TRACE)
printf("\n  store i5 %%37, i5* @aesl_internal_imf1.i, align 1, !dbg !5 for 0x%I64xth hint within @imf1  --> \n", ++aesl_llvm_cbe_55_count);

...
void AESL_ORIG_DUT_duc(signed int llvm_cbe_din_i, signed short llvm_cbe_freq, signed int *llvm_cbe_dout_i, signed int *llvm_cbe_dout_q);
...
if (AESL_DEBUG_TRACE)
printf("\n\{ BEGIN @AESL_ORIG_DUT_duc\n");
if (AESL_DEBUG_TRACE)
printf("\n  call void @srrc(i18* %%srrc_o, i18 signext %%din_i) nounwind, !dbg !3 for 0x%I64xth hint within @AESL_ORIG_DUT_duc  --> \n", ++aesl_llvm_cbe_13_count);
  srrc((signed int *)(&llvm_cbe_srrc_o), llvm_cbe_din_i);
if (AESL_DEBUG_TRACE) {
printf("\nArgument din_i = 0x%X",llvm_cbe_din_i);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%1 = load i18* %%srrc_o, align 4, !dbg !3 for 0x%I64xth hint within @AESL_ORIG_DUT_duc  --> \n", ++aesl_llvm_cbe_20_count);
  llvm_cbe_tmp__1 = (unsigned int )*(&llvm_cbe_srrc_o);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__1);
if (AESL_DEBUG_TRACE)
printf("\n  call void @imf1(i18* %%imf1_o, i18 signext %%1) nounwind, !dbg !3 for 0x%I64xth hint within @AESL_ORIG_DUT_duc  --> \n", ++aesl_llvm_cbe_21_count);
  imf1((signed int *)(&llvm_cbe_imf1_o), llvm_cbe_tmp__1);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",llvm_cbe_tmp__1);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%2 = load i18* %%imf1_o, align 4, !dbg !4 for 0x%I64xth hint within @AESL_ORIG_DUT_duc  --> \n", ++aesl_llvm_cbe_28_count);
  llvm_cbe_tmp__2 = (unsigned int )*(&llvm_cbe_imf1_o);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__2);
if (AESL_DEBUG_TRACE)
printf("\n  call void @imf2(i18* %%imf2_o, i18 signext %%2) nounwind, !dbg !4 for 0x%I64xth hint within @AESL_ORIG_DUT_duc  --> \n", ++aesl_llvm_cbe_29_count);
  imf2((signed int *)(&llvm_cbe_imf2_o), llvm_cbe_tmp__2);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",llvm_cbe_tmp__2);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%3 = load i18* %%imf2_o, align 4, !dbg !4 for 0x%I64xth hint within @AESL_ORIG_DUT_duc  --> \n", ++aesl_llvm_cbe_36_count);
  llvm_cbe_tmp__3 = (unsigned int )*(&llvm_cbe_imf2_o);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__3);
if (AESL_DEBUG_TRACE)
printf("\n  call void @imf3(i18* %%imf3_o, i18 signext %%3) nounwind, !dbg !4 for 0x%I64xth hint within @AESL_ORIG_DUT_duc  --> \n", ++aesl_llvm_cbe_37_count);
  imf3((signed int *)(&llvm_cbe_imf3_o), llvm_cbe_tmp__3);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",llvm_cbe_tmp__3);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%4 = load i18* %%imf3_o, align 4, !dbg !2 for 0x%I64xth hint within @AESL_ORIG_DUT_duc  --> \n", ++aesl_llvm_cbe_44_count);
  llvm_cbe_tmp__4 = (unsigned int )*(&llvm_cbe_imf3_o);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__4);
if (AESL_DEBUG_TRACE)
printf("\n  call void @mixer(i16 zeroext %%freq, i18 signext %%4, i18* %%dout_i, i18* %%dout_q) nounwind, !dbg !2 for 0x%I64xth hint within @AESL_ORIG_DUT_duc  --> \n", ++aesl_llvm_cbe_45_count);

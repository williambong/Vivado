...
if (AESL_DEBUG_TRACE)
printf("\n  %%4 = tail call i37 @mult(i18 signext %%c, i19 signext %%3) nounwind, !dbg !6 for 0x%I64xth hint within @mix_SubDSP  --> \n", ++aesl_llvm_cbe_12_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%4 = tail call i37 @mult(i18 signext %%c, i19 signext %%3) nounwind, !dbg !6 for 0x%I64xth hint within @mix_AddDSP  --> \n", ++aesl_llvm_cbe_27_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%5 = trunc i37 %%4 to i36, !dbg !6 for 0x%I64xth hint within @mix_AddDSP  --> \n", ++aesl_llvm_cbe_30_count);
...
printf("\n\{ BEGIN @mixer\n");
if (AESL_DEBUG_TRACE)
printf("\n  %%1 = load i3* @aesl_internal_mixer.i, align 1, !dbg !7 for 0x%I64xth hint within @mixer  --> \n", ++aesl_llvm_cbe_42_count);
  llvm_cbe_tmp__10 = (unsigned char )*(&aesl_internal_mixer_OC_i);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__10);
if (AESL_DEBUG_TRACE)
printf("\n  %%2 = add i3 %%1, 1, !dbg !7 for 0x%I64xth hint within @mixer  --> \n", ++aesl_llvm_cbe_43_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%4 = load i1* @aesl_internal_mixer.init, align 1, !dbg !5 for 0x%I64xth hint within @mixer  --> \n", ++aesl_llvm_cbe_51_count);
  llvm_cbe_tmp__12 = (bool )((*(&aesl_internal_mixer_OC_init))&1);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__12);
if (AESL_DEBUG_TRACE)
printf("\n  %%5 = select i1 %%4, i16 0, i16 %%freq, !dbg !5 for 0x%I64xth hint within @mixer  --> \n", ++aesl_llvm_cbe_52_count);
  llvm_cbe_tmp__13 = (unsigned short )((llvm_cbe_tmp__12) ? ((unsigned short )((unsigned short )0)) : ((unsigned short )llvm_cbe_freq));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__13);
if (AESL_DEBUG_TRACE)
printf("\n  store i18 %%Din, i18* @aesl_internal_mixer.Din_im, align 4, !dbg !5 for 0x%I64xth hint within @mixer  --> \n", ++aesl_llvm_cbe_55_count);
  *(&aesl_internal_mixer_OC_Din_im) = ((llvm_cbe_Din) & 262143ull);
if (AESL_DEBUG_TRACE)
printf("\nDin = 0x%X\n", llvm_cbe_Din);
if (AESL_DEBUG_TRACE)
printf("\n  %%6 = load i1* @aesl_internal_mixer.ch, align 1, !dbg !7 for 0x%I64xth hint within @mixer  --> \n", ++aesl_llvm_cbe_56_count);
...
llvm_cbe_tmp__54:
if (AESL_DEBUG_TRACE)
printf("\n  %%9 = load i4* @aesl_internal_mixer.index, align 1, !dbg !8 for 0x%I64xth hint within @mixer  --> \n", ++aesl_llvm_cbe_59_count);
  llvm_cbe_tmp__15 = (unsigned char )*(&aesl_internal_mixer_OC_index);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__15);
if (AESL_DEBUG_TRACE)
printf("\n  %%10 = zext i4 %%9 to i64, !dbg !8 for 0x%I64xth hint within @mixer  --> \n", ++aesl_llvm_cbe_60_count);
  llvm_cbe_tmp__16 = (unsigned long long )((unsigned long long )(unsigned char )llvm_cbe_tmp__15&15U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__16);
if (AESL_DEBUG_TRACE)
printf("\n  %%11 = getelementptr inbounds [16 x i18]* @aesl_internal_mixer.DI_cache, i64 0, i64 %%10, !dbg !8 for 0x%I64xth hint within @mixer  --> \n", ++aesl_llvm_cbe_61_count);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  store i18 %%Din, i18* %%11, align 4, !dbg !8 for 0x%I64xth hint within @mixer  --> \n", ++aesl_llvm_cbe_62_count);
...
llvm_cbe_tmp__56:
if (AESL_DEBUG_TRACE)
printf("\n  call void @dds(i16 zeroext %%5, i16* %%sine, i16* %%cosine) nounwind, !dbg !8 for 0x%I64xth hint within @mixer  --> \n", ++aesl_llvm_cbe_65_count);
  dds(llvm_cbe_tmp__13, (signed short *)(&llvm_cbe_sine), (signed short *)(&llvm_cbe_cosine));
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",llvm_cbe_tmp__13);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%14 = load i4* @aesl_internal_mixer.index, align 1, !dbg !8 for 0x%I64xth hint within @mixer  --> \n", ++aesl_llvm_cbe_66_count);
  llvm_cbe_tmp__18 = (unsigned char )*(&aesl_internal_mixer_OC_index);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__18);
if (AESL_DEBUG_TRACE)
printf("\n  %%15 = zext i4 %%14 to i64, !dbg !8 for 0x%I64xth hint within @mixer  --> \n", ++aesl_llvm_cbe_67_count);
  llvm_cbe_tmp__19 = (unsigned long long )((unsigned long long )(unsigned char )llvm_cbe_tmp__18&15U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__19);
if (AESL_DEBUG_TRACE)
printf("\n  %%16 = getelementptr inbounds [16 x i18]* @aesl_internal_mixer.DI_cache, i64 0, i64 %%15, !dbg !8 for 0x%I64xth hint within @mixer  --> \n", ++aesl_llvm_cbe_68_count);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  %%17 = load i18* %%16, align 4, !dbg !8 for 0x%I64xth hint within @mixer  --> \n", ++aesl_llvm_cbe_69_count);
  llvm_cbe_tmp__21 = (unsigned int )*llvm_cbe_tmp__20;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__21);
if (AESL_DEBUG_TRACE)
printf("\n  %%18 = load i16* %%sine, align 2, !dbg !8 for 0x%I64xth hint within @mixer  --> \n", ++aesl_llvm_cbe_79_count);
  llvm_cbe_tmp__22 = (unsigned short )*(&llvm_cbe_sine);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__22);
if (AESL_DEBUG_TRACE)
printf("\n  %%19 = sext i16 %%18 to i18, !dbg !8 for 0x%I64xth hint within @mixer  --> \n", ++aesl_llvm_cbe_80_count);
  llvm_cbe_tmp__23 = (unsigned int )((signed int )(signed short )llvm_cbe_tmp__22);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__23);
if (AESL_DEBUG_TRACE)
printf("\n  %%20 = load i16* %%cosine, align 2, !dbg !8 for 0x%I64xth hint within @mixer  --> \n", ++aesl_llvm_cbe_87_count);
  llvm_cbe_tmp__24 = (unsigned short )*(&llvm_cbe_cosine);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__24);
if (AESL_DEBUG_TRACE)
printf("\n  %%21 = sext i16 %%20 to i18, !dbg !8 for 0x%I64xth hint within @mixer  --> \n", ++aesl_llvm_cbe_88_count);
  llvm_cbe_tmp__25 = (unsigned int )((signed int )(signed short )llvm_cbe_tmp__24);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__25);
if (AESL_DEBUG_TRACE)
printf("\n  %%22 = load i18* @aesl_internal_mixer.Din_im, align 4, !dbg !8 for 0x%I64xth hint within @mixer  --> \n", ++aesl_llvm_cbe_89_count);
  llvm_cbe_tmp__26 = (unsigned int )*(&aesl_internal_mixer_OC_Din_im);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__26);
if (AESL_DEBUG_TRACE)
printf("\n  %%23 = call i37 @mix_SubDSP(i18 signext %%19, i18 signext %%21, i18 signext %%22), !dbg !8 for 0x%I64xth hint within @mixer  --> \n", ++aesl_llvm_cbe_90_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%24 = trunc i37 %%23 to i34, !dbg !8 for 0x%I64xth hint within @mixer  --> \n", ++aesl_llvm_cbe_91_count);
  llvm_cbe_tmp__28 = (unsigned long long )((unsigned long long )llvm_cbe_tmp__27&17179869183ULL);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__28);
if (AESL_DEBUG_TRACE)
printf("\n  %%25 = zext i34 %%24 to i37, !dbg !9 for 0x%I64xth hint within @mixer  --> \n", ++aesl_llvm_cbe_95_count);
  llvm_cbe_tmp__29 = (unsigned long long )((unsigned long long )(unsigned long long )llvm_cbe_tmp__28&17179869183ULL);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__29);
if (AESL_DEBUG_TRACE)
printf("\n  %%26 = load i18* @aesl_internal_mixer.Din_im, align 4, !dbg !6 for 0x%I64xth hint within @mixer  --> \n", ++aesl_llvm_cbe_96_count);
  llvm_cbe_tmp__30 = (unsigned int )*(&aesl_internal_mixer_OC_Din_im);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__30);
if (AESL_DEBUG_TRACE)
printf("\n  %%27 = load i16* %%sine, align 2, !dbg !6 for 0x%I64xth hint within @mixer  --> \n", ++aesl_llvm_cbe_103_count);
  llvm_cbe_tmp__31 = (unsigned short )*(&llvm_cbe_sine);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__31);
if (AESL_DEBUG_TRACE)
printf("\n  %%28 = sext i16 %%27 to i18, !dbg !6 for 0x%I64xth hint within @mixer  --> \n", ++aesl_llvm_cbe_104_count);
  llvm_cbe_tmp__32 = (unsigned int )((signed int )(signed short )llvm_cbe_tmp__31);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__32);
if (AESL_DEBUG_TRACE)
printf("\n  %%29 = call i37 @mix_SubDSP(i18 signext %%17, i18 signext %%26, i18 signext %%28), !dbg !6 for 0x%I64xth hint within @mixer  --> \n", ++aesl_llvm_cbe_105_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%30 = add nsw i37 %%29, %%25, !dbg !6 for 0x%I64xth hint within @mixer  --> \n", ++aesl_llvm_cbe_106_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%31 = lshr i37 %%30, 14, !dbg !6 for 0x%I64xth hint within @mixer  --> \n", ++aesl_llvm_cbe_107_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%32 = trunc i37 %%31 to i18, !dbg !6 for 0x%I64xth hint within @mixer  --> \n", ++aesl_llvm_cbe_108_count);
  llvm_cbe_tmp__36 = (unsigned int )((unsigned int )llvm_cbe_tmp__35&262143U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__36);
if (AESL_DEBUG_TRACE)
printf("\n  store i18 %%32, i18* %%Dout_I, align 4, !dbg !6 for 0x%I64xth hint within @mixer  --> \n", ++aesl_llvm_cbe_109_count);
  *llvm_cbe_Dout_I = ((llvm_cbe_tmp__36) & 262143ull);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__36);
if (AESL_DEBUG_TRACE)
printf("\n  %%33 = zext i34 %%24 to i36, !dbg !9 for 0x%I64xth hint within @mixer  --> \n", ++aesl_llvm_cbe_110_count);
  llvm_cbe_tmp__37 = (unsigned long long )((unsigned long long )(unsigned long long )llvm_cbe_tmp__28&17179869183ULL);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__37);
if (AESL_DEBUG_TRACE)
printf("\n  %%34 = load i18* @aesl_internal_mixer.Din_im, align 4, !dbg !6 for 0x%I64xth hint within @mixer  --> \n", ++aesl_llvm_cbe_111_count);
  llvm_cbe_tmp__38 = (unsigned int )*(&aesl_internal_mixer_OC_Din_im);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__38);
if (AESL_DEBUG_TRACE)
printf("\n  %%35 = load i16* %%cosine, align 2, !dbg !6 for 0x%I64xth hint within @mixer  --> \n", ++aesl_llvm_cbe_118_count);
  llvm_cbe_tmp__39 = (unsigned short )*(&llvm_cbe_cosine);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__39);
if (AESL_DEBUG_TRACE)
printf("\n  %%36 = sext i16 %%35 to i18, !dbg !6 for 0x%I64xth hint within @mixer  --> \n", ++aesl_llvm_cbe_119_count);
  llvm_cbe_tmp__40 = (unsigned int )((signed int )(signed short )llvm_cbe_tmp__39);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__40);
if (AESL_DEBUG_TRACE)
printf("\n  %%37 = call i36 @mix_AddDSP(i18 signext %%17, i18 signext %%34, i18 signext %%36), !dbg !6 for 0x%I64xth hint within @mixer  --> \n", ++aesl_llvm_cbe_120_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%38 = add nsw i36 %%37, %%33, !dbg !6 for 0x%I64xth hint within @mixer  --> \n", ++aesl_llvm_cbe_121_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%39 = lshr i36 %%38, 14, !dbg !6 for 0x%I64xth hint within @mixer  --> \n", ++aesl_llvm_cbe_122_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%40 = trunc i36 %%39 to i18, !dbg !6 for 0x%I64xth hint within @mixer  --> \n", ++aesl_llvm_cbe_123_count);
  llvm_cbe_tmp__44 = (unsigned int )((unsigned int )llvm_cbe_tmp__43&262143U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__44);
if (AESL_DEBUG_TRACE)
printf("\n  store i18 %%40, i18* %%Dout_Q, align 4, !dbg !6 for 0x%I64xth hint within @mixer  --> \n", ++aesl_llvm_cbe_124_count);
  *llvm_cbe_Dout_Q = ((llvm_cbe_tmp__44) & 262143ull);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__44);
if (AESL_DEBUG_TRACE)
printf("\n  %%41 = load i4* @aesl_internal_mixer.index, align 1, !dbg !9 for 0x%I64xth hint within @mixer  --> \n", ++aesl_llvm_cbe_125_count);
...
llvm_cbe_tmp__57:
if (AESL_DEBUG_TRACE)
printf("\n  store i1 false, i1* @aesl_internal_mixer.init, align 1, !dbg !9 for 0x%I64xth hint within @mixer  --> \n", ++aesl_llvm_cbe_128_count);
...
llvm_cbe_tmp__55:
if (AESL_DEBUG_TRACE)
printf("\n  %%46 = load i4* @aesl_internal_mixer.index, align 1, !dbg !9 for 0x%I64xth hint within @mixer  --> \n", ++aesl_llvm_cbe_132_count);
...
llvm_cbe_tmp__59:
if (AESL_DEBUG_TRACE)
printf("\n  %%49 = load i1* @aesl_internal_mixer.ch, align 1, !dbg !9 for 0x%I64xth hint within @mixer  --> \n", ++aesl_llvm_cbe_135_count);
  llvm_cbe_tmp__47 = (bool )((*(&aesl_internal_mixer_OC_ch))&1);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__47);
if (AESL_DEBUG_TRACE)
printf("\n  %%50 = xor i1 %%49, true, !dbg !9 for 0x%I64xth hint within @mixer  --> \n", ++aesl_llvm_cbe_136_count);
  llvm_cbe_tmp__48 = (bool )((llvm_cbe_tmp__47 ^ 1)&1);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__48);
if (AESL_DEBUG_TRACE)
printf("\n  store i1 %%50, i1* @aesl_internal_mixer.ch, align 1, !dbg !9 for 0x%I64xth hint within @mixer  --> \n", ++aesl_llvm_cbe_137_count);
...
llvm_cbe_tmp__61:
if (AESL_DEBUG_TRACE)
printf("\n  %%53 = add i4 %%46, 1, !dbg !10 for 0x%I64xth hint within @mixer  --> \n", ++aesl_llvm_cbe_140_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  store i4 %%53, i4* @aesl_internal_mixer.index, align 1, !dbg !10 for 0x%I64xth hint within @mixer  --> \n", ++aesl_llvm_cbe_141_count);
...
llvm_cbe_tmp__62:
if (AESL_DEBUG_TRACE)
printf("\n  %%55 = load i3* @aesl_internal_mixer.i, align 1, !dbg !7 for 0x%I64xth hint within @mixer  --> \n", ++aesl_llvm_cbe_143_count);
  llvm_cbe_tmp__50 = (unsigned char )*(&aesl_internal_mixer_OC_i);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__50);
if (AESL_DEBUG_TRACE)
printf("\n  %%57 = select i1 %%56, i3 0, i3 %%2, !dbg !7 for 0x%I64xth hint within @mixer  --> \n", ++aesl_llvm_cbe_145_count);
...
printf("\n = 0x%X\n", llvm_cbe_tmp__51);
if (AESL_DEBUG_TRACE)
printf("\n  store i3 %%57, i3* @aesl_internal_mixer.i, align 1, !dbg !7 for 0x%I64xth hint within @mixer  --> \n", ++aesl_llvm_cbe_146_count);

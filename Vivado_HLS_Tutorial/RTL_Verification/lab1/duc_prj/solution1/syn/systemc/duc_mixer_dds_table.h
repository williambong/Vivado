...
#ifndef __duc_mixer_dds_table_H__
#define __duc_mixer_dds_table_H__
...
struct duc_mixer_dds_table_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(duc_mixer_dds_table_ram) {
...
duc_mixer_dds_table_ram* meminst;


SC_CTOR(duc_mixer_dds_table) {
meminst = new duc_mixer_dds_table_ram("duc_mixer_dds_table_ram");

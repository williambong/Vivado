...
architecture behav of duc_imf2 is 
    ...
    signal i_2 : STD_LOGIC_VECTOR (3 downto 0) := "0000";
    ...
    signal shift_reg_p_2_address0 : STD_LOGIC_VECTOR (4 downto 0);
    ...
    signal cnt_1 : STD_LOGIC_VECTOR (1 downto 0) := "00";
    signal i_2_load_reg_257 : STD_LOGIC_VECTOR (3 downto 0);
    signal inc_fu_100_p2 : STD_LOGIC_VECTOR (3 downto 0);
    signal inc_reg_267 : STD_LOGIC_VECTOR (3 downto 0);
    signal c_2_load_reg_278 : STD_LOGIC_VECTOR (17 downto 0);
    ...
    signal shift_reg_p_2_load_reg_310 : STD_LOGIC_VECTOR (37 downto 0);
    ...
    signal tmp_3_fu_122_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_8_fu_185_p1 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal tmp_7_fu_217_p2 : STD_LOGIC_VECTOR (1 downto 0);
    signal tmp_1_fu_115_p3 : STD_LOGIC_VECTOR (4 downto 0);
    ...
    signal tmp_4_fu_179_p3 : STD_LOGIC_VECTOR (4 downto 0);
    ...
    component duc_imf2_shift_reg_p_2 IS
    generic (
        DataWidth : INTEGER;
        AddressRange : INTEGER;
        AddressWidth : INTEGER );
...
begin
    ...
    shift_reg_p_2_U : component duc_imf2_shift_reg_p_2
    generic map (
        DataWidth => 38,
        AddressRange => 26,
        AddressWidth => 5)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_sig_cseq_ST_st7_fsm_6) and not((ap_const_lv1_0 = sel_tmp1_reg_294)) and not((ap_const_lv1_0 = tmp_5_fu_194_p2)))) then
                ch_2 <= tmp_6_fu_206_p2;
            end if;
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_sig_cseq_ST_st7_fsm_6) and not((ap_const_lv1_0 = sel_tmp1_reg_294)) and not((ap_const_lv1_0 = tmp_5_fu_194_p2)) and not((ap_const_lv1_0 = ch_2_load_reg_283)))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_sig_cseq_ST_st3_fsm_2)) then
                ...
                shift_reg_p_2_load_reg_310 <= shift_reg_p_2_q0;
            end if;
        end if;
    end process;
    ...
    c_2_address0 <= tmp_s_fu_106_p1(4 - 1 downto 0);

    -- c_2_ce0 assign process. --
    c_2_ce0_assign_proc : process(ap_start, ap_sig_cseq_ST_st1_fsm_0)
    begin
        if (((ap_const_logic_1 = ap_sig_cseq_ST_st1_fsm_0) and not((ap_start = ap_const_logic_0)))) then 
    ...
    grp_fu_250_p0 <= c_2_load_reg_278;
    grp_fu_250_p1 <= in_2;
    grp_fu_250_p2 <= s_assign_reg_330;
    inc_3_fu_238_p3 <= 
        ap_const_lv4_0 when (sel_tmp1_reg_294(0) = '1') else 
        inc_reg_267;
    inc_fu_100_p2 <= std_logic_vector(unsigned(i_2) + unsigned(ap_const_lv4_1));
    s_assign_fu_172_p3 <= 
        ap_const_lv38_0 when (tmp_2_fu_168_p2(0) = '1') else 
        shift_reg_p_2_load_reg_310;
    sel_tmp1_fu_127_p2 <= "1" when (i_2_load_reg_257 = ap_const_lv4_B) else "0";
    sel_tmp2_fu_132_p2 <= "1" when (i_2_load_reg_257 = ap_const_lv4_5) else "0";
    sel_tmp3_fu_145_p2 <= (init_2 xor ap_const_lv1_1);
    ...
    shift_reg_p_2_address0_assign_proc : process(ap_sig_cseq_ST_st2_fsm_1, tmp_3_fu_122_p1, tmp_8_fu_185_p1, ap_sig_cseq_ST_st7_fsm_6)
    begin
        if ((ap_const_logic_1 = ap_sig_cseq_ST_st7_fsm_6)) then 
            shift_reg_p_2_address0 <= tmp_8_fu_185_p1(5 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_sig_cseq_ST_st2_fsm_1)) then 
            shift_reg_p_2_address0 <= tmp_3_fu_122_p1(5 - 1 downto 0);
        else 
    ...
    shift_reg_p_2_ce0_assign_proc : process(ap_sig_cseq_ST_st2_fsm_1, ap_sig_cseq_ST_st7_fsm_6)
    begin
    ...
    shift_reg_p_2_d0 <= sum_reg_335;

    -- shift_reg_p_2_we0 assign process. --
    shift_reg_p_2_we0_assign_proc : process(ap_sig_cseq_ST_st7_fsm_6)
    begin
        if (((ap_const_logic_1 = ap_sig_cseq_ST_st7_fsm_6))) then 
    ...
    tmp_1_fu_115_p3 <= (inc_reg_267 & ch_2);
    tmp_2_fu_168_p2 <= (sel_tmp5_reg_315 or init_2);
    tmp_3_fu_122_p1 <= std_logic_vector(resize(unsigned(tmp_1_fu_115_p3),64));
    tmp_4_fu_179_p3 <= (i_2_load_reg_257 & ch_2_load_reg_283);
    tmp_5_fu_194_p2 <= "1" when (cnt_1 = ap_const_lv2_3) else "0";
    tmp_6_fu_206_p2 <= (ch_2_load_reg_283 xor ap_const_lv1_1);
    tmp_7_fu_217_p2 <= std_logic_vector(unsigned(cnt_1) + unsigned(ap_const_lv2_1));
    tmp_8_fu_185_p1 <= std_logic_vector(resize(unsigned(tmp_4_fu_179_p3),64));
    tmp_fu_88_p2 <= "1" when (i_2 = ap_const_lv4_0) else "0";
    tmp_s_fu_106_p1 <= std_logic_vector(resize(unsigned(i_2),64));
end behav;

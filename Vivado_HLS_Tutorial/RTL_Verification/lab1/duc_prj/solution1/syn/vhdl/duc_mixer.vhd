...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_sig_cseq_ST_st10_fsm_9) and not((ap_const_lv1_0 = tmp_11_fu_290_p2)))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_sig_cseq_ST_st10_fsm_9) and (brmerge_demorgan_reg_386 = ap_const_lv1_0) and not((valid_in_reg_377 = ap_const_lv1_0)) and not((ap_const_lv1_0 = tmp_10_fu_279_p2)))) then
    ...
    Dout_I <= tmp_3_reg_462(31 downto 14);
    ...
    Dout_Q <= tmp_6_reg_467(31 downto 14);
    ...
    dds_table_address1 <= tmp_53_i_fu_230_p1(5 - 1 downto 0);
    ...
    grp_fu_353_p2 <= Din;
    inc_5_fu_322_p3 <= 
        ap_const_lv3_0 when (tmp_14_fu_317_p2(0) = '1') else 
        inc_reg_372;
    ...
    tmp_10_fu_279_p2 <= "1" when (index_load_reg_390 = ap_const_lv4_F) else "0";
    tmp_11_fu_290_p2 <= "1" when (index_load_reg_390 = ap_const_lv4_F) else "0";
    tmp_12_fu_295_p2 <= (ch_3_load_reg_381 xor ap_const_lv1_1);
    tmp_13_fu_306_p2 <= std_logic_vector(unsigned(index_load_reg_390) + unsigned(ap_const_lv4_1));
    tmp_14_fu_317_p2 <= "1" when (i_4_load_reg_367 = ap_const_lv3_5) else "0";
    tmp_15_fu_148_p4 <= i_4(2 downto 1);
    tmp_53_i_fu_230_p1 <= std_logic_vector(resize(unsigned(phase2_reg_404),64));
    ...
    valid_in_fu_158_p2 <= "1" when (tmp_15_fu_148_p4 = ap_const_lv2_0) else "0";
end behav;

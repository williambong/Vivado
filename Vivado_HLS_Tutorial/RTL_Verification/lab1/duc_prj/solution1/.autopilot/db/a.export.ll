; ModuleID = 'D:/opt/source/Vivado/Vivado_HLS_Tutorial/RTL_Verification/lab1/duc_prj/solution1/.autopilot/db/a.o.2.bc'
...
@c_1 = internal unnamed_addr constant [24 x i18] [i18 -224, i18 1139, i18 -3642, i18 9343, i18 -22689, i18 81597, i18 81597, i18 -22689, i18 9343, i18 -3642, i18 1139, i18 -224, i18 0, i18 0, i18 0, i18 0, i18 0, i18 131071, i18 0, i18 0, i18 0, i18 0, i18 0, i18 0], align 16
@shift_reg_p_1 = internal global [50 x i38] zeroinitializer
@in_1 = internal unnamed_addr global i18 0, align 4
@init_1 = internal unnamed_addr global i1 true, align 1
@cnt = internal unnamed_addr global i1 false, align 1
@ch_1 = internal unnamed_addr global i1 false, align 1
@i_1 = internal unnamed_addr global i5 0, align 1
@c_2 = internal unnamed_addr constant [12 x i18] [i18 2054, i18 -14177, i18 77667, i18 77667, i18 -14177, i18 2054, i18 0, i18 0, i18 131071, i18 0, i18 0, i18 0], align 16
@shift_reg_p_2 = internal global [26 x i38] zeroinitializer
@in_2 = internal unnamed_addr global i18 0, align 4
@init_2 = internal unnamed_addr global i1 true, align 1
@cnt_1 = internal unnamed_addr global i2 0, align 1
@ch_2 = internal unnamed_addr global i1 false, align 1
@i_2 = internal unnamed_addr global i4 0, align 1
@c_3_0 = internal unnamed_addr constant [6 x i18] [i18 1651, i18 -13134, i18 77019, i18 77019, i18 -13134, i18 1651]
...
@i_3 = internal unnamed_addr global i6 0, align 1
...
@i_4 = internal unnamed_addr global i3 0, align 1
@ch_3 = internal unnamed_addr global i1 true, align 1
...
@c_3_1 = internal unnamed_addr constant [6 x i1] [i1 false, i1 false, i1 false, i1 true, i1 false, i1 false]
...
._crit_edge_ifconv.i:                             ; preds = %1, %0
  ...
  %tmp_2 = call i7 @_ssdm_op_BitConcatenate.i7.i6.i1(i6 %inc, i1 %ch_load)
  %tmp_3 = zext i7 %tmp_2 to i64
  %shift_reg_p_addr = getelementptr [96 x i38]* @shift_reg_p, i64 0, i64 %tmp_3
  ...
  %tmp_i_i_10 = sext i18 %in_load to i36
  %m = mul nsw i36 %tmp_i_i, %tmp_i_i_10
  %tmp_54_i_i = sext i36 %m to i38
  %acc_1 = add i38 %tmp_54_i_i, %tmp_5_i
  %tmp_4 = call i7 @_ssdm_op_BitConcatenate.i7.i6.i1(i6 %i_load, i1 %ch_load)
  %tmp_5 = zext i7 %tmp_4 to i64
  %shift_reg_p_addr_1 = getelementptr [96 x i38]* @shift_reg_p, i64 0, i64 %tmp_5
...
._crit_edge9.i:                                   ; preds = %3, %2
  %tmp_i_11 = xor i1 %ch_load, true
  store i1 %tmp_i_11, i1* @ch, align 1
  br label %srrc.exit
...
srrc.exit:                                        ; preds = %._crit_edge9.i, %._crit_edge_ifconv.i
  ...
  %inc_1 = select i1 %sel_tmp1_i, i6 0, i6 %inc
  store i6 %inc_1, i6* @i, align 1
  %i_1_load = load i5* @i_1, align 1
  %tmp_i1 = icmp eq i5 %i_1_load, 0
  br i1 %tmp_i1, label %4, label %._crit_edge_ifconv.i17

; <label>:4                                       ; preds = %srrc.exit
  store i18 %srrc_o, i18* @in_1, align 4
  br label %._crit_edge_ifconv.i17

._crit_edge_ifconv.i17:                           ; preds = %4, %srrc.exit
  %inc_2 = add i5 %i_1_load, 1
  %tmp_i3 = zext i5 %i_1_load to i64
  %c_1_addr = getelementptr inbounds [24 x i18]* @c_1, i64 0, i64 %tmp_i3
  ...
  %tmp_6 = call i6 @_ssdm_op_BitConcatenate.i6.i5.i1(i5 %inc_2, i1 %ch_1_load)
  %tmp_7 = zext i6 %tmp_6 to i64
  %shift_reg_p_1_addr = getelementptr [50 x i38]* @shift_reg_p_1, i64 0, i64 %tmp_7
  %shift_reg_p_1_load = load i38* %shift_reg_p_1_addr, align 8
  %sel_tmp1_i9 = icmp eq i5 %i_1_load, -9
  %sel_tmp2_i1 = icmp eq i5 %i_1_load, 11
  %sel_tmp3_i1 = xor i1 %init_1_load, true
  %sel_tmp4_i1 = or i1 %sel_tmp1_i9, %sel_tmp2_i1
  %sel_tmp5_i1 = and i1 %sel_tmp4_i1, %sel_tmp3_i1
  %tmp_1 = or i1 %sel_tmp5_i1, %init_1_load
  %s_assign = select i1 %tmp_1, i38 0, i38 %shift_reg_p_1_load
  %tmp_i_i1 = sext i18 %c_1_load to i36
  %tmp_i_i1_12 = sext i18 %in_1_load to i36
  %m_1 = mul nsw i36 %tmp_i_i1, %tmp_i_i1_12
  %tmp_57_i_i = sext i36 %m_1 to i38
  %sum = add nsw i38 %tmp_57_i_i, %s_assign
  %tmp_8 = call i6 @_ssdm_op_BitConcatenate.i6.i5.i1(i5 %i_1_load, i1 %ch_1_load)
  %tmp_9 = zext i6 %tmp_8 to i64
  %shift_reg_p_1_addr_1 = getelementptr [50 x i38]* @shift_reg_p_1, i64 0, i64 %tmp_9
  store i38 %sum, i38* %shift_reg_p_1_addr_1, align 8
  br i1 %sel_tmp1_i9, label %5, label %imf1.exit

; <label>:5                                       ; preds = %._crit_edge_ifconv.i17
  br i1 %ch_1_load, label %6, label %._crit_edge9.i18

; <label>:6                                       ; preds = %5
  store i1 false, i1* @init_1, align 1
  br label %._crit_edge9.i18

._crit_edge9.i18:                                 ; preds = %6, %5
  %cnt_load = load i1* @cnt, align 1
  %tmp_6_i = xor i1 %ch_1_load, %cnt_load
  store i1 %tmp_6_i, i1* @ch_1, align 1
  %tmp_7_i = xor i1 %cnt_load, true
  store i1 %tmp_7_i, i1* @cnt, align 1
  br label %imf1.exit

imf1.exit:                                        ; preds = %._crit_edge9.i18, %._crit_edge_ifconv.i17
  %imf1_o = call i18 @_ssdm_op_PartSelect.i18.i38.i32.i32(i38 %sum, i32 17, i32 34)
  %inc_3 = select i1 %sel_tmp1_i9, i5 0, i5 %inc_2
  store i5 %inc_3, i5* @i_1, align 1
...
define internal fastcc i18 @duc_imf2(i18 signext %x) {
  ...
  %i_2_load = load i4* @i_2, align 1
  %tmp = icmp eq i4 %i_2_load, 0
...
._crit_edge_ifconv:                               ; preds = %1, %0
  %inc = add i4 %i_2_load, 1
  %tmp_s = zext i4 %i_2_load to i64
  %c_2_addr = getelementptr inbounds [12 x i18]* @c_2, i64 0, i64 %tmp_s
  ...
  %tmp_1 = call i5 @_ssdm_op_BitConcatenate.i5.i4.i1(i4 %inc, i1 %ch_2_load)
  %tmp_3 = zext i5 %tmp_1 to i64
  %shift_reg_p_2_addr = getelementptr [26 x i38]* @shift_reg_p_2, i64 0, i64 %tmp_3
  %shift_reg_p_2_load = load i38* %shift_reg_p_2_addr, align 8
  %sel_tmp1 = icmp eq i4 %i_2_load, -5
  %sel_tmp2 = icmp eq i4 %i_2_load, 5
  %sel_tmp3 = xor i1 %init_2_load, true
  %sel_tmp4 = or i1 %sel_tmp1, %sel_tmp2
  %sel_tmp5 = and i1 %sel_tmp4, %sel_tmp3
  %tmp_2 = or i1 %sel_tmp5, %init_2_load
  %s_assign = select i1 %tmp_2, i38 0, i38 %shift_reg_p_2_load
  %tmp_i = sext i18 %c_2_load to i36
  %tmp_i_13 = sext i18 %in_2_load to i36
  %m = mul nsw i36 %tmp_i, %tmp_i_13
  %tmp_58_i = sext i36 %m to i38
  %sum = add nsw i38 %tmp_58_i, %s_assign
  %tmp_4 = call i5 @_ssdm_op_BitConcatenate.i5.i4.i1(i4 %i_2_load, i1 %ch_2_load)
  %tmp_8 = zext i5 %tmp_4 to i64
  %shift_reg_p_2_addr_1 = getelementptr [26 x i38]* @shift_reg_p_2, i64 0, i64 %tmp_8
...
; <label>:2                                       ; preds = %._crit_edge_ifconv
  %cnt_1_load = load i2* @cnt_1, align 1
  %tmp_5 = icmp eq i2 %cnt_1_load, -1
  br i1 %tmp_5, label %3, label %._crit_edge9
...
._crit_edge10:                                    ; preds = %4, %3
  %tmp_6 = xor i1 %ch_2_load, true
  store i1 %tmp_6, i1* @ch_2, align 1
  br label %._crit_edge9

._crit_edge9:                                     ; preds = %._crit_edge10, %2
  %tmp_7 = add i2 %cnt_1_load, 1
  store i2 %tmp_7, i2* @cnt_1, align 1
...
._crit_edge8_ifconv:                              ; preds = %._crit_edge9, %._crit_edge_ifconv
  ...
  store i4 %inc_3, i4* @i_2, align 1
  ret i18 %y_write_assign
}

define internal fastcc i18 @duc_imf3(i18 signext %x) {
  %x_read = call i18 @_ssdm_op_Read.ap_auto.i18(i18 %x)
  %i_3_load = load i6* @i_3, align 1
  %tmp = icmp eq i6 %i_3_load, 0
  %in_3_load = load i18* @in_3, align 4
  br i1 %tmp, label %1, label %._crit_edge_ifconv

; <label>:1                                       ; preds = %0
  store i18 %x_read, i18* @in_3, align 4
  br label %._crit_edge_ifconv

._crit_edge_ifconv:                               ; preds = %1, %0
  %d_assign = phi i18 [ %x_read, %1 ], [ %in_3_load, %0 ]
  %inc = add i6 %i_3_load, 1
  %p_Val2_s = load i6* @j, align 1
  %ch_4 = call i1 @_ssdm_op_BitSelect.i1.i6.i32(i6 %p_Val2_s, i32 3)
  %tmp_s = zext i6 %i_3_load to i64
  %c_3_0_addr = getelementptr [6 x i18]* @c_3_0, i64 0, i64 %tmp_s
  %c_3_0_load = load i18* %c_3_0_addr, align 8
  %init_3_load = load i1* @init_3, align 1
  %tmp_9 = icmp eq i6 %i_3_load, 5
  %or_cond = or i1 %init_3_load, %tmp_9
  %tmp_10 = call i7 @_ssdm_op_BitConcatenate.i7.i6.i1(i6 %inc, i1 %ch_4)
  %tmp_11 = zext i7 %tmp_10 to i64
  %shift_reg_p0_addr = getelementptr [12 x i38]* @shift_reg_p0, i64 0, i64 %tmp_11
  %shift_reg_p0_load = load i38* %shift_reg_p0_addr, align 8
  %tmp_3 = select i1 %or_cond, i38 0, i38 %shift_reg_p0_load
  %tmp_i = sext i18 %c_3_0_load to i36
  %tmp_i_14 = sext i18 %d_assign to i36
  %tmp_i_cast = sext i18 %d_assign to i35
  %m = mul nsw i36 %tmp_i_14, %tmp_i
  %tmp_59_i = sext i36 %m to i38
  %acc0 = add i38 %tmp_3, %tmp_59_i
  %c_3_1_addr = getelementptr [6 x i1]* @c_3_1, i64 0, i64 %tmp_s
  %c_3_1_load = load i1* %c_3_1_addr, align 1
  %shift_reg_p1_addr = getelementptr [12 x i38]* @shift_reg_p1, i64 0, i64 %tmp_11
  %shift_reg_p1_load = load i38* %shift_reg_p1_addr, align 8
  %tmp_4 = select i1 %or_cond, i38 0, i38 %shift_reg_p1_load
  %p_shl = call i35 @_ssdm_op_BitConcatenate.i35.i18.i17(i18 %d_assign, i17 0)
  %mt = sub i35 %p_shl, %tmp_i_cast
  %m_1 = select i1 %c_3_1_load, i35 %mt, i35 0
  %tmp_59_i6 = sext i35 %m_1 to i38
  %acc1 = add i38 %tmp_4, %tmp_59_i6
  %tmp_12 = call i7 @_ssdm_op_BitConcatenate.i7.i6.i1(i6 %i_3_load, i1 %ch_4)
  %tmp_13 = zext i7 %tmp_12 to i64
  %shift_reg_p0_addr_1 = getelementptr [12 x i38]* @shift_reg_p0, i64 0, i64 %tmp_13
  store i38 %acc0, i38* %shift_reg_p0_addr_1, align 8
  %shift_reg_p1_addr_1 = getelementptr [12 x i38]* @shift_reg_p1, i64 0, i64 %tmp_13
  store i38 %acc1, i38* %shift_reg_p1_addr_1, align 8
  %tmp_14 = call i18 @_ssdm_op_PartSelect.i18.i38.i32.i32(i38 %acc0, i32 17, i32 34)
  %tmp_15 = call i18 @_ssdm_op_PartSelect.i18.i38.i32.i32(i38 %acc1, i32 17, i32 34)
  %tmp_16 = select i1 %tmp, i18 %tmp_14, i18 %tmp_15
  %tmp_7 = icmp eq i6 %p_Val2_s, 15
  %or_cond5 = and i1 %tmp_9, %tmp_7
...
._crit_edge8:                                     ; preds = %2, %._crit_edge_ifconv
  br i1 %tmp_9, label %._crit_edge10, label %._crit_edge9

._crit_edge10:                                    ; preds = %._crit_edge8
  %tmp_8 = add i6 %p_Val2_s, 1
  %tmp_1 = select i1 %tmp_7, i6 0, i6 %tmp_8
  store i6 %tmp_1, i6* @j, align 1
  br label %._crit_edge9

._crit_edge9:                                     ; preds = %._crit_edge10, %._crit_edge8
  %inc_4 = select i1 %tmp_9, i6 0, i6 %inc
  store i6 %inc_4, i6* @i_3, align 1
  ret i18 %tmp_16
}
...
define internal fastcc void @duc_mixer(i16 zeroext %freq, i18 signext %Din, i18* nocapture %Dout_I, i18* nocapture %Dout_Q) nounwind uwtable {
  ...
  %freq_read = call i16 @_ssdm_op_Read.ap_auto.i16(i16 %freq) nounwind
  %i_4_load = load i3* @i_4, align 1
  %inc = add i3 %i_4_load, 1
  %tmp_15 = call i2 @_ssdm_op_PartSelect.i2.i3.i32.i32(i3 %i_4_load, i32 1, i32 2)
  %valid_in = icmp eq i2 %tmp_15, 0
  %init_4_load = load i1* @init_4, align 1
  %freq_dds = select i1 %init_4_load, i16 0, i16 %freq_read
  %ch_3_load = load i1* @ch_3, align 1
  %brmerge_demorgan = and i1 %ch_3_load, %valid_in
...
; <label>:3                                       ; preds = %2
  ...
  %tmp_53_i = zext i5 %phase2 to i64
  %dds_table_addr_1 = getelementptr inbounds [32 x i16]* @dds_table, i64 0, i64 %tmp_53_i
  ...
  %tmp_8 = sub i17 %tmp_i3_cast, %tmp_i4_cast
  %tmp_i_i = sext i18 %Din_read to i32
  %tmp_i_i_15 = sext i17 %tmp_8 to i32
  %tmp_2 = mul i32 %tmp_i_i_15, %tmp_i_i
  %tmp_i5 = sext i18 %Din_re to i19
  %tmp_i6 = sext i18 %Din_read to i19
  %tmp_9 = sub i19 %tmp_i5, %tmp_i6
  %tmp_i_i8_cast = sext i16 %sine to i32
  %tmp_i_i9_cast = sext i19 %tmp_9 to i32
  %m = mul i32 %tmp_i_i9_cast, %tmp_i_i8_cast
  %tmp_3 = add i32 %m, %tmp_2
  %tmp_4 = call i18 @_ssdm_op_PartSelect.i18.i32.i32.i32(i32 %tmp_3, i32 14, i32 31)
  call void @_ssdm_op_Write.ap_auto.i18P(i18* %Dout_I, i18 %tmp_4) nounwind
  %tmp_5 = add i19 %tmp_i6, %tmp_i5
  %tmp_i_i1_cast = sext i16 %cosine to i32
  %tmp_i_i1_cast_16 = sext i19 %tmp_5 to i32
  %m_i_i = mul i32 %tmp_i_i1_cast_16, %tmp_i_i1_cast
  %tmp_6 = add i32 %m_i_i, %tmp_2
  %tmp_7 = call i18 @_ssdm_op_PartSelect.i18.i32.i32.i32(i32 %tmp_6, i32 14, i32 31)
  call void @_ssdm_op_Write.ap_auto.i18P(i18* %Dout_Q, i18 %tmp_7) nounwind
  %tmp_10 = icmp eq i4 %index_load, -1
  br i1 %tmp_10, label %4, label %._crit_edge2
...
; <label>:5                                       ; preds = %._crit_edge, %1
  %tmp_11 = icmp eq i4 %index_load, -1
  br i1 %tmp_11, label %6, label %._crit_edge3

; <label>:6                                       ; preds = %5
  %tmp_12 = xor i1 %ch_3_load, true
  store i1 %tmp_12, i1* @ch_3, align 1
...
; <label>:7                                       ; preds = %._crit_edge3
  %tmp_13 = add i4 %index_load, 1
  store i4 %tmp_13, i4* @index, align 1
  br label %._crit_edge4

._crit_edge4:                                     ; preds = %7, %._crit_edge3
  %tmp_14 = icmp eq i3 %i_4_load, -3
  %inc_5 = select i1 %tmp_14, i3 0, i3 %inc
  store i3 %inc_5, i3* @i_4, align 1
  ret void
}
...
entry:
  ...
  %empty_17 = zext i1 %1 to i7
  %empty_18 = shl i7 %empty, 1
...
entry:
  ...
  %empty_20 = trunc i38 %empty to i18
  ret i18 %empty_20
}
...
entry:
  ...
  %empty_24 = zext i1 %1 to i5
  %empty_25 = shl i5 %empty, 1
...
entry:
  ...
  %empty_27 = zext i17 %1 to i35
  %empty_28 = shl i35 %empty, 17
  %empty_29 = or i35 %empty_28, %empty_27
  ret i35 %empty_29
}
...
entry:
  ...
  %empty_30 = trunc i32 %empty to i18
  ret i18 %empty_30
}
...
entry:
  ...
  %empty_31 = trunc i16 %empty to i5
  ret i5 %empty_31
}
...
entry:
  ...
  %empty_32 = shl i6 1, %empty
  %empty_33 = and i6 %0, %empty_32
  %empty_34 = icmp ne i6 %empty_33, 0
  ret i1 %empty_34
}

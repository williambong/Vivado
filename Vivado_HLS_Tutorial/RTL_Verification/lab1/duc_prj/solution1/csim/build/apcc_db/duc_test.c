...
if (AESL_DEBUG_TRACE)
printf("\n  %%2 = call %%struct._iobuf* @fopen(i8* getelementptr inbounds ([10 x i8]* @aesl_internal_.str2, i64 0, i64 0), i8* getelementptr inbounds ([2 x i8]* @aesl_internal_.str1, i64 0, i64 0)) nounwind, !dbg !4 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_6_count);
...
llvm_cbe_tmp__41:
if (AESL_DEBUG_TRACE)
printf("\n  %%10 = add nsw i32 %%storemerge10, 1, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_47_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%storemerge2 = select i1 %%11, i18 -131072, i18 0, !dbg !9 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_storemerge2_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%12 = sub i18 0, %%storemerge2, !dbg !7 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_70_count);
...
llvm_cbe_tmp__43:
if (AESL_DEBUG_TRACE)
printf("\n  %%45 = add nsw i32 %%storemerge19, 1, !dbg !11 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_184_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%34 = sext i32 %%storemerge46 to i64, !dbg !9 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_154_count);
  llvm_cbe_tmp__21 = (unsigned long long )((signed long long )(signed int )llvm_cbe_storemerge46);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__21);
if (AESL_DEBUG_TRACE)
printf("\n  %%35 = getelementptr inbounds [32 x i18]* %%i_o, i64 0, i64 %%34, !dbg !9 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_155_count);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  %%36 = load i18* %%35, align 4, !dbg !9 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_156_count);
  llvm_cbe_tmp__23 = (unsigned int )*llvm_cbe_tmp__22;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__23);
if (AESL_DEBUG_TRACE)
printf("\n  %%37 = sext i18 %%36 to i32, !dbg !3 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_159_count);
...
printf("\n = 0x%X\n", llvm_cbe_tmp__24);
if (AESL_DEBUG_TRACE)
printf("\n  %%38 = call i32 (%%struct._iobuf*, i8*, ...)* @fprintf(%%struct._iobuf* %%1, i8* getelementptr inbounds ([10 x i8]* @aesl_internal_.str3, i64 0, i64 0), i32 %%storemerge19, i32 %%14, i32 %%37) nounwind, !dbg !3 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_160_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%39 = getelementptr inbounds [32 x i18]* %%q_o, i64 0, i64 %%34, !dbg !9 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_161_count);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  %%40 = load i18* %%39, align 4, !dbg !9 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_162_count);
  llvm_cbe_tmp__27 = (unsigned int )*llvm_cbe_tmp__26;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__27);
if (AESL_DEBUG_TRACE)
printf("\n  %%41 = sext i18 %%40 to i32, !dbg !4 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_165_count);
...
printf("\n = 0x%X\n", llvm_cbe_tmp__28);
if (AESL_DEBUG_TRACE)
printf("\n  %%42 = call i32 (%%struct._iobuf*, i8*, ...)* @fprintf(%%struct._iobuf* %%2, i8* getelementptr inbounds ([10 x i8]* @aesl_internal_.str3, i64 0, i64 0), i32 %%storemerge19, i32 %%16, i32 %%41) nounwind, !dbg !4 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_166_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%43 = add nsw i32 %%storemerge46, 1, !dbg !9 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_167_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%13 = sext i18 %%storemerge2 to i32, !dbg !3 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_109_count);
...
printf("\n = 0x%X\n", llvm_cbe_tmp__7);
if (AESL_DEBUG_TRACE)
printf("\n  %%14 = ashr exact i32 %%13, 17, !dbg !3 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_110_count);
  llvm_cbe_tmp__8 = (unsigned int )((signed int )(((signed int )llvm_cbe_tmp__7) >> ((signed int )17u)));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((signed int )llvm_cbe_tmp__8));
if (AESL_DEBUG_TRACE)
printf("\n  %%15 = sext i18 %%12 to i32, !dbg !4 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_111_count);
...
printf("\n = 0x%X\n", llvm_cbe_tmp__9);
if (AESL_DEBUG_TRACE)
printf("\n  %%16 = ashr exact i32 %%15, 17, !dbg !4 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_112_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%32 = add nsw i32 %%storemerge37, 1, !dbg !9 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_137_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%23 = add nsw i32 %%18, 1, !dbg !10 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_119_count);
...
printf("\n. = 0x%X\n", llvm_cbe__2e_);
if (AESL_DEBUG_TRACE)
printf("\n  call void @duc(i18 signext %%12, i16 zeroext 6628, i18* %%3, i18* %%4) nounwind, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_124_count);
...
llvm_cbe__2e_thread:
if (AESL_DEBUG_TRACE)
printf("\n  call void @duc(i18 signext %%storemerge2, i16 zeroext 6628, i18* %%3, i18* %%4) nounwind, !dbg !7 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_126_count);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  %%25 = load i18* %%3, align 4, !dbg !10 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_128_count);
  llvm_cbe_tmp__14 = (unsigned int )*llvm_cbe_tmp__3;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__14);
if (AESL_DEBUG_TRACE)
printf("\n  %%26 = sext i32 %%. to i64, !dbg !10 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_129_count);
  llvm_cbe_tmp__15 = (unsigned long long )((signed long long )(signed int )llvm_cbe__2e_);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__15);
if (AESL_DEBUG_TRACE)
printf("\n  %%27 = getelementptr inbounds [32 x i18]* %%i_o, i64 0, i64 %%26, !dbg !10 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_130_count);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  store i18 %%25, i18* %%27, align 4, !dbg !10 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_131_count);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  %%28 = load i18* %%4, align 4, !dbg !10 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_132_count);
  llvm_cbe_tmp__17 = (unsigned int )*llvm_cbe_tmp__4;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__17);
if (AESL_DEBUG_TRACE)
printf("\n  %%29 = getelementptr inbounds [32 x i18]* %%q_o, i64 0, i64 %%26, !dbg !10 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_133_count);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  store i18 %%28, i18* %%29, align 4, !dbg !10 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_134_count);
...
llvm_cbe_tmp__44:
if (AESL_DEBUG_TRACE)
printf("\n  %%47 = call i32 @fclose(%%struct._iobuf* %%1) nounwind, !dbg !4 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_192_count);
  fclose((l_struct_OC__iobuf *)llvm_cbe_tmp__1);
if (AESL_DEBUG_TRACE) {
printf("\nReturn  = 0x%X",llvm_cbe_tmp__32);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%48 = call i32 @fclose(%%struct._iobuf* %%2) nounwind, !dbg !4 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_193_count);
  fclose((l_struct_OC__iobuf *)llvm_cbe_tmp__2);
if (AESL_DEBUG_TRACE) {
printf("\nReturn  = 0x%X",llvm_cbe_tmp__33);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%49 = call i32 @system(i8* getelementptr inbounds ([43 x i8]* @aesl_internal_.str4, i64 0, i64 0)) nounwind, !dbg !11 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_194_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%51 = or i32 %%50, %%49, !dbg !11 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_202_count);
...
llvm_cbe_tmp__50:
if (AESL_DEBUG_TRACE)
printf("\n  %%puts = call i32 @puts(i8* getelementptr inbounds ([39 x i8]* @aesl_internal_str, i64 0, i64 0)), !dbg !12 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_puts_count);
...
llvm_cbe_tmp__49:
if (AESL_DEBUG_TRACE)
printf("\n  %%puts5 = call i32 @puts(i8* getelementptr inbounds ([39 x i8]* @aesl_internal_str1, i64 0, i64 0)), !dbg !12 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_puts5_count);

...
printf("\n\{ BEGIN @dds\n");
if (AESL_DEBUG_TRACE)
printf("\n  %%1 = load i16* @aesl_internal_dds.acc, align 2, !dbg !3 for 0x%I64xth hint within @dds  --> \n", ++aesl_llvm_cbe_7_count);
  llvm_cbe_tmp__1 = (unsigned short )*(&aesl_internal_dds_OC_acc);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__1);
if (AESL_DEBUG_TRACE)
printf("\n  %%2 = add i16 %%1, %%freq, !dbg !3 for 0x%I64xth hint within @dds  --> \n", ++aesl_llvm_cbe_8_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  store i16 %%2, i16* @aesl_internal_dds.acc, align 2, !dbg !3 for 0x%I64xth hint within @dds  --> \n", ++aesl_llvm_cbe_9_count);
...
printf("\n = 0x%X\n", llvm_cbe_tmp__4);
if (AESL_DEBUG_TRACE)
printf("\n  %%5 = zext i5 %%4 to i64, !dbg !3 for 0x%I64xth hint within @dds  --> \n", ++aesl_llvm_cbe_15_count);
  llvm_cbe_tmp__5 = (unsigned long long )((unsigned long long )(unsigned char )llvm_cbe_tmp__4&31U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__5);
if (AESL_DEBUG_TRACE)
printf("\n  %%6 = getelementptr inbounds [32 x i16]* @aesl_internal_dds.dds_table, i64 0, i64 %%5, !dbg !3 for 0x%I64xth hint within @dds  --> \n", ++aesl_llvm_cbe_16_count);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  %%7 = load i16* %%6, align 2, !dbg !3 for 0x%I64xth hint within @dds  --> \n", ++aesl_llvm_cbe_17_count);
  llvm_cbe_tmp__7 = (unsigned short )*llvm_cbe_tmp__6;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__7);
if (AESL_DEBUG_TRACE)
printf("\n  store i16 %%7, i16* %%sine, align 2, !dbg !3 for 0x%I64xth hint within @dds  --> \n", ++aesl_llvm_cbe_18_count);
  *llvm_cbe_sine = llvm_cbe_tmp__7;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__7);
if (AESL_DEBUG_TRACE)
printf("\n  %%8 = sub i5 8, %%4, !dbg !4 for 0x%I64xth hint within @dds  --> \n", ++aesl_llvm_cbe_19_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%9 = zext i5 %%8 to i64, !dbg !3 for 0x%I64xth hint within @dds  --> \n", ++aesl_llvm_cbe_22_count);
  llvm_cbe_tmp__9 = (unsigned long long )((unsigned long long )(unsigned char )llvm_cbe_tmp__8&31U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__9);
if (AESL_DEBUG_TRACE)
printf("\n  %%10 = getelementptr inbounds [32 x i16]* @aesl_internal_dds.dds_table, i64 0, i64 %%9, !dbg !3 for 0x%I64xth hint within @dds  --> \n", ++aesl_llvm_cbe_23_count);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  %%11 = load i16* %%10, align 2, !dbg !3 for 0x%I64xth hint within @dds  --> \n", ++aesl_llvm_cbe_24_count);
  llvm_cbe_tmp__11 = (unsigned short )*llvm_cbe_tmp__10;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__11);
if (AESL_DEBUG_TRACE)
printf("\n  store i16 %%11, i16* %%cosine, align 2, !dbg !3 for 0x%I64xth hint within @dds  --> \n", ++aesl_llvm_cbe_25_count);

...
printf("\n\{ BEGIN @srrc_mac\n");
if (AESL_DEBUG_TRACE)
printf("\n  %%1 = sext i18 %%c to i36, !dbg !5 for 0x%I64xth hint within @srrc_mac  --> \n", ++aesl_llvm_cbe_15_count);
...
printf("\n = 0x%I64X\n", llvm_cbe_tmp__4);
if (AESL_DEBUG_TRACE)
printf("\n  %%2 = sext i18 %%d to i36, !dbg !5 for 0x%I64xth hint within @srrc_mac  --> \n", ++aesl_llvm_cbe_17_count);
...
printf("\n = 0x%I64X\n", llvm_cbe_tmp__5);
if (AESL_DEBUG_TRACE)
printf("\n  %%3 = mul nsw i36 %%2, %%1, !dbg !5 for 0x%I64xth hint within @srrc_mac  --> \n", ++aesl_llvm_cbe_18_count);
...
printf("\n\{ BEGIN @mac1\n");
if (AESL_DEBUG_TRACE)
printf("\n  %%1 = sext i18 %%c to i36, !dbg !5 for 0x%I64xth hint within @mac1  --> \n", ++aesl_llvm_cbe_31_count);
...
printf("\n = 0x%I64X\n", llvm_cbe_tmp__10);
if (AESL_DEBUG_TRACE)
printf("\n  %%2 = sext i18 %%d to i36, !dbg !5 for 0x%I64xth hint within @mac1  --> \n", ++aesl_llvm_cbe_33_count);
...
printf("\n = 0x%I64X\n", llvm_cbe_tmp__11);
if (AESL_DEBUG_TRACE)
printf("\n  %%3 = mul nsw i36 %%2, %%1, !dbg !5 for 0x%I64xth hint within @mac1  --> \n", ++aesl_llvm_cbe_34_count);
...
printf("\n\{ BEGIN @mac2\n");
if (AESL_DEBUG_TRACE)
printf("\n  %%1 = sext i18 %%c to i36, !dbg !5 for 0x%I64xth hint within @mac2  --> \n", ++aesl_llvm_cbe_47_count);
...
printf("\n = 0x%I64X\n", llvm_cbe_tmp__15);
if (AESL_DEBUG_TRACE)
printf("\n  %%2 = sext i18 %%d to i36, !dbg !5 for 0x%I64xth hint within @mac2  --> \n", ++aesl_llvm_cbe_49_count);
...
printf("\n = 0x%I64X\n", llvm_cbe_tmp__16);
if (AESL_DEBUG_TRACE)
printf("\n  %%3 = mul nsw i36 %%2, %%1, !dbg !5 for 0x%I64xth hint within @mac2  --> \n", ++aesl_llvm_cbe_50_count);
...
printf("\n\{ BEGIN @mac\n");
if (AESL_DEBUG_TRACE)
printf("\n  %%1 = sext i18 %%c to i36, !dbg !5 for 0x%I64xth hint within @mac  --> \n", ++aesl_llvm_cbe_63_count);
...
printf("\n = 0x%I64X\n", llvm_cbe_tmp__20);
if (AESL_DEBUG_TRACE)
printf("\n  %%2 = sext i18 %%d to i36, !dbg !5 for 0x%I64xth hint within @mac  --> \n", ++aesl_llvm_cbe_65_count);
...
printf("\n = 0x%I64X\n", llvm_cbe_tmp__21);
if (AESL_DEBUG_TRACE)
printf("\n  %%3 = mul nsw i36 %%2, %%1, !dbg !5 for 0x%I64xth hint within @mac  --> \n", ++aesl_llvm_cbe_66_count);

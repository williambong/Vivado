...
if (AESL_DEBUG_TRACE)
printf("\n  %%2 = load i18* %%imf1_o, align 4, !dbg !4 for 0x%I64xth hint within @duc  --> \n", ++aesl_llvm_cbe_28_count);
  llvm_cbe_tmp__2 = (unsigned int )*(&llvm_cbe_imf1_o);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__2);
if (AESL_DEBUG_TRACE)
printf("\n  call void @imf2(i18* %%imf2_o, i18 signext %%2) nounwind, !dbg !4 for 0x%I64xth hint within @duc  --> \n", ++aesl_llvm_cbe_29_count);
  imf2((signed int *)(&llvm_cbe_imf2_o), llvm_cbe_tmp__2);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",llvm_cbe_tmp__2);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%3 = load i18* %%imf2_o, align 4, !dbg !4 for 0x%I64xth hint within @duc  --> \n", ++aesl_llvm_cbe_36_count);
  llvm_cbe_tmp__3 = (unsigned int )*(&llvm_cbe_imf2_o);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__3);
if (AESL_DEBUG_TRACE)
printf("\n  call void @imf3(i18* %%imf3_o, i18 signext %%3) nounwind, !dbg !4 for 0x%I64xth hint within @duc  --> \n", ++aesl_llvm_cbe_37_count);
  imf3((signed int *)(&llvm_cbe_imf3_o), llvm_cbe_tmp__3);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",llvm_cbe_tmp__3);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%4 = load i18* %%imf3_o, align 4, !dbg !2 for 0x%I64xth hint within @duc  --> \n", ++aesl_llvm_cbe_44_count);
  llvm_cbe_tmp__4 = (unsigned int )*(&llvm_cbe_imf3_o);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__4);
if (AESL_DEBUG_TRACE)
printf("\n  call void @mixer(i16 zeroext %%freq, i18 signext %%4, i18* %%dout_i, i18* %%dout_q) nounwind, !dbg !2 for 0x%I64xth hint within @duc  --> \n", ++aesl_llvm_cbe_45_count);

...
printf("\n\{ BEGIN @srrc\n");
if (AESL_DEBUG_TRACE)
printf("\n  %%1 = load i6* @aesl_internal_srrc.i, align 1, !dbg !4 for 0x%I64xth hint within @srrc  --> \n", ++aesl_llvm_cbe_5_count);
...
llvm_cbe_tmp__25:
if (AESL_DEBUG_TRACE)
printf("\n  store i18 %%x, i18* @aesl_internal_srrc.in, align 4, !dbg !4 for 0x%I64xth hint within @srrc  --> \n", ++aesl_llvm_cbe_8_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%21 = load i1* @aesl_internal_srrc.ch, align 1, !dbg !5 for 0x%I64xth hint within @srrc  --> \n", ++aesl_llvm_cbe_33_count);
  llvm_cbe_tmp__16 = (bool )((*(&aesl_internal_srrc_OC_ch))&1);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__16);
if (AESL_DEBUG_TRACE)
printf("\n  %%22 = zext i1 %%21 to i64, !dbg !5 for 0x%I64xth hint within @srrc  --> \n", ++aesl_llvm_cbe_34_count);
  llvm_cbe_tmp__17 = (unsigned long long )((unsigned long long )(bool )llvm_cbe_tmp__16&1U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__17);
if (AESL_DEBUG_TRACE)
printf("\n  %%23 = load i6* @aesl_internal_srrc.i, align 1, !dbg !5 for 0x%I64xth hint within @srrc  --> \n", ++aesl_llvm_cbe_35_count);
  llvm_cbe_tmp__18 = (unsigned char )*(&aesl_internal_srrc_OC_i);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__18);
if (AESL_DEBUG_TRACE)
printf("\n  %%24 = zext i6 %%23 to i64, !dbg !5 for 0x%I64xth hint within @srrc  --> \n", ++aesl_llvm_cbe_36_count);
  llvm_cbe_tmp__19 = (unsigned long long )((unsigned long long )(unsigned char )llvm_cbe_tmp__18&63U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__19);
if (AESL_DEBUG_TRACE)
printf("\n  %%25 = getelementptr inbounds [48 x [2 x i38]]* @aesl_internal_srrc.shift_reg_p, i64 0, i64 %%24, i64 %%22, !dbg !5 for 0x%I64xth hint within @srrc  --> \n", ++aesl_llvm_cbe_37_count);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  store i38 %%20, i38* %%25, align 8, !dbg !5 for 0x%I64xth hint within @srrc  --> \n", ++aesl_llvm_cbe_38_count);
...
llvm_cbe_tmp__31:
if (AESL_DEBUG_TRACE)
printf("\n  store i1 false, i1* @aesl_internal_srrc.init, align 1, !dbg !5 for 0x%I64xth hint within @srrc  --> \n", ++aesl_llvm_cbe_42_count);
...
llvm_cbe_tmp__34:
if (AESL_DEBUG_TRACE)
printf("\n  %%33 = lshr i38 %%20, 17, !dbg !4 for 0x%I64xth hint within @srrc  --> \n", ++aesl_llvm_cbe_48_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%34 = trunc i38 %%33 to i18, !dbg !4 for 0x%I64xth hint within @srrc  --> \n", ++aesl_llvm_cbe_49_count);
  llvm_cbe_tmp__23 = (unsigned int )((unsigned int )llvm_cbe_tmp__22&262143U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__23);
if (AESL_DEBUG_TRACE)
printf("\n  store i18 %%34, i18* %%y, align 4, !dbg !4 for 0x%I64xth hint within @srrc  --> \n", ++aesl_llvm_cbe_50_count);
...
llvm_cbe_tmp__33:
if (AESL_DEBUG_TRACE)
printf("\n  %%36 = select i1 %%26, i6 0, i6 %%5, !dbg !5 for 0x%I64xth hint within @srrc  --> \n", ++aesl_llvm_cbe_52_count);
...
printf("\n = 0x%X\n", llvm_cbe_tmp__24);
if (AESL_DEBUG_TRACE)
printf("\n  store i6 %%36, i6* @aesl_internal_srrc.i, align 1, !dbg !5 for 0x%I64xth hint within @srrc  --> \n", ++aesl_llvm_cbe_53_count);

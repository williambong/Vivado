...
.reset:                                           ; preds = %1
  ...
  %exitcond_i5 = icmp eq i4 %c_i, -8
  %c_i_mid2 = select i1 %exitcond_i5, i4 0, i4 %c_i
  %r3 = add i4 1, %r_i
  %r_i_mid2 = select i1 %exitcond_i5, i4 %r3, i4 %r_i
  ...
  %empty_5 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str13, i32 %tmp_2_i) nounwind
  %c = add i4 1, %c_i_mid2
  br label %1
...
.preheader7:                                      ; preds = %.preheader7.preheader
  ...
  %row_outbuf_addr = getelementptr [64 x i16]* %row_outbuf, i64 0, i64 %tmp_3
  %row_outbuf_load = load i16* %row_outbuf_addr, align 2
  %tmp_1 = trunc i4 %i_1_mid2 to i3
...
.preheader:                                       ; preds = %.preheader.preheader
  ...
  %tmp_5 = call i32 (...)* @_ssdm_op_SpecRegionBegin([21 x i8]* @p_str9)
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, [1 x i8]* @p_str1) nounwind
  %tmp_4_trn_cast = zext i4 %i_3_mid2 to i8
  %tmp_3_trn_cast = zext i4 %j_1_mid2 to i8
  %tmp_4 = call i7 @_ssdm_op_BitConcatenate.i7.i4.i3(i4 %i_3_mid2, i3 0)
  %p_addr2_cast = zext i7 %tmp_4 to i8
  %p_addr5 = add i8 %tmp_3_trn_cast, %p_addr2_cast
  %tmp_6 = zext i8 %p_addr5 to i64
  %col_outbuf_addr = getelementptr [64 x i16]* %col_outbuf, i64 0, i64 %tmp_6
  %col_outbuf_load = load i16* %col_outbuf_addr, align 2
  %tmp_7 = call i7 @_ssdm_op_BitConcatenate.i7.i4.i3(i4 %j_1_mid2, i3 0)
  %p_addr3_cast = zext i7 %tmp_7 to i8
  %p_addr4 = add i8 %tmp_4_trn_cast, %p_addr3_cast
  %tmp_8 = zext i8 %p_addr4 to i64
  %out_block_addr = getelementptr [64 x i16]* %out_block, i64 0, i64 %tmp_8
  store i16 %col_outbuf_load, i16* %out_block_addr, align 2
  %empty_10 = call i32 (...)* @_ssdm_op_SpecRegionEnd([21 x i8]* @p_str9, i32 %tmp_5)
...
ifBlock:                                          ; preds = %branch7, %branch6, %branch5, %branch4, %branch3, %branch2, %branch1, %branch0
  %empty = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str11, i32 %tmp_8)
  %c_1 = add i4 %c_mid2, 1
  br label %1
...
.reset:                                           ; preds = %1
  ...
  %tmp = call i6 @_ssdm_op_BitConcatenate.i6.i3.i3(i3 %tmp_2, i3 0)
  %tmp_s = zext i4 %r_mid2 to i64
  %c_cast2 = zext i4 %c_mid2 to i6
  call void (...)* @_ssdm_op_SpecLoopName([12 x i8]* @p_str11) nounwind
  %tmp_8 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @p_str11)
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, [1 x i8]* @p_str1) nounwind
  %tmp_5 = add i6 %c_cast2, %tmp
...
define internal fastcc void @dct_dct_1d([8 x i16]* nocapture %src, [8 x i16]* nocapture %src1, [8 x i16]* nocapture %src2, [8 x i16]* nocapture %src3, [8 x i16]* nocapture %src4, [8 x i16]* nocapture %src5, [8 x i16]* nocapture %src6, [8 x i16]* nocapture %src7, i4 %tmp_1, [64 x i16]* nocapture %dst, i4 %tmp_11) {
  ...
  %tmp_3 = call i7 @_ssdm_op_BitConcatenate.i7.i4.i3(i4 %tmp_11_read, i3 0)
  %p_addr_cast = zext i7 %tmp_3 to i8
  br label %1
...
; <label>:2                                       ; preds = %1
  ...
  %dst_addr = getelementptr [64 x i16]* %dst, i64 0, i64 %tmp_5

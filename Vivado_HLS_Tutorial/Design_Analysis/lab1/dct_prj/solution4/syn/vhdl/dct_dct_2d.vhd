...
architecture behav of dct_dct_2d is 
    ...
    signal tmp_1_fu_483_p1 : STD_LOGIC_VECTOR (2 downto 0);
    ...
    signal tmp_3_fu_478_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_s_fu_493_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_6_fu_578_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_8_fu_609_p1 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal tmp_4_fu_560_p3 : STD_LOGIC_VECTOR (6 downto 0);
    ...
    signal tmp_7_fu_592_p3 : STD_LOGIC_VECTOR (6 downto 0);
...
begin
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, exitcond5_fu_404_p2, exitcond_flatten_fu_416_p2, ap_reg_ppiten_pp0_it0, exitcond2_fu_504_p2, exitcond_flatten1_fu_516_p2, ap_reg_ppiten_pp1_it0, grp_dct_dct_1d_fu_361_ap_done)
    begin
        case ap_CS_fsm is
    ...
    begin
                ap_sig_bdd_326 <= (ap_const_lv1_1 = ap_CS_fsm(2 downto 2));
    end process;
    ...
    begin
                ap_sig_bdd_345 <= (ap_const_lv1_1 = ap_CS_fsm(5 downto 5));
    end process;
    ...
    begin
                ap_sig_bdd_606 <= (ap_const_lv1_1 = ap_CS_fsm(7 downto 7));
    end process;


    -- ap_sig_cseq_ST_pp0_stg0_fsm_3 assign process. --
    ap_sig_cseq_ST_pp0_stg0_fsm_3_assign_proc : process(ap_sig_bdd_116)
    begin
    ...
    ap_sig_cseq_ST_pp1_stg0_fsm_6_assign_proc : process(ap_sig_bdd_155)
    begin
    ...
    ap_sig_cseq_ST_st10_fsm_7_assign_proc : process(ap_sig_bdd_606)
    begin
    ...
    ap_sig_cseq_ST_st3_fsm_2_assign_proc : process(ap_sig_bdd_326)
    begin
    ...
    ap_sig_cseq_ST_st6_fsm_4_assign_proc : process(ap_sig_bdd_144)
    begin
    ...
    ap_sig_cseq_ST_st7_fsm_5_assign_proc : process(ap_sig_bdd_345)
    begin
    ...
    col_inbuf_0_we0_assign_proc : process(ap_sig_cseq_ST_pp0_stg0_fsm_3, ap_reg_ppiten_pp0_it1, tmp_1_reg_643)
    begin
        if ((((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_3) and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and (tmp_1_reg_643 = ap_const_lv3_0)))) then 
    ...
    col_inbuf_1_we0_assign_proc : process(ap_sig_cseq_ST_pp0_stg0_fsm_3, ap_reg_ppiten_pp0_it1, tmp_1_reg_643)
    begin
        if ((((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_3) and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and (tmp_1_reg_643 = ap_const_lv3_1)))) then 
    ...
    col_inbuf_2_we0_assign_proc : process(ap_sig_cseq_ST_pp0_stg0_fsm_3, ap_reg_ppiten_pp0_it1, tmp_1_reg_643)
    begin
        if ((((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_3) and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and (tmp_1_reg_643 = ap_const_lv3_2)))) then 
    ...
    col_inbuf_3_we0_assign_proc : process(ap_sig_cseq_ST_pp0_stg0_fsm_3, ap_reg_ppiten_pp0_it1, tmp_1_reg_643)
    begin
        if ((((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_3) and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and (tmp_1_reg_643 = ap_const_lv3_3)))) then 
    ...
    col_inbuf_4_we0_assign_proc : process(ap_sig_cseq_ST_pp0_stg0_fsm_3, ap_reg_ppiten_pp0_it1, tmp_1_reg_643)
    begin
        if ((((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_3) and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and (tmp_1_reg_643 = ap_const_lv3_4)))) then 
    ...
    col_inbuf_5_we0_assign_proc : process(ap_sig_cseq_ST_pp0_stg0_fsm_3, ap_reg_ppiten_pp0_it1, tmp_1_reg_643)
    begin
        if ((((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_3) and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and (tmp_1_reg_643 = ap_const_lv3_5)))) then 
    ...
    col_inbuf_6_we0_assign_proc : process(ap_sig_cseq_ST_pp0_stg0_fsm_3, ap_reg_ppiten_pp0_it1, tmp_1_reg_643)
    begin
        if ((((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_3) and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and (tmp_1_reg_643 = ap_const_lv3_6)))) then 
    ...
    col_inbuf_7_we0_assign_proc : process(ap_sig_cseq_ST_pp0_stg0_fsm_3, ap_reg_ppiten_pp0_it1, tmp_1_reg_643)
    begin
        if ((((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_3) and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and not((tmp_1_reg_643 = ap_const_lv3_6)) and not((tmp_1_reg_643 = ap_const_lv3_5)) and not((tmp_1_reg_643 = ap_const_lv3_4)) and not((tmp_1_reg_643 = ap_const_lv3_3)) and not((tmp_1_reg_643 = ap_const_lv3_2)) and not((tmp_1_reg_643 = ap_const_lv3_1)) and not((tmp_1_reg_643 = ap_const_lv3_0))))) then 
    ...
    col_outbuf_address0_assign_proc : process(ap_sig_cseq_ST_pp1_stg0_fsm_6, ap_reg_ppiten_pp1_it0, grp_dct_dct_1d_fu_361_dst_address0, ap_sig_cseq_ST_st7_fsm_5, tmp_6_fu_578_p1)
    begin
        if (((ap_const_logic_1 = ap_sig_cseq_ST_pp1_stg0_fsm_6) and (ap_const_logic_1 = ap_reg_ppiten_pp1_it0))) then 
            col_outbuf_address0 <= tmp_6_fu_578_p1(6 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_sig_cseq_ST_st7_fsm_5)) then 
    ...
    out_block_address0 <= tmp_8_fu_609_p1(6 - 1 downto 0);
    ...
    p_addr2_cast_fu_568_p1 <= std_logic_vector(resize(unsigned(tmp_4_fu_560_p3),8));
    p_addr3_cast_fu_599_p1 <= std_logic_vector(resize(unsigned(tmp_7_fu_592_p3),8));
    ...
    row_outbuf_address0_assign_proc : process(ap_sig_cseq_ST_pp0_stg0_fsm_3, ap_reg_ppiten_pp0_it0, grp_dct_dct_1d_fu_361_dst_address0, ap_sig_cseq_ST_st3_fsm_2, tmp_3_fu_478_p1)
    begin
        if (((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_3) and (ap_const_logic_1 = ap_reg_ppiten_pp0_it0))) then 
            row_outbuf_address0 <= tmp_3_fu_478_p1(6 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_sig_cseq_ST_st3_fsm_2)) then 
    ...
    tmp_1_fu_483_p1 <= i_1_mid2_fu_434_p3(3 - 1 downto 0);
    tmp_3_fu_478_p1 <= std_logic_vector(resize(unsigned(p_addr1_fu_472_p2),64));
    tmp_3_trn_cast_fu_556_p1 <= std_logic_vector(resize(unsigned(j_1_mid2_fu_548_p3),8));
    tmp_4_fu_560_p3 <= (i_3_mid2_fu_534_p3 & ap_const_lv3_0);
    tmp_4_trn_cast_fu_589_p1 <= std_logic_vector(resize(unsigned(i_3_mid2_reg_670),8));
    tmp_6_fu_578_p1 <= std_logic_vector(resize(unsigned(p_addr5_fu_572_p2),64));
    tmp_7_fu_592_p3 <= (j_1_mid2_reg_675 & ap_const_lv3_0);
    tmp_8_fu_609_p1 <= std_logic_vector(resize(unsigned(p_addr4_fu_603_p2),64));

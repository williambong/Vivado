...
architecture behav of dct_read_data is 
    ...
    signal tmp_3_fu_286_p1 : STD_LOGIC_VECTOR (2 downto 0);
    signal tmp_3_reg_327 : STD_LOGIC_VECTOR (2 downto 0);
    ...
    signal tmp_2_fu_259_p1 : STD_LOGIC_VECTOR (2 downto 0);
    ...
    signal tmp_5_fu_275_p2 : STD_LOGIC_VECTOR (5 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                elsif ((((ap_const_logic_1 = ap_sig_cseq_ST_st1_fsm_0) and not((ap_start = ap_const_logic_0))) or ((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_1) and not((exitcond_flatten_fu_219_p2 = ap_const_lv1_0))))) then 
                    ap_reg_ppiten_pp0_it1 <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_1) and (exitcond_flatten_fu_219_p2 = ap_const_lv1_0))) then
                tmp_3_reg_327 <= tmp_3_fu_286_p1;
            end if;
        end if;
    end process;

    -- the next state (ap_NS_fsm) of the state machine. --
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, exitcond_flatten_fu_219_p2, ap_reg_ppiten_pp0_it0)
    begin
        case ap_CS_fsm is
    ...
    begin
        if (((not((ap_const_logic_1 = ap_start)) and (ap_const_logic_1 = ap_sig_cseq_ST_st1_fsm_0)) or (ap_const_logic_1 = ap_sig_cseq_ST_st4_fsm_2))) then 
    ...
    ap_sig_cseq_ST_st4_fsm_2_assign_proc : process(ap_sig_bdd_244)
    begin
    ...
    buf_0_we0_assign_proc : process(ap_sig_cseq_ST_pp0_stg0_fsm_1, ap_reg_ppiten_pp0_it1, tmp_3_reg_327)
    begin
        if ((((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_1) and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and (tmp_3_reg_327 = ap_const_lv3_0)))) then 
    ...
    buf_1_we0_assign_proc : process(ap_sig_cseq_ST_pp0_stg0_fsm_1, ap_reg_ppiten_pp0_it1, tmp_3_reg_327)
    begin
        if ((((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_1) and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and (tmp_3_reg_327 = ap_const_lv3_1)))) then 
    ...
    buf_2_we0_assign_proc : process(ap_sig_cseq_ST_pp0_stg0_fsm_1, ap_reg_ppiten_pp0_it1, tmp_3_reg_327)
    begin
        if ((((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_1) and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and (tmp_3_reg_327 = ap_const_lv3_2)))) then 
    ...
    buf_3_we0_assign_proc : process(ap_sig_cseq_ST_pp0_stg0_fsm_1, ap_reg_ppiten_pp0_it1, tmp_3_reg_327)
    begin
        if ((((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_1) and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and (tmp_3_reg_327 = ap_const_lv3_3)))) then 
    ...
    buf_4_we0_assign_proc : process(ap_sig_cseq_ST_pp0_stg0_fsm_1, ap_reg_ppiten_pp0_it1, tmp_3_reg_327)
    begin
        if ((((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_1) and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and (tmp_3_reg_327 = ap_const_lv3_4)))) then 
    ...
    buf_5_we0_assign_proc : process(ap_sig_cseq_ST_pp0_stg0_fsm_1, ap_reg_ppiten_pp0_it1, tmp_3_reg_327)
    begin
        if ((((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_1) and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and (tmp_3_reg_327 = ap_const_lv3_5)))) then 
    ...
    buf_6_we0_assign_proc : process(ap_sig_cseq_ST_pp0_stg0_fsm_1, ap_reg_ppiten_pp0_it1, tmp_3_reg_327)
    begin
        if ((((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_1) and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and (tmp_3_reg_327 = ap_const_lv3_6)))) then 
    ...
    buf_7_we0_assign_proc : process(ap_sig_cseq_ST_pp0_stg0_fsm_1, ap_reg_ppiten_pp0_it1, tmp_3_reg_327)
    begin
        if ((((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_1) and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1) and not((tmp_3_reg_327 = ap_const_lv3_6)) and not((tmp_3_reg_327 = ap_const_lv3_5)) and not((tmp_3_reg_327 = ap_const_lv3_4)) and not((tmp_3_reg_327 = ap_const_lv3_3)) and not((tmp_3_reg_327 = ap_const_lv3_2)) and not((tmp_3_reg_327 = ap_const_lv3_1)) and not((tmp_3_reg_327 = ap_const_lv3_0))))) then 
    ...
    c_cast2_fu_271_p1 <= std_logic_vector(resize(unsigned(c_mid2_fu_237_p3),6));
    c_mid2_fu_237_p3 <= 
    ...
    input_r_address0 <= tmp_6_fu_281_p1(6 - 1 downto 0);
    ...
    tmp_2_fu_259_p1 <= r_mid2_fu_251_p3(3 - 1 downto 0);
    tmp_3_fu_286_p1 <= c_mid2_fu_237_p3(3 - 1 downto 0);
    tmp_5_fu_275_p2 <= std_logic_vector(unsigned(c_cast2_fu_271_p1) + unsigned(tmp_fu_263_p3));
    tmp_6_fu_281_p1 <= std_logic_vector(resize(unsigned(tmp_5_fu_275_p2),64));
    tmp_fu_263_p3 <= (tmp_2_fu_259_p1 & ap_const_lv3_0);

...
define void @dct([64 x i16]* %input, [64 x i16]* %output) nounwind uwtable {
  ...
  call void @llvm.dbg.declare(metadata !{[8 x [8 x i16]]* %buf_2d_in}, metadata !2929), !dbg !2932 ; [debug line = 124:10] [debug variable = buf_2d_in]
  call void @llvm.dbg.declare(metadata !{[8 x [8 x i16]]* %buf_2d_out}, metadata !2933), !dbg !2934 ; [debug line = 125:10] [debug variable = buf_2d_out]
  call void @llvm.dbg.value(metadata !{[64 x i16]* %input}, i64 0, metadata !2935) nounwind, !dbg !2937 ; [debug line = 98:22@128:4] [debug variable = input]
  call void @llvm.dbg.value(metadata !{[8 x [8 x i16]]* %buf_2d_in}, i64 0, metadata !2938) nounwind, !dbg !2939 ; [debug line = 98:44@128:4] [debug variable = buf]
  br label %1, !dbg !2940                         ; [debug line = 103:9@128:4]

; <label>:1                                       ; preds = %8, %0
  %r.i = phi i4 [ 0, %0 ], [ %r, %8 ]             ; [#uses=4 type=i4]
  %r.i.cast7 = zext i4 %r.i to i6, !dbg !2940     ; [#uses=1 type=i6] [debug line = 103:9@128:4]
  %exitcond1.i = icmp eq i4 %r.i, -8, !dbg !2940  ; [#uses=1 type=i1] [debug line = 103:9@128:4]
  %2 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) nounwind ; [#uses=0 type=i32]
  br i1 %exitcond1.i, label %read_data.exit, label %3, !dbg !2940 ; [debug line = 103:9@128:4]

; <label>:3                                       ; preds = %1
  call void (...)* @_ssdm_op_SpecLoopName([12 x i8]* @.str9) nounwind, !dbg !2943 ; [debug line = 103:67@128:4]
  %tmp.11.i = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @.str9) nounwind, !dbg !2943 ; [#uses=1 type=i32] [debug line = 103:67@128:4]
  %tmp.i = shl i6 %r.i.cast7, 3, !dbg !2945       ; [#uses=1 type=i6] [debug line = 106:1@128:4]
  %tmp..i = zext i4 %r.i to i64, !dbg !2945       ; [#uses=1 type=i64] [debug line = 106:1@128:4]
  br label %4, !dbg !2948                         ; [debug line = 105:12@128:4]

; <label>:4                                       ; preds = %6, %3
  %c.i = phi i4 [ 0, %3 ], [ %c, %6 ]             ; [#uses=4 type=i4]
  %c.i.cast6 = zext i4 %c.i to i6, !dbg !2948     ; [#uses=1 type=i6] [debug line = 105:12@128:4]
  %exitcond.i = icmp eq i4 %c.i, -8, !dbg !2948   ; [#uses=1 type=i1] [debug line = 105:12@128:4]
  %5 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) nounwind ; [#uses=0 type=i32]
  br i1 %exitcond.i, label %8, label %6, !dbg !2948 ; [debug line = 105:12@128:4]

; <label>:6                                       ; preds = %4
  call void (...)* @_ssdm_op_SpecLoopName([12 x i8]* @.str10) nounwind, !dbg !2949 ; [debug line = 106:2@128:4]
  %tmp.12.i = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @.str10) nounwind, !dbg !2949 ; [#uses=1 type=i32] [debug line = 106:2@128:4]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, [1 x i8]* @.str1) nounwind, !dbg !2950 ; [debug line = 107:1@128:4]
  %tmp.5.i = add i6 %c.i.cast6, %tmp.i, !dbg !2945 ; [#uses=1 type=i6] [debug line = 106:1@128:4]
  %tmp.6.i = zext i6 %tmp.5.i to i64, !dbg !2945  ; [#uses=1 type=i64] [debug line = 106:1@128:4]
  %input.addr = getelementptr [64 x i16]* %input, i64 0, i64 %tmp.6.i, !dbg !2945 ; [#uses=1 type=i16*] [debug line = 106:1@128:4]
  %input.load = load i16* %input.addr, align 2, !dbg !2945 ; [#uses=1 type=i16] [debug line = 106:1@128:4]
  %tmp.7.i = zext i4 %c.i to i64, !dbg !2945      ; [#uses=1 type=i64] [debug line = 106:1@128:4]
  %buf.assign.addr = getelementptr [8 x [8 x i16]]* %buf_2d_in, i64 0, i64 %tmp..i, i64 %tmp.7.i, !dbg !2945 ; [#uses=1 type=i16*] [debug line = 106:1@128:4]
  store i16 %input.load, i16* %buf.assign.addr, align 2, !dbg !2945 ; [debug line = 106:1@128:4]
  %7 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @.str10, i32 %tmp.12.i) nounwind, !dbg !2951 ; [#uses=0 type=i32] [debug line = 106:66@128:4]
  %c = add i4 %c.i, 1, !dbg !2952                 ; [#uses=1 type=i4] [debug line = 105:64@128:4]
  call void @llvm.dbg.value(metadata !{i4 %c}, i64 0, metadata !2953) nounwind, !dbg !2952 ; [debug line = 105:64@128:4] [debug variable = c]
  br label %4, !dbg !2952                         ; [debug line = 105:64@128:4]

; <label>:8                                       ; preds = %4
  %9 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @.str9, i32 %tmp.11.i) nounwind, !dbg !2954 ; [#uses=0 type=i32] [debug line = 107:4@128:4]
  %r = add i4 %r.i, 1, !dbg !2955                 ; [#uses=1 type=i4] [debug line = 103:61@128:4]
  call void @llvm.dbg.value(metadata !{i4 %r}, i64 0, metadata !2956) nounwind, !dbg !2955 ; [debug line = 103:61@128:4] [debug variable = r]
  br label %1, !dbg !2955                         ; [debug line = 103:61@128:4]

read_data.exit:                                   ; preds = %1
  call fastcc void @dct_2d([8 x [8 x i16]]* %buf_2d_in, [8 x [8 x i16]]* %buf_2d_out) nounwind, !dbg !2957 ; [debug line = 130:4]
  call void @llvm.dbg.value(metadata !{[8 x [8 x i16]]* %buf_2d_out}, i64 0, metadata !2958) nounwind, !dbg !2960 ; [debug line = 110:23@133:4] [debug variable = buf]
  call void @llvm.dbg.value(metadata !{[64 x i16]* %output}, i64 0, metadata !2961) nounwind, !dbg !2962 ; [debug line = 110:116@133:4] [debug variable = output]
  br label %10, !dbg !2963                        ; [debug line = 115:9@133:4]

; <label>:10                                      ; preds = %17, %read_data.exit
  %r.i2 = phi i4 [ 0, %read_data.exit ], [ %r.1, %17 ] ; [#uses=4 type=i4]
  %r.i2.cast4 = zext i4 %r.i2 to i6, !dbg !2963   ; [#uses=1 type=i6] [debug line = 115:9@133:4]
  %exitcond1.i3 = icmp eq i4 %r.i2, -8, !dbg !2963 ; [#uses=1 type=i1] [debug line = 115:9@133:4]
  %11 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) nounwind ; [#uses=0 type=i32]
  br i1 %exitcond1.i3, label %write_data.exit, label %12, !dbg !2963 ; [debug line = 115:9@133:4]

; <label>:12                                      ; preds = %10
  call void (...)* @_ssdm_op_SpecLoopName([12 x i8]* @.str11) nounwind, !dbg !2966 ; [debug line = 115:67@133:4]
  %tmp.1.i = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @.str11) nounwind, !dbg !2966 ; [#uses=1 type=i32] [debug line = 115:67@133:4]
  %tmp.i4 = zext i4 %r.i2 to i64, !dbg !2968      ; [#uses=1 type=i64] [debug line = 118:1@133:4]
  %tmp..i5 = shl i6 %r.i2.cast4, 3, !dbg !2968    ; [#uses=1 type=i6] [debug line = 118:1@133:4]
  br label %13, !dbg !2971                        ; [debug line = 117:12@133:4]

; <label>:13                                      ; preds = %15, %12
  %c.i6 = phi i4 [ 0, %12 ], [ %c.1, %15 ]        ; [#uses=4 type=i4]
  %c.i6.cast2 = zext i4 %c.i6 to i6, !dbg !2971   ; [#uses=1 type=i6] [debug line = 117:12@133:4]
  %exitcond.i7 = icmp eq i4 %c.i6, -8, !dbg !2971 ; [#uses=1 type=i1] [debug line = 117:12@133:4]
  %14 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) nounwind ; [#uses=0 type=i32]
  br i1 %exitcond.i7, label %17, label %15, !dbg !2971 ; [debug line = 117:12@133:4]

; <label>:15                                      ; preds = %13
  call void (...)* @_ssdm_op_SpecLoopName([12 x i8]* @.str12) nounwind, !dbg !2972 ; [debug line = 118:2@133:4]
  %tmp.2.i = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @.str12) nounwind, !dbg !2972 ; [#uses=1 type=i32] [debug line = 118:2@133:4]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, [1 x i8]* @.str1) nounwind, !dbg !2973 ; [debug line = 119:1@133:4]
  %tmp.8.i = zext i4 %c.i6 to i64, !dbg !2968     ; [#uses=1 type=i64] [debug line = 118:1@133:4]
  %buf.assign.1.addr = getelementptr [8 x [8 x i16]]* %buf_2d_out, i64 0, i64 %tmp.i4, i64 %tmp.8.i, !dbg !2968 ; [#uses=1 type=i16*] [debug line = 118:1@133:4]
  %buf.assign.1.load = load i16* %buf.assign.1.addr, align 2, !dbg !2968 ; [#uses=1 type=i16] [debug line = 118:1@133:4]
  %tmp.9.i = add i6 %c.i6.cast2, %tmp..i5, !dbg !2968 ; [#uses=1 type=i6] [debug line = 118:1@133:4]
  %tmp.3.i = zext i6 %tmp.9.i to i64, !dbg !2968  ; [#uses=1 type=i64] [debug line = 118:1@133:4]
  %output.addr = getelementptr [64 x i16]* %output, i64 0, i64 %tmp.3.i, !dbg !2968 ; [#uses=1 type=i16*] [debug line = 118:1@133:4]
  store i16 %buf.assign.1.load, i16* %output.addr, align 2, !dbg !2968 ; [debug line = 118:1@133:4]
  %16 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @.str12, i32 %tmp.2.i) nounwind, !dbg !2974 ; [#uses=0 type=i32] [debug line = 118:67@133:4]
  %c.1 = add i4 %c.i6, 1, !dbg !2975              ; [#uses=1 type=i4] [debug line = 117:64@133:4]
  call void @llvm.dbg.value(metadata !{i4 %c.1}, i64 0, metadata !2976) nounwind, !dbg !2975 ; [debug line = 117:64@133:4] [debug variable = c]
  br label %13, !dbg !2975                        ; [debug line = 117:64@133:4]

; <label>:17                                      ; preds = %13
  %18 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @.str11, i32 %tmp.1.i) nounwind, !dbg !2977 ; [#uses=0 type=i32] [debug line = 119:4@133:4]
  %r.1 = add i4 %r.i2, 1, !dbg !2978              ; [#uses=1 type=i4] [debug line = 115:61@133:4]
  call void @llvm.dbg.value(metadata !{i4 %r.1}, i64 0, metadata !2979) nounwind, !dbg !2978 ; [debug line = 115:61@133:4] [debug variable = r]
  br label %10, !dbg !2978                        ; [debug line = 115:61@133:4]

write_data.exit:                                  ; preds = %10
  ret void, !dbg !2980                            ; [debug line = 134:1]
}
...
define internal fastcc void @dct_2d([8 x [8 x i16]]* nocapture %in_block, [8 x [8 x i16]]* nocapture %out_block) {
  ...
  call void @llvm.dbg.value(metadata !{[8 x [8 x i16]]* %in_block}, i64 0, metadata !2981), !dbg !2983 ; [debug line = 67:24] [debug variable = in_block]
  call void @llvm.dbg.value(metadata !{[8 x [8 x i16]]* %out_block}, i64 0, metadata !2984), !dbg !2985 ; [debug line = 68:18] [debug variable = out_block]
  call void @llvm.dbg.declare(metadata !{[8 x [8 x i16]]* %col_inbuf}, metadata !2986), !dbg !2988 ; [debug line = 71:109] [debug variable = col_inbuf]
  br label %1, !dbg !2989                         ; [debug line = 76:8]

; <label>:1                                       ; preds = %3, %0
  %i = phi i4 [ 0, %0 ], [ %i.4, %3 ]             ; [#uses=4 type=i4]
  %exitcond5 = icmp eq i4 %i, -8, !dbg !2989      ; [#uses=1 type=i1] [debug line = 76:8]
  %2 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) ; [#uses=0 type=i32]
  br i1 %exitcond5, label %.preheader7, label %3, !dbg !2989 ; [debug line = 76:8]

; <label>:3                                       ; preds = %1
  call void (...)* @_ssdm_op_SpecLoopName([13 x i8]* @.str3) nounwind, !dbg !2991 ; [debug line = 76:66]
  call fastcc void @dct_1d([8 x [8 x i16]]* %in_block, i4 %i, [8 x [8 x i16]]* %row_outbuf, i4 %i), !dbg !2993 ; [debug line = 77:7]
  %i.4 = add i4 %i, 1, !dbg !2994                 ; [#uses=1 type=i4] [debug line = 76:60]
  call void @llvm.dbg.value(metadata !{i4 %i.4}, i64 0, metadata !2995), !dbg !2994 ; [debug line = 76:60] [debug variable = i]
  br label %1, !dbg !2994                         ; [debug line = 76:60]

.preheader7:                                      ; preds = %10, %1
  %j = phi i4 [ %j.2, %10 ], [ 0, %1 ]            ; [#uses=3 type=i4]
  %exitcond4 = icmp eq i4 %j, -8, !dbg !2996      ; [#uses=1 type=i1] [debug line = 81:9]
  %4 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) ; [#uses=0 type=i32]
  br i1 %exitcond4, label %.preheader6, label %5, !dbg !2996 ; [debug line = 81:9]

; <label>:5                                       ; preds = %.preheader7
  call void (...)* @_ssdm_op_SpecLoopName([21 x i8]* @.str4) nounwind, !dbg !2998 ; [debug line = 82:1]
  %tmp.6 = call i32 (...)* @_ssdm_op_SpecRegionBegin([21 x i8]* @.str4), !dbg !2998 ; [#uses=1 type=i32] [debug line = 82:1]
  %tmp. = zext i4 %j to i64, !dbg !3000           ; [#uses=2 type=i64] [debug line = 84:1]
  br label %6, !dbg !3003                         ; [debug line = 83:11]

; <label>:6                                       ; preds = %8, %5
  %i.1 = phi i4 [ 0, %5 ], [ %i.6, %8 ]           ; [#uses=3 type=i4]
  %exitcond3 = icmp eq i4 %i.1, -8, !dbg !3003    ; [#uses=1 type=i1] [debug line = 83:11]
  %7 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) ; [#uses=0 type=i32]
  br i1 %exitcond3, label %10, label %8, !dbg !3003 ; [debug line = 83:11]

; <label>:8                                       ; preds = %6
  call void (...)* @_ssdm_op_SpecLoopName([21 x i8]* @.str5) nounwind, !dbg !3004 ; [debug line = 84:2]
  %tmp.9 = call i32 (...)* @_ssdm_op_SpecRegionBegin([21 x i8]* @.str5), !dbg !3004 ; [#uses=1 type=i32] [debug line = 84:2]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, [1 x i8]* @.str1) nounwind, !dbg !3005 ; [debug line = 85:1]
  %tmp.2 = zext i4 %i.1 to i64, !dbg !3000        ; [#uses=2 type=i64] [debug line = 84:1]
  %row_outbuf.addr = getelementptr inbounds [8 x [8 x i16]]* %row_outbuf, i64 0, i64 %tmp.2, i64 %tmp., !dbg !3000 ; [#uses=1 type=i16*] [debug line = 84:1]
  %row_outbuf.load = load i16* %row_outbuf.addr, align 2, !dbg !3000 ; [#uses=1 type=i16] [debug line = 84:1]
  %col_inbuf.addr = getelementptr inbounds [8 x [8 x i16]]* %col_inbuf, i64 0, i64 %tmp., i64 %tmp.2, !dbg !3000 ; [#uses=1 type=i16*] [debug line = 84:1]
  store i16 %row_outbuf.load, i16* %col_inbuf.addr, align 2, !dbg !3000 ; [debug line = 84:1]
  %9 = call i32 (...)* @_ssdm_op_SpecRegionEnd([21 x i8]* @.str5, i32 %tmp.9), !dbg !3006 ; [#uses=0 type=i32] [debug line = 84:34]
  %i.6 = add i4 %i.1, 1, !dbg !3007               ; [#uses=1 type=i4] [debug line = 83:63]
  call void @llvm.dbg.value(metadata !{i4 %i.6}, i64 0, metadata !2995), !dbg !3007 ; [debug line = 83:63] [debug variable = i]
  br label %6, !dbg !3007                         ; [debug line = 83:63]

; <label>:10                                      ; preds = %6
  %11 = call i32 (...)* @_ssdm_op_SpecRegionEnd([21 x i8]* @.str4, i32 %tmp.6), !dbg !3008 ; [#uses=0 type=i32] [debug line = 84:34]
  %j.2 = add i4 %j, 1, !dbg !3009                 ; [#uses=1 type=i4] [debug line = 81:61]
  call void @llvm.dbg.value(metadata !{i4 %j.2}, i64 0, metadata !3010), !dbg !3009 ; [debug line = 81:61] [debug variable = j]
  br label %.preheader7, !dbg !3009               ; [debug line = 81:61]

.preheader6:                                      ; preds = %13, %.preheader7
  %i.2 = phi i4 [ %i.5, %13 ], [ 0, %.preheader7 ] ; [#uses=4 type=i4]
  %exitcond2 = icmp eq i4 %i.2, -8, !dbg !3011    ; [#uses=1 type=i1] [debug line = 87:9]
  %12 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) ; [#uses=0 type=i32]
  br i1 %exitcond2, label %.preheader, label %13, !dbg !3011 ; [debug line = 87:9]

; <label>:13                                      ; preds = %.preheader6
  call void (...)* @_ssdm_op_SpecLoopName([13 x i8]* @.str6) nounwind, !dbg !3013 ; [debug line = 87:67]
  call fastcc void @dct_1d([8 x [8 x i16]]* %col_inbuf, i4 %i.2, [8 x [8 x i16]]* %col_outbuf, i4 %i.2), !dbg !3015 ; [debug line = 88:7]
  %i.5 = add i4 %i.2, 1, !dbg !3016               ; [#uses=1 type=i4] [debug line = 87:61]
  call void @llvm.dbg.value(metadata !{i4 %i.5}, i64 0, metadata !2995), !dbg !3016 ; [debug line = 87:61] [debug variable = i]
  br label %.preheader6, !dbg !3016               ; [debug line = 87:61]

.preheader:                                       ; preds = %20, %.preheader6
  %j.1 = phi i4 [ %j.3, %20 ], [ 0, %.preheader6 ] ; [#uses=3 type=i4]
  %exitcond1 = icmp eq i4 %j.1, -8, !dbg !3017    ; [#uses=1 type=i1] [debug line = 92:9]
  %14 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) ; [#uses=0 type=i32]
  br i1 %exitcond1, label %22, label %15, !dbg !3017 ; [debug line = 92:9]

; <label>:15                                      ; preds = %.preheader
  call void (...)* @_ssdm_op_SpecLoopName([21 x i8]* @.str7) nounwind, !dbg !3019 ; [debug line = 93:1]
  %tmp.8 = call i32 (...)* @_ssdm_op_SpecRegionBegin([21 x i8]* @.str7), !dbg !3019 ; [#uses=1 type=i32] [debug line = 93:1]
  %tmp.3 = zext i4 %j.1 to i64, !dbg !3021        ; [#uses=2 type=i64] [debug line = 95:1]
  br label %16, !dbg !3024                        ; [debug line = 94:11]

; <label>:16                                      ; preds = %18, %15
  %i.3 = phi i4 [ 0, %15 ], [ %i.7, %18 ]         ; [#uses=3 type=i4]
  %exitcond = icmp eq i4 %i.3, -8, !dbg !3024     ; [#uses=1 type=i1] [debug line = 94:11]
  %17 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) ; [#uses=0 type=i32]
  br i1 %exitcond, label %20, label %18, !dbg !3024 ; [debug line = 94:11]

; <label>:18                                      ; preds = %16
  call void (...)* @_ssdm_op_SpecLoopName([21 x i8]* @.str8) nounwind, !dbg !3025 ; [debug line = 95:2]
  %tmp.5 = call i32 (...)* @_ssdm_op_SpecRegionBegin([21 x i8]* @.str8), !dbg !3025 ; [#uses=1 type=i32] [debug line = 95:2]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, [1 x i8]* @.str1) nounwind, !dbg !3026 ; [debug line = 96:1]
  %tmp.4 = zext i4 %i.3 to i64, !dbg !3021        ; [#uses=2 type=i64] [debug line = 95:1]
  %col_outbuf.addr = getelementptr inbounds [8 x [8 x i16]]* %col_outbuf, i64 0, i64 %tmp.4, i64 %tmp.3, !dbg !3021 ; [#uses=1 type=i16*] [debug line = 95:1]
  %col_outbuf.load = load i16* %col_outbuf.addr, align 2, !dbg !3021 ; [#uses=1 type=i16] [debug line = 95:1]
  %out_block.addr = getelementptr [8 x [8 x i16]]* %out_block, i64 0, i64 %tmp.3, i64 %tmp.4, !dbg !3021 ; [#uses=1 type=i16*] [debug line = 95:1]
  store i16 %col_outbuf.load, i16* %out_block.addr, align 2, !dbg !3021 ; [debug line = 95:1]
  %19 = call i32 (...)* @_ssdm_op_SpecRegionEnd([21 x i8]* @.str8, i32 %tmp.5), !dbg !3027 ; [#uses=0 type=i32] [debug line = 95:34]
  %i.7 = add i4 %i.3, 1, !dbg !3028               ; [#uses=1 type=i4] [debug line = 94:63]
  call void @llvm.dbg.value(metadata !{i4 %i.7}, i64 0, metadata !2995), !dbg !3028 ; [debug line = 94:63] [debug variable = i]
  br label %16, !dbg !3028                        ; [debug line = 94:63]

; <label>:20                                      ; preds = %16
  %21 = call i32 (...)* @_ssdm_op_SpecRegionEnd([21 x i8]* @.str7, i32 %tmp.8), !dbg !3029 ; [#uses=0 type=i32] [debug line = 95:34]
  %j.3 = add i4 %j.1, 1, !dbg !3030               ; [#uses=1 type=i4] [debug line = 92:61]
  call void @llvm.dbg.value(metadata !{i4 %j.3}, i64 0, metadata !3010), !dbg !3030 ; [debug line = 92:61] [debug variable = j]
  br label %.preheader, !dbg !3030                ; [debug line = 92:61]

; <label>:22                                      ; preds = %.preheader
  ret void, !dbg !3031                            ; [debug line = 96:1]
}
...
define internal fastcc void @dct_1d([8 x [8 x i16]]* nocapture %src, i4 %tmp.1, [8 x [8 x i16]]* nocapture %dst, i4 %tmp.11) {
  ...
  call void (...)* @_ssdm_SpecKeepAssert(i64 %tmp.1.cast), !hlsrange !3032
  call void (...)* @_ssdm_SpecKeepAssert(i64 %tmp.11.cast), !hlsrange !3032
  call void @llvm.dbg.value(metadata !{[8 x [8 x i16]]* %src}, i64 0, metadata !3033), !dbg !3035 ; [debug line = 48:24] [debug variable = src]
  call void @llvm.dbg.value(metadata !{[8 x [8 x i16]]* %dst}, i64 0, metadata !3036), !dbg !3037 ; [debug line = 48:81] [debug variable = dst]
  br label %1, !dbg !3038                         ; [debug line = 57:9]

; <label>:1                                       ; preds = %3, %0
  %k = phi i4 [ 0, %0 ], [ %k.1, %3 ]             ; [#uses=3 type=i4]
  %exitcond1 = icmp eq i4 %k, -8, !dbg !3038      ; [#uses=1 type=i1] [debug line = 57:9]
  %2 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) ; [#uses=0 type=i32]
  br i1 %exitcond1, label %5, label %3, !dbg !3038 ; [debug line = 57:9]

; <label>:3                                       ; preds = %1
  call void (...)* @_ssdm_op_SpecLoopName([15 x i8]* @.str) nounwind, !dbg !3041 ; [debug line = 57:67]
  %tmp. = call i32 (...)* @_ssdm_op_SpecRegionBegin([15 x i8]* @.str) nounwind, !dbg !3041 ; [#uses=1 type=i32] [debug line = 57:67]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, [1 x i8]* @.str1) nounwind, !dbg !3043 ; [debug line = 58:1]
  %tmp = zext i4 %k to i64, !dbg !3044            ; [#uses=9 type=i64] [debug line = 60:48]
  %dct_coeff_table.0.addr = getelementptr [8 x i14]* @dct_coeff_table.0, i64 0, i64 %tmp, !dbg !3044 ; [#uses=1 type=i14*] [debug line = 60:48]
  %dct_coeff_table.0.load = load i14* %dct_coeff_table.0.addr, align 2, !dbg !3044 ; [#uses=1 type=i14] [debug line = 60:48]
  %coeff.cast = zext i14 %dct_coeff_table.0.load to i29, !dbg !3047 ; [#uses=1 type=i29] [debug line = 61:10]
  %src.addr = getelementptr [8 x [8 x i16]]* %src, i64 0, i64 %tmp.1.cast, i64 0, !dbg !3047 ; [#uses=1 type=i16*] [debug line = 61:10]
  %src.load = load i16* %src.addr, align 2, !dbg !3047 ; [#uses=1 type=i16] [debug line = 61:10]
  %tmp.7.cast = sext i16 %src.load to i29, !dbg !3047 ; [#uses=1 type=i29] [debug line = 61:10]
  %tmp.8 = mul i29 %tmp.7.cast, %coeff.cast, !dbg !3047 ; [#uses=1 type=i29] [debug line = 61:10]
  %dct_coeff_table.1.addr = getelementptr [8 x i15]* @dct_coeff_table.1, i64 0, i64 %tmp, !dbg !3044 ; [#uses=1 type=i15*] [debug line = 60:48]
  %dct_coeff_table.1.load = load i15* %dct_coeff_table.1.addr, align 2, !dbg !3044 ; [#uses=1 type=i15] [debug line = 60:48]
  %coeff.1.cast = sext i15 %dct_coeff_table.1.load to i29, !dbg !3047 ; [#uses=1 type=i29] [debug line = 61:10]
  %src.addr.1 = getelementptr [8 x [8 x i16]]* %src, i64 0, i64 %tmp.1.cast, i64 1, !dbg !3047 ; [#uses=1 type=i16*] [debug line = 61:10]
  %src.load.1 = load i16* %src.addr.1, align 2, !dbg !3047 ; [#uses=1 type=i16] [debug line = 61:10]
  %tmp.7.1.cast = sext i16 %src.load.1 to i29, !dbg !3047 ; [#uses=1 type=i29] [debug line = 61:10]
  %tmp.8.1 = mul i29 %tmp.7.1.cast, %coeff.1.cast, !dbg !3047 ; [#uses=1 type=i29] [debug line = 61:10]
  %dct_coeff_table.2.addr = getelementptr [8 x i15]* @dct_coeff_table.2, i64 0, i64 %tmp, !dbg !3044 ; [#uses=1 type=i15*] [debug line = 60:48]
  %dct_coeff_table.2.load = load i15* %dct_coeff_table.2.addr, align 2, !dbg !3044 ; [#uses=1 type=i15] [debug line = 60:48]
  %coeff.2.cast = sext i15 %dct_coeff_table.2.load to i29, !dbg !3047 ; [#uses=1 type=i29] [debug line = 61:10]
  %src.addr.2 = getelementptr [8 x [8 x i16]]* %src, i64 0, i64 %tmp.1.cast, i64 2, !dbg !3047 ; [#uses=1 type=i16*] [debug line = 61:10]
  %src.load.2 = load i16* %src.addr.2, align 2, !dbg !3047 ; [#uses=1 type=i16] [debug line = 61:10]
  %tmp.7.2.cast = sext i16 %src.load.2 to i29, !dbg !3047 ; [#uses=1 type=i29] [debug line = 61:10]
  %tmp.8.2 = mul i29 %tmp.7.2.cast, %coeff.2.cast, !dbg !3047 ; [#uses=1 type=i29] [debug line = 61:10]
  %dct_coeff_table.3.addr = getelementptr [8 x i15]* @dct_coeff_table.3, i64 0, i64 %tmp, !dbg !3044 ; [#uses=1 type=i15*] [debug line = 60:48]
  %dct_coeff_table.3.load = load i15* %dct_coeff_table.3.addr, align 2, !dbg !3044 ; [#uses=1 type=i15] [debug line = 60:48]
  %coeff.3.cast = sext i15 %dct_coeff_table.3.load to i29, !dbg !3047 ; [#uses=1 type=i29] [debug line = 61:10]
  %src.addr.3 = getelementptr [8 x [8 x i16]]* %src, i64 0, i64 %tmp.1.cast, i64 3, !dbg !3047 ; [#uses=1 type=i16*] [debug line = 61:10]
  %src.load.3 = load i16* %src.addr.3, align 2, !dbg !3047 ; [#uses=1 type=i16] [debug line = 61:10]
  %tmp.7.3.cast = sext i16 %src.load.3 to i29, !dbg !3047 ; [#uses=1 type=i29] [debug line = 61:10]
  %tmp.8.3 = mul i29 %tmp.7.3.cast, %coeff.3.cast, !dbg !3047 ; [#uses=1 type=i29] [debug line = 61:10]
  %dct_coeff_table.4.addr = getelementptr [8 x i15]* @dct_coeff_table.4, i64 0, i64 %tmp, !dbg !3044 ; [#uses=1 type=i15*] [debug line = 60:48]
  %dct_coeff_table.4.load = load i15* %dct_coeff_table.4.addr, align 2, !dbg !3044 ; [#uses=1 type=i15] [debug line = 60:48]
  %coeff.4.cast = sext i15 %dct_coeff_table.4.load to i29, !dbg !3047 ; [#uses=1 type=i29] [debug line = 61:10]
  %src.addr.4 = getelementptr [8 x [8 x i16]]* %src, i64 0, i64 %tmp.1.cast, i64 4, !dbg !3047 ; [#uses=1 type=i16*] [debug line = 61:10]
  %src.load.4 = load i16* %src.addr.4, align 2, !dbg !3047 ; [#uses=1 type=i16] [debug line = 61:10]
  %tmp.7.4.cast = sext i16 %src.load.4 to i29, !dbg !3047 ; [#uses=1 type=i29] [debug line = 61:10]
  %tmp.8.4 = mul i29 %tmp.7.4.cast, %coeff.4.cast, !dbg !3047 ; [#uses=1 type=i29] [debug line = 61:10]
  %dct_coeff_table.5.addr = getelementptr [8 x i15]* @dct_coeff_table.5, i64 0, i64 %tmp, !dbg !3044 ; [#uses=1 type=i15*] [debug line = 60:48]
  %dct_coeff_table.5.load = load i15* %dct_coeff_table.5.addr, align 2, !dbg !3044 ; [#uses=1 type=i15] [debug line = 60:48]
  %coeff.5.cast = sext i15 %dct_coeff_table.5.load to i29, !dbg !3047 ; [#uses=1 type=i29] [debug line = 61:10]
  %src.addr.5 = getelementptr [8 x [8 x i16]]* %src, i64 0, i64 %tmp.1.cast, i64 5, !dbg !3047 ; [#uses=1 type=i16*] [debug line = 61:10]
  %src.load.5 = load i16* %src.addr.5, align 2, !dbg !3047 ; [#uses=1 type=i16] [debug line = 61:10]
  %tmp.7.5.cast = sext i16 %src.load.5 to i29, !dbg !3047 ; [#uses=1 type=i29] [debug line = 61:10]
  %tmp.8.5 = mul i29 %tmp.7.5.cast, %coeff.5.cast, !dbg !3047 ; [#uses=1 type=i29] [debug line = 61:10]
  %dct_coeff_table.6.addr = getelementptr [8 x i15]* @dct_coeff_table.6, i64 0, i64 %tmp, !dbg !3044 ; [#uses=1 type=i15*] [debug line = 60:48]
  %dct_coeff_table.6.load = load i15* %dct_coeff_table.6.addr, align 2, !dbg !3044 ; [#uses=1 type=i15] [debug line = 60:48]
  %coeff.6.cast = sext i15 %dct_coeff_table.6.load to i29, !dbg !3047 ; [#uses=1 type=i29] [debug line = 61:10]
  %src.addr.6 = getelementptr [8 x [8 x i16]]* %src, i64 0, i64 %tmp.1.cast, i64 6, !dbg !3047 ; [#uses=1 type=i16*] [debug line = 61:10]
  %src.load.6 = load i16* %src.addr.6, align 2, !dbg !3047 ; [#uses=1 type=i16] [debug line = 61:10]
  %tmp.7.6.cast = sext i16 %src.load.6 to i29, !dbg !3047 ; [#uses=1 type=i29] [debug line = 61:10]
  %tmp.8.6 = mul i29 %tmp.7.6.cast, %coeff.6.cast, !dbg !3047 ; [#uses=1 type=i29] [debug line = 61:10]
  %dct_coeff_table.7.addr = getelementptr [8 x i15]* @dct_coeff_table.7, i64 0, i64 %tmp, !dbg !3044 ; [#uses=1 type=i15*] [debug line = 60:48]
  %dct_coeff_table.7.load = load i15* %dct_coeff_table.7.addr, align 2, !dbg !3044 ; [#uses=1 type=i15] [debug line = 60:48]
  %coeff.7.cast = sext i15 %dct_coeff_table.7.load to i29, !dbg !3047 ; [#uses=1 type=i29] [debug line = 61:10]
  %src.addr.7 = getelementptr [8 x [8 x i16]]* %src, i64 0, i64 %tmp.1.cast, i64 7, !dbg !3047 ; [#uses=1 type=i16*] [debug line = 61:10]
  %src.load.7 = load i16* %src.addr.7, align 2, !dbg !3047 ; [#uses=1 type=i16] [debug line = 61:10]
  %tmp.7.7.cast = sext i16 %src.load.7 to i29, !dbg !3047 ; [#uses=1 type=i29] [debug line = 61:10]
  %tmp.8.7 = mul i29 %tmp.7.7.cast, %coeff.7.cast, !dbg !3047 ; [#uses=1 type=i29] [debug line = 61:10]
  %tmp2 = add i29 %tmp.8.1, %tmp.8, !dbg !3048    ; [#uses=1 type=i29] [debug line = 63:7]
  %tmp3 = add i29 %tmp.8.3, %tmp.8.2, !dbg !3048  ; [#uses=1 type=i29] [debug line = 63:7]
  %tmp1 = add i29 %tmp2, %tmp3, !dbg !3048        ; [#uses=1 type=i29] [debug line = 63:7]
  %tmp5 = add i29 %tmp.8.5, %tmp.8.4, !dbg !3048  ; [#uses=1 type=i29] [debug line = 63:7]
  %tmp7 = add i29 %tmp.8.7, 4096, !dbg !3048      ; [#uses=1 type=i29] [debug line = 63:7]
  %tmp6 = add i29 %tmp.8.6, %tmp7, !dbg !3048     ; [#uses=1 type=i29] [debug line = 63:7]
  %tmp4 = add i29 %tmp5, %tmp6, !dbg !3048        ; [#uses=1 type=i29] [debug line = 63:7]
  %tmp.2 = add i29 %tmp1, %tmp4, !dbg !3048       ; [#uses=1 type=i29] [debug line = 63:7]
  %tmp.3 = lshr i29 %tmp.2, 13, !dbg !3048        ; [#uses=1 type=i29] [debug line = 63:7]
  %tmp.4 = trunc i29 %tmp.3 to i16, !dbg !3048    ; [#uses=1 type=i16] [debug line = 63:7]
  %dst.addr = getelementptr [8 x [8 x i16]]* %dst, i64 0, i64 %tmp.11.cast, i64 %tmp, !dbg !3048 ; [#uses=1 type=i16*] [debug line = 63:7]
  store i16 %tmp.4, i16* %dst.addr, align 2, !dbg !3048 ; [debug line = 63:7]
  %4 = call i32 (...)* @_ssdm_op_SpecRegionEnd([15 x i8]* @.str, i32 %tmp.) nounwind, !dbg !3049 ; [#uses=0 type=i32] [debug line = 64:4]
  %k.1 = add i4 %k, 1, !dbg !3050                 ; [#uses=1 type=i4] [debug line = 57:61]
  call void @llvm.dbg.value(metadata !{i4 %k.1}, i64 0, metadata !3051), !dbg !3050 ; [debug line = 57:61] [debug variable = k]
  br label %1, !dbg !3050                         ; [debug line = 57:61]

; <label>:5                                       ; preds = %1
  ret void, !dbg !3052                            ; [debug line = 65:1]
}
...
!2929 = metadata !{i32 786688, metadata !2930, metadata !"buf_2d_in", metadata !876, i32 124, metadata !2931, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2930 = metadata !{i32 786443, metadata !896, i32 123, i32 1, metadata !876, i32 28} ; [ DW_TAG_lexical_block ]
!2931 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 1024, i64 16, i32 0, i32 0, metadata !881, metadata !904, i32 0, i32 0} ; [ DW_TAG_array_type ]
!2932 = metadata !{i32 124, i32 10, metadata !2930, null}
!2933 = metadata !{i32 786688, metadata !2930, metadata !"buf_2d_out", metadata !876, i32 125, metadata !2931, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2934 = metadata !{i32 125, i32 10, metadata !2930, null}
!2935 = metadata !{i32 786689, metadata !887, metadata !"input", null, i32 98, metadata !2923, i32 0, metadata !2936} ; [ DW_TAG_arg_variable ]
!2936 = metadata !{i32 128, i32 4, metadata !2930, null}
!2937 = metadata !{i32 98, i32 22, metadata !887, metadata !2936}
!2938 = metadata !{i32 786689, metadata !887, metadata !"buf", null, i32 98, metadata !2931, i32 0, metadata !2936} ; [ DW_TAG_arg_variable ]
!2939 = metadata !{i32 98, i32 44, metadata !887, metadata !2936}
!2940 = metadata !{i32 103, i32 9, metadata !2941, metadata !2936}
!2941 = metadata !{i32 786443, metadata !2942, i32 103, i32 4, metadata !876, i32 19} ; [ DW_TAG_lexical_block ]
!2942 = metadata !{i32 786443, metadata !887, i32 99, i32 1, metadata !876, i32 18} ; [ DW_TAG_lexical_block ]
!2943 = metadata !{i32 103, i32 67, metadata !2944, metadata !2936}
!2944 = metadata !{i32 786443, metadata !2941, i32 103, i32 66, metadata !876, i32 20} ; [ DW_TAG_lexical_block ]
!2945 = metadata !{i32 106, i32 1, metadata !2946, metadata !2936}
!2946 = metadata !{i32 786443, metadata !2947, i32 106, i32 1, metadata !876, i32 22} ; [ DW_TAG_lexical_block ]
!2947 = metadata !{i32 786443, metadata !2944, i32 105, i32 7, metadata !876, i32 21} ; [ DW_TAG_lexical_block ]
!2948 = metadata !{i32 105, i32 12, metadata !2947, metadata !2936}
!2949 = metadata !{i32 106, i32 2, metadata !2946, metadata !2936}
!2950 = metadata !{i32 107, i32 1, metadata !2946, metadata !2936}
!2951 = metadata !{i32 106, i32 66, metadata !2946, metadata !2936}
!2952 = metadata !{i32 105, i32 64, metadata !2947, metadata !2936}
!2953 = metadata !{i32 786688, metadata !2942, metadata !"c", metadata !876, i32 100, metadata !55, i32 0, metadata !2936} ; [ DW_TAG_auto_variable ]
!2954 = metadata !{i32 107, i32 4, metadata !2944, metadata !2936}
!2955 = metadata !{i32 103, i32 61, metadata !2941, metadata !2936}
!2956 = metadata !{i32 786688, metadata !2942, metadata !"r", metadata !876, i32 100, metadata !55, i32 0, metadata !2936} ; [ DW_TAG_auto_variable ]
!2957 = metadata !{i32 130, i32 4, metadata !2930, null}
!2958 = metadata !{i32 786689, metadata !893, metadata !"buf", null, i32 110, metadata !2931, i32 0, metadata !2959} ; [ DW_TAG_arg_variable ]
!2959 = metadata !{i32 133, i32 4, metadata !2930, null}
!2960 = metadata !{i32 110, i32 23, metadata !893, metadata !2959}
!2961 = metadata !{i32 786689, metadata !893, metadata !"output", null, i32 110, metadata !2923, i32 0, metadata !2959} ; [ DW_TAG_arg_variable ]
!2962 = metadata !{i32 110, i32 116, metadata !893, metadata !2959}
!2963 = metadata !{i32 115, i32 9, metadata !2964, metadata !2959}
!2964 = metadata !{i32 786443, metadata !2965, i32 115, i32 4, metadata !876, i32 24} ; [ DW_TAG_lexical_block ]
!2965 = metadata !{i32 786443, metadata !893, i32 111, i32 1, metadata !876, i32 23} ; [ DW_TAG_lexical_block ]
!2966 = metadata !{i32 115, i32 67, metadata !2967, metadata !2959}
!2967 = metadata !{i32 786443, metadata !2964, i32 115, i32 66, metadata !876, i32 25} ; [ DW_TAG_lexical_block ]
!2968 = metadata !{i32 118, i32 1, metadata !2969, metadata !2959}
!2969 = metadata !{i32 786443, metadata !2970, i32 118, i32 1, metadata !876, i32 27} ; [ DW_TAG_lexical_block ]
!2970 = metadata !{i32 786443, metadata !2967, i32 117, i32 7, metadata !876, i32 26} ; [ DW_TAG_lexical_block ]
!2971 = metadata !{i32 117, i32 12, metadata !2970, metadata !2959}
!2972 = metadata !{i32 118, i32 2, metadata !2969, metadata !2959}
!2973 = metadata !{i32 119, i32 1, metadata !2969, metadata !2959}
!2974 = metadata !{i32 118, i32 67, metadata !2969, metadata !2959}
!2975 = metadata !{i32 117, i32 64, metadata !2970, metadata !2959}
!2976 = metadata !{i32 786688, metadata !2965, metadata !"c", metadata !876, i32 112, metadata !55, i32 0, metadata !2959} ; [ DW_TAG_auto_variable ]
!2977 = metadata !{i32 119, i32 4, metadata !2967, metadata !2959}
!2978 = metadata !{i32 115, i32 61, metadata !2964, metadata !2959}
!2979 = metadata !{i32 786688, metadata !2965, metadata !"r", metadata !876, i32 112, metadata !55, i32 0, metadata !2959} ; [ DW_TAG_auto_variable ]
!2980 = metadata !{i32 134, i32 1, metadata !2930, null}
!2981 = metadata !{i32 786689, metadata !882, metadata !"in_block", null, i32 67, metadata !2982, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2982 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 1024, i64 16, i32 0, i32 0, metadata !880, metadata !904, i32 0, i32 0} ; [ DW_TAG_array_type ]
!2983 = metadata !{i32 67, i32 24, metadata !882, null}
!2984 = metadata !{i32 786689, metadata !882, metadata !"out_block", null, i32 68, metadata !2982, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2985 = metadata !{i32 68, i32 18, metadata !882, null}
!2986 = metadata !{i32 786688, metadata !2987, metadata !"col_inbuf", metadata !876, i32 71, metadata !2982, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
...
!2989 = metadata !{i32 76, i32 8, metadata !2990, null}
!2990 = metadata !{i32 786443, metadata !2987, i32 76, i32 4, metadata !876, i32 6} ; [ DW_TAG_lexical_block ]
!2991 = metadata !{i32 76, i32 66, metadata !2992, null}
!2992 = metadata !{i32 786443, metadata !2990, i32 76, i32 65, metadata !876, i32 7} ; [ DW_TAG_lexical_block ]
!2993 = metadata !{i32 77, i32 7, metadata !2992, null}
!2994 = metadata !{i32 76, i32 60, metadata !2990, null}
!2995 = metadata !{i32 786688, metadata !2987, metadata !"i", metadata !876, i32 72, metadata !979, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2996 = metadata !{i32 81, i32 9, metadata !2997, null}
!2997 = metadata !{i32 786443, metadata !2987, i32 81, i32 4, metadata !876, i32 8} ; [ DW_TAG_lexical_block ]
!2998 = metadata !{i32 82, i32 1, metadata !2999, null}
!2999 = metadata !{i32 786443, metadata !2997, i32 82, i32 1, metadata !876, i32 9} ; [ DW_TAG_lexical_block ]
!3000 = metadata !{i32 84, i32 1, metadata !3001, null}
!3001 = metadata !{i32 786443, metadata !3002, i32 84, i32 1, metadata !876, i32 11} ; [ DW_TAG_lexical_block ]
!3002 = metadata !{i32 786443, metadata !2999, i32 83, i32 7, metadata !876, i32 10} ; [ DW_TAG_lexical_block ]
!3003 = metadata !{i32 83, i32 11, metadata !3002, null}
!3004 = metadata !{i32 84, i32 2, metadata !3001, null}
!3005 = metadata !{i32 85, i32 1, metadata !3001, null}
!3006 = metadata !{i32 84, i32 34, metadata !3001, null}
!3007 = metadata !{i32 83, i32 63, metadata !3002, null}
!3008 = metadata !{i32 84, i32 34, metadata !3002, null}
!3009 = metadata !{i32 81, i32 61, metadata !2997, null}
!3010 = metadata !{i32 786688, metadata !2987, metadata !"j", metadata !876, i32 72, metadata !979, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3011 = metadata !{i32 87, i32 9, metadata !3012, null}
!3012 = metadata !{i32 786443, metadata !2987, i32 87, i32 4, metadata !876, i32 12} ; [ DW_TAG_lexical_block ]
!3013 = metadata !{i32 87, i32 67, metadata !3014, null}
!3014 = metadata !{i32 786443, metadata !3012, i32 87, i32 66, metadata !876, i32 13} ; [ DW_TAG_lexical_block ]
!3015 = metadata !{i32 88, i32 7, metadata !3014, null}
!3016 = metadata !{i32 87, i32 61, metadata !3012, null}
!3017 = metadata !{i32 92, i32 9, metadata !3018, null}
!3018 = metadata !{i32 786443, metadata !2987, i32 92, i32 4, metadata !876, i32 14} ; [ DW_TAG_lexical_block ]
!3019 = metadata !{i32 93, i32 1, metadata !3020, null}
!3020 = metadata !{i32 786443, metadata !3018, i32 93, i32 1, metadata !876, i32 15} ; [ DW_TAG_lexical_block ]
!3021 = metadata !{i32 95, i32 1, metadata !3022, null}
!3022 = metadata !{i32 786443, metadata !3023, i32 95, i32 1, metadata !876, i32 17} ; [ DW_TAG_lexical_block ]
!3023 = metadata !{i32 786443, metadata !3020, i32 94, i32 7, metadata !876, i32 16} ; [ DW_TAG_lexical_block ]
!3024 = metadata !{i32 94, i32 11, metadata !3023, null}
!3025 = metadata !{i32 95, i32 2, metadata !3022, null}
!3026 = metadata !{i32 96, i32 1, metadata !3022, null}
!3027 = metadata !{i32 95, i32 34, metadata !3022, null}
!3028 = metadata !{i32 94, i32 63, metadata !3023, null}
!3029 = metadata !{i32 95, i32 34, metadata !3023, null}
!3030 = metadata !{i32 92, i32 61, metadata !3018, null}
!3031 = metadata !{i32 96, i32 1, metadata !2987, null}
!3032 = metadata !{i4 0, i4 7, i4 0, i4 7}        
!3033 = metadata !{i32 786689, metadata !875, metadata !"src", null, i32 48, metadata !3034, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3034 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 0, i64 0, i32 0, i32 0, metadata !880, metadata !107, i32 0, i32 0} ; [ DW_TAG_array_type ]
!3035 = metadata !{i32 48, i32 24, metadata !875, null}
!3036 = metadata !{i32 786689, metadata !875, metadata !"dst", null, i32 48, metadata !3034, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3037 = metadata !{i32 48, i32 81, metadata !875, null}
!3038 = metadata !{i32 57, i32 9, metadata !3039, null}
!3039 = metadata !{i32 786443, metadata !3040, i32 57, i32 4, metadata !876, i32 1} ; [ DW_TAG_lexical_block ]
!3040 = metadata !{i32 786443, metadata !875, i32 49, i32 1, metadata !876, i32 0} ; [ DW_TAG_lexical_block ]
!3041 = metadata !{i32 57, i32 67, metadata !3042, null}
!3042 = metadata !{i32 786443, metadata !3039, i32 57, i32 66, metadata !876, i32 2} ; [ DW_TAG_lexical_block ]
!3043 = metadata !{i32 58, i32 1, metadata !3042, null}
!3044 = metadata !{i32 60, i32 48, metadata !3045, null}
!3045 = metadata !{i32 786443, metadata !3046, i32 59, i32 77, metadata !876, i32 4} ; [ DW_TAG_lexical_block ]
!3046 = metadata !{i32 786443, metadata !3042, i32 59, i32 7, metadata !876, i32 3} ; [ DW_TAG_lexical_block ]
!3047 = metadata !{i32 61, i32 10, metadata !3045, null}
!3048 = metadata !{i32 63, i32 7, metadata !3042, null}
!3049 = metadata !{i32 64, i32 4, metadata !3042, null}
!3050 = metadata !{i32 57, i32 61, metadata !3039, null}
!3051 = metadata !{i32 786688, metadata !3040, metadata !"k", metadata !876, i32 50, metadata !979, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3052 = metadata !{i32 65, i32 1, metadata !3040, null}

; ModuleID = 'D:/opt/source/Vivado/Vivado_HLS_Tutorial/Design_Analysis/lab1/dct_prj/solution3/.autopilot/db/a.o.3.bc'
...
.reset:                                           ; preds = %1
  ...
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, [1 x i8]* @p_str1) nounwind, !dbg !57 ; [debug line = 107:1@128:4]
...
.reset10:                                         ; preds = %2
  ...
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, [1 x i8]* @p_str1) nounwind, !dbg !79 ; [debug line = 119:1@133:4]
...
.preheader7:                                      ; preds = %.preheader7.preheader
  ...
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, [1 x i8]* @p_str1) nounwind, !dbg !113 ; [debug line = 85:1]
...
.preheader:                                       ; preds = %.preheader.preheader
  ...
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, [1 x i8]* @p_str1) nounwind, !dbg !130 ; [debug line = 96:1]
...
define internal fastcc void @dct_dct_1d([64 x i16]* nocapture %src, i4 %tmp_1, [64 x i16]* nocapture %dst, i4 %tmp_11) {
  ...
  %tmp_5 = call i7 @_ssdm_op_BitConcatenate.i7.i4.i3(i4 %tmp_1_read, i3 0) ; [#uses=8 type=i7]
  %tmp_6 = zext i7 %tmp_5 to i64, !dbg !144       ; [#uses=1 type=i64] [debug line = 61:10]
  %src_addr = getelementptr [64 x i16]* %src, i64 0, i64 %tmp_6, !dbg !144 ; [#uses=1 type=i16*] [debug line = 61:10]
  %tmp_7 = or i7 %tmp_5, 1                        ; [#uses=1 type=i7]
  %p_addr = call i32 @_ssdm_op_BitConcatenate.i32.i25.i7(i25 0, i7 %tmp_7), !dbg !144 ; [#uses=1 type=i32] [debug line = 61:10]
  %tmp_9 = zext i32 %p_addr to i64, !dbg !144     ; [#uses=1 type=i64] [debug line = 61:10]
  %src_addr_1 = getelementptr [64 x i16]* %src, i64 0, i64 %tmp_9, !dbg !144 ; [#uses=1 type=i16*] [debug line = 61:10]
  %tmp_10 = or i7 %tmp_5, 2                       ; [#uses=1 type=i7]
  %p_addr1 = call i32 @_ssdm_op_BitConcatenate.i32.i25.i7(i25 0, i7 %tmp_10), !dbg !144 ; [#uses=1 type=i32] [debug line = 61:10]
  %tmp_12 = zext i32 %p_addr1 to i64, !dbg !144   ; [#uses=1 type=i64] [debug line = 61:10]
  %src_addr_2 = getelementptr [64 x i16]* %src, i64 0, i64 %tmp_12, !dbg !144 ; [#uses=1 type=i16*] [debug line = 61:10]
  %tmp_13 = or i7 %tmp_5, 3                       ; [#uses=1 type=i7]
  %p_addr2 = call i32 @_ssdm_op_BitConcatenate.i32.i25.i7(i25 0, i7 %tmp_13), !dbg !144 ; [#uses=1 type=i32] [debug line = 61:10]
  %tmp_14 = zext i32 %p_addr2 to i64, !dbg !144   ; [#uses=1 type=i64] [debug line = 61:10]
  %src_addr_3 = getelementptr [64 x i16]* %src, i64 0, i64 %tmp_14, !dbg !144 ; [#uses=1 type=i16*] [debug line = 61:10]
  %tmp_15 = or i7 %tmp_5, 4                       ; [#uses=1 type=i7]
  %p_addr3 = call i32 @_ssdm_op_BitConcatenate.i32.i25.i7(i25 0, i7 %tmp_15), !dbg !144 ; [#uses=1 type=i32] [debug line = 61:10]
  %tmp_16 = zext i32 %p_addr3 to i64, !dbg !144   ; [#uses=1 type=i64] [debug line = 61:10]
  %src_addr_4 = getelementptr [64 x i16]* %src, i64 0, i64 %tmp_16, !dbg !144 ; [#uses=1 type=i16*] [debug line = 61:10]
  %tmp_17 = or i7 %tmp_5, 5                       ; [#uses=1 type=i7]
  %p_addr4 = call i32 @_ssdm_op_BitConcatenate.i32.i25.i7(i25 0, i7 %tmp_17), !dbg !144 ; [#uses=1 type=i32] [debug line = 61:10]
  %tmp_18 = zext i32 %p_addr4 to i64, !dbg !144   ; [#uses=1 type=i64] [debug line = 61:10]
  %src_addr_5 = getelementptr [64 x i16]* %src, i64 0, i64 %tmp_18, !dbg !144 ; [#uses=1 type=i16*] [debug line = 61:10]
  %tmp_19 = or i7 %tmp_5, 6                       ; [#uses=1 type=i7]
  %p_addr5 = call i32 @_ssdm_op_BitConcatenate.i32.i25.i7(i25 0, i7 %tmp_19), !dbg !144 ; [#uses=1 type=i32] [debug line = 61:10]
  %tmp_20 = zext i32 %p_addr5 to i64, !dbg !144   ; [#uses=1 type=i64] [debug line = 61:10]
  %src_addr_6 = getelementptr [64 x i16]* %src, i64 0, i64 %tmp_20, !dbg !144 ; [#uses=1 type=i16*] [debug line = 61:10]
  %tmp_21 = or i7 %tmp_5, 7                       ; [#uses=1 type=i7]
  %p_addr6 = call i32 @_ssdm_op_BitConcatenate.i32.i25.i7(i25 0, i7 %tmp_21), !dbg !144 ; [#uses=1 type=i32] [debug line = 61:10]
  %tmp_22 = zext i32 %p_addr6 to i64, !dbg !144   ; [#uses=1 type=i64] [debug line = 61:10]
  %src_addr_7 = getelementptr [64 x i16]* %src, i64 0, i64 %tmp_22, !dbg !144 ; [#uses=1 type=i16*] [debug line = 61:10]
  %tmp_23 = call i7 @_ssdm_op_BitConcatenate.i7.i4.i3(i4 %tmp_11_read, i3 0) ; [#uses=1 type=i7]
  %p_addr16_cast = zext i7 %tmp_23 to i8, !dbg !150 ; [#uses=1 type=i8] [debug line = 57:9]
  br label %1, !dbg !150                          ; [debug line = 57:9]

; <label>:1                                       ; preds = %2, %0
  %k = phi i4 [ 0, %0 ], [ %k_1, %2 ]             ; [#uses=4 type=i4]
  %exitcond1 = icmp eq i4 %k, -8, !dbg !150       ; [#uses=1 type=i1] [debug line = 57:9]
  %k_1 = add i4 %k, 1, !dbg !151                  ; [#uses=1 type=i4] [debug line = 57:61]
  br i1 %exitcond1, label %3, label %2, !dbg !150 ; [debug line = 57:9]

; <label>:2                                       ; preds = %1
  %empty = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) ; [#uses=0 type=i32]
  call void (...)* @_ssdm_op_SpecLoopName([15 x i8]* @p_str) nounwind, !dbg !152 ; [debug line = 57:67]
  %tmp_s = call i32 (...)* @_ssdm_op_SpecRegionBegin([15 x i8]* @p_str) nounwind, !dbg !152 ; [#uses=1 type=i32] [debug line = 57:67]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, [1 x i8]* @p_str1) nounwind, !dbg !153 ; [debug line = 58:1]
  %tmp = zext i4 %k to i64, !dbg !154             ; [#uses=8 type=i64] [debug line = 60:48]
  %dct_coeff_table_0_addr = getelementptr [8 x i14]* @dct_coeff_table_0, i64 0, i64 %tmp, !dbg !154 ; [#uses=1 type=i14*] [debug line = 60:48]
  %dct_coeff_table_0_load = load i14* %dct_coeff_table_0_addr, align 2, !dbg !154 ; [#uses=1 type=i14] [debug line = 60:48]
  %coeff_cast = zext i14 %dct_coeff_table_0_load to i29, !dbg !144 ; [#uses=1 type=i29] [debug line = 61:10]
  %src_load = load i16* %src_addr, align 2, !dbg !144 ; [#uses=1 type=i16] [debug line = 61:10]
  %tmp_7_cast = sext i16 %src_load to i29, !dbg !144 ; [#uses=1 type=i29] [debug line = 61:10]
  %tmp_8 = mul i29 %tmp_7_cast, %coeff_cast, !dbg !144 ; [#uses=1 type=i29] [debug line = 61:10]
  %dct_coeff_table_1_addr = getelementptr [8 x i15]* @dct_coeff_table_1, i64 0, i64 %tmp, !dbg !154 ; [#uses=1 type=i15*] [debug line = 60:48]
  %dct_coeff_table_1_load = load i15* %dct_coeff_table_1_addr, align 2, !dbg !154 ; [#uses=1 type=i15] [debug line = 60:48]
  %coeff_1_cast = sext i15 %dct_coeff_table_1_load to i29, !dbg !144 ; [#uses=1 type=i29] [debug line = 61:10]
  %src_load_1 = load i16* %src_addr_1, align 2, !dbg !144 ; [#uses=1 type=i16] [debug line = 61:10]
  %tmp_7_1_cast = sext i16 %src_load_1 to i29, !dbg !144 ; [#uses=1 type=i29] [debug line = 61:10]
  %tmp_8_1 = mul i29 %tmp_7_1_cast, %coeff_1_cast, !dbg !144 ; [#uses=1 type=i29] [debug line = 61:10]
  %dct_coeff_table_2_addr = getelementptr [8 x i15]* @dct_coeff_table_2, i64 0, i64 %tmp, !dbg !154 ; [#uses=1 type=i15*] [debug line = 60:48]
  %dct_coeff_table_2_load = load i15* %dct_coeff_table_2_addr, align 2, !dbg !154 ; [#uses=1 type=i15] [debug line = 60:48]
  %coeff_2_cast = sext i15 %dct_coeff_table_2_load to i29, !dbg !144 ; [#uses=1 type=i29] [debug line = 61:10]
  %src_load_2 = load i16* %src_addr_2, align 2, !dbg !144 ; [#uses=1 type=i16] [debug line = 61:10]
  %tmp_7_2_cast = sext i16 %src_load_2 to i29, !dbg !144 ; [#uses=1 type=i29] [debug line = 61:10]
  %tmp_8_2 = mul i29 %tmp_7_2_cast, %coeff_2_cast, !dbg !144 ; [#uses=1 type=i29] [debug line = 61:10]
  %dct_coeff_table_3_addr = getelementptr [8 x i15]* @dct_coeff_table_3, i64 0, i64 %tmp, !dbg !154 ; [#uses=1 type=i15*] [debug line = 60:48]
  %dct_coeff_table_3_load = load i15* %dct_coeff_table_3_addr, align 2, !dbg !154 ; [#uses=1 type=i15] [debug line = 60:48]
  %coeff_3_cast = sext i15 %dct_coeff_table_3_load to i29, !dbg !144 ; [#uses=1 type=i29] [debug line = 61:10]
  %src_load_3 = load i16* %src_addr_3, align 2, !dbg !144 ; [#uses=1 type=i16] [debug line = 61:10]
  %tmp_7_3_cast = sext i16 %src_load_3 to i29, !dbg !144 ; [#uses=1 type=i29] [debug line = 61:10]
  %tmp_8_3 = mul i29 %tmp_7_3_cast, %coeff_3_cast, !dbg !144 ; [#uses=1 type=i29] [debug line = 61:10]
  %dct_coeff_table_4_addr = getelementptr [8 x i15]* @dct_coeff_table_4, i64 0, i64 %tmp, !dbg !154 ; [#uses=1 type=i15*] [debug line = 60:48]
  %dct_coeff_table_4_load = load i15* %dct_coeff_table_4_addr, align 2, !dbg !154 ; [#uses=1 type=i15] [debug line = 60:48]
  %coeff_4_cast = sext i15 %dct_coeff_table_4_load to i29, !dbg !144 ; [#uses=1 type=i29] [debug line = 61:10]
  %src_load_4 = load i16* %src_addr_4, align 2, !dbg !144 ; [#uses=1 type=i16] [debug line = 61:10]
  %tmp_7_4_cast = sext i16 %src_load_4 to i29, !dbg !144 ; [#uses=1 type=i29] [debug line = 61:10]
  %tmp_8_4 = mul i29 %tmp_7_4_cast, %coeff_4_cast, !dbg !144 ; [#uses=1 type=i29] [debug line = 61:10]
  %dct_coeff_table_5_addr = getelementptr [8 x i15]* @dct_coeff_table_5, i64 0, i64 %tmp, !dbg !154 ; [#uses=1 type=i15*] [debug line = 60:48]
  %dct_coeff_table_5_load = load i15* %dct_coeff_table_5_addr, align 2, !dbg !154 ; [#uses=1 type=i15] [debug line = 60:48]
  %coeff_5_cast = sext i15 %dct_coeff_table_5_load to i29, !dbg !144 ; [#uses=1 type=i29] [debug line = 61:10]
  %src_load_5 = load i16* %src_addr_5, align 2, !dbg !144 ; [#uses=1 type=i16] [debug line = 61:10]
  %tmp_7_5_cast = sext i16 %src_load_5 to i29, !dbg !144 ; [#uses=1 type=i29] [debug line = 61:10]
  %tmp_8_5 = mul i29 %tmp_7_5_cast, %coeff_5_cast, !dbg !144 ; [#uses=1 type=i29] [debug line = 61:10]
  %dct_coeff_table_6_addr = getelementptr [8 x i15]* @dct_coeff_table_6, i64 0, i64 %tmp, !dbg !154 ; [#uses=1 type=i15*] [debug line = 60:48]
  %dct_coeff_table_6_load = load i15* %dct_coeff_table_6_addr, align 2, !dbg !154 ; [#uses=1 type=i15] [debug line = 60:48]
  %coeff_6_cast = sext i15 %dct_coeff_table_6_load to i29, !dbg !144 ; [#uses=1 type=i29] [debug line = 61:10]
  %src_load_6 = load i16* %src_addr_6, align 2, !dbg !144 ; [#uses=1 type=i16] [debug line = 61:10]
  %tmp_7_6_cast = sext i16 %src_load_6 to i29, !dbg !144 ; [#uses=1 type=i29] [debug line = 61:10]
  %tmp_8_6 = mul i29 %tmp_7_6_cast, %coeff_6_cast, !dbg !144 ; [#uses=1 type=i29] [debug line = 61:10]
  %dct_coeff_table_7_addr = getelementptr [8 x i15]* @dct_coeff_table_7, i64 0, i64 %tmp, !dbg !154 ; [#uses=1 type=i15*] [debug line = 60:48]
  %dct_coeff_table_7_load = load i15* %dct_coeff_table_7_addr, align 2, !dbg !154 ; [#uses=1 type=i15] [debug line = 60:48]
  %coeff_7_cast = sext i15 %dct_coeff_table_7_load to i29, !dbg !144 ; [#uses=1 type=i29] [debug line = 61:10]
  %src_load_7 = load i16* %src_addr_7, align 2, !dbg !144 ; [#uses=1 type=i16] [debug line = 61:10]
  %tmp_7_7_cast = sext i16 %src_load_7 to i29, !dbg !144 ; [#uses=1 type=i29] [debug line = 61:10]
  %tmp_8_7 = mul i29 %tmp_7_7_cast, %coeff_7_cast, !dbg !144 ; [#uses=1 type=i29] [debug line = 61:10]
  %tmp2 = add i29 %tmp_8_1, %tmp_8, !dbg !155     ; [#uses=1 type=i29] [debug line = 63:7]
  %tmp3 = add i29 %tmp_8_3, %tmp_8_2, !dbg !155   ; [#uses=1 type=i29] [debug line = 63:7]
  %tmp1 = add i29 %tmp2, %tmp3, !dbg !155         ; [#uses=1 type=i29] [debug line = 63:7]
  %tmp5 = add i29 %tmp_8_5, %tmp_8_4, !dbg !155   ; [#uses=1 type=i29] [debug line = 63:7]
  %tmp7 = add i29 %tmp_8_7, 4096, !dbg !155       ; [#uses=1 type=i29] [debug line = 63:7]
  %tmp6 = add i29 %tmp_8_6, %tmp7, !dbg !155      ; [#uses=1 type=i29] [debug line = 63:7]
  %tmp4 = add i29 %tmp5, %tmp6, !dbg !155         ; [#uses=1 type=i29] [debug line = 63:7]
  %tmp_2 = add i29 %tmp1, %tmp4, !dbg !155        ; [#uses=1 type=i29] [debug line = 63:7]
  %tmp_4 = call i16 @_ssdm_op_PartSelect.i16.i29.i32.i32(i29 %tmp_2, i32 13, i32 28), !dbg !155 ; [#uses=1 type=i16] [debug line = 63:7]
  %tmp_trn_cast = zext i4 %k to i8, !dbg !155     ; [#uses=1 type=i8] [debug line = 63:7]
  %p_addr7 = add i8 %p_addr16_cast, %tmp_trn_cast, !dbg !155 ; [#uses=1 type=i8] [debug line = 63:7]
  %tmp_24 = zext i8 %p_addr7 to i64, !dbg !155    ; [#uses=1 type=i64] [debug line = 63:7]
  %dst_addr = getelementptr [64 x i16]* %dst, i64 0, i64 %tmp_24, !dbg !155 ; [#uses=1 type=i16*] [debug line = 63:7]
  store i16 %tmp_4, i16* %dst_addr, align 2, !dbg !155 ; [debug line = 63:7]
  %empty_13 = call i32 (...)* @_ssdm_op_SpecRegionEnd([15 x i8]* @p_str, i32 %tmp_s) nounwind, !dbg !156 ; [#uses=0 type=i32] [debug line = 64:4]
  call void @llvm.dbg.value(metadata !{i4 %k_1}, i64 0, metadata !157), !dbg !151 ; [debug line = 57:61] [debug variable = k]
  br label %1, !dbg !151                          ; [debug line = 57:61]

; <label>:3                                       ; preds = %1
  ret void, !dbg !158                             ; [debug line = 65:1]
}
...
entry:
  ...
  %empty_14 = zext i3 %1 to i6                    ; [#uses=1 type=i6]
  %empty_15 = shl i6 %empty, 3                    ; [#uses=1 type=i6]
...
entry:
  ...
  %empty_20 = zext i7 %1 to i32                   ; [#uses=1 type=i32]
  %empty_21 = shl i32 %empty, 7                   ; [#uses=1 type=i32]
...
entry:
  ...
  %empty_23 = trunc i29 %empty to i16             ; [#uses=1 type=i16]
  ret i16 %empty_23
}
...
!145 = metadata !{i32 786443, metadata !146, i32 59, i32 77, metadata !19, i32 4} ; [ DW_TAG_lexical_block ]
!146 = metadata !{i32 786443, metadata !147, i32 59, i32 7, metadata !19, i32 3} ; [ DW_TAG_lexical_block ]
!147 = metadata !{i32 786443, metadata !148, i32 57, i32 66, metadata !19, i32 2} ; [ DW_TAG_lexical_block ]
!148 = metadata !{i32 786443, metadata !149, i32 57, i32 4, metadata !19, i32 1} ; [ DW_TAG_lexical_block ]
!149 = metadata !{i32 786443, metadata !136, i32 49, i32 1, metadata !19, i32 0} ; [ DW_TAG_lexical_block ]
!150 = metadata !{i32 57, i32 9, metadata !148, null}
!151 = metadata !{i32 57, i32 61, metadata !148, null}
!152 = metadata !{i32 57, i32 67, metadata !147, null}
!153 = metadata !{i32 58, i32 1, metadata !147, null}
!154 = metadata !{i32 60, i32 48, metadata !145, null}
!155 = metadata !{i32 63, i32 7, metadata !147, null}
!156 = metadata !{i32 64, i32 4, metadata !147, null}
!157 = metadata !{i32 786688, metadata !149, metadata !"k", metadata !19, i32 50, metadata !105, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!158 = metadata !{i32 65, i32 1, metadata !149, null}

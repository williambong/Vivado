...
codeRepl:
  call void (...)* @_ssdm_op_SpecDataflowPipeline(i32 -1, [1 x i8]* @.str1) nounwind, !dbg !2912 ; [debug line = 124:1]
  call void (...)* @_ssdm_op_SpecBitsMap([64 x i16]* %input) nounwind, !map !2914
  call void (...)* @_ssdm_op_SpecBitsMap([64 x i16]* %output) nounwind, !map !2920
  ...
  call void @llvm.dbg.value(metadata !{[64 x i16]* %input}, i64 0, metadata !2924), !dbg !2928 ; [debug line = 122:16] [debug variable = input]
  call void @llvm.dbg.value(metadata !{[64 x i16]* %output}, i64 0, metadata !2929), !dbg !2930 ; [debug line = 122:38] [debug variable = output]
  call void @llvm.dbg.declare(metadata !{[8 x i16]* %"col_inbuf[0]"}, metadata !2931), !dbg !2936 ; [debug line = 71:109@130:4] [debug variable = col_inbuf[0]]
  call void @llvm.dbg.declare(metadata !{[8 x i16]* %"col_inbuf[1]"}, metadata !2938), !dbg !2936 ; [debug line = 71:109@130:4] [debug variable = col_inbuf[1]]
  call void @llvm.dbg.declare(metadata !{[8 x i16]* %"col_inbuf[2]"}, metadata !2939), !dbg !2936 ; [debug line = 71:109@130:4] [debug variable = col_inbuf[2]]
  call void @llvm.dbg.declare(metadata !{[8 x i16]* %"col_inbuf[3]"}, metadata !2940), !dbg !2936 ; [debug line = 71:109@130:4] [debug variable = col_inbuf[3]]
  call void @llvm.dbg.declare(metadata !{[8 x i16]* %"col_inbuf[4]"}, metadata !2941), !dbg !2936 ; [debug line = 71:109@130:4] [debug variable = col_inbuf[4]]
  call void @llvm.dbg.declare(metadata !{[8 x i16]* %"col_inbuf[5]"}, metadata !2942), !dbg !2936 ; [debug line = 71:109@130:4] [debug variable = col_inbuf[5]]
  call void @llvm.dbg.declare(metadata !{[8 x i16]* %"col_inbuf[6]"}, metadata !2943), !dbg !2936 ; [debug line = 71:109@130:4] [debug variable = col_inbuf[6]]
  call void @llvm.dbg.declare(metadata !{[8 x i16]* %"col_inbuf[7]"}, metadata !2944), !dbg !2936 ; [debug line = 71:109@130:4] [debug variable = col_inbuf[7]]
  call void @llvm.dbg.declare(metadata !{[8 x i16]* %"buf_2d_in[0]"}, metadata !2945), !dbg !2949 ; [debug line = 124:10] [debug variable = buf_2d_in[0]]
  call void @llvm.dbg.declare(metadata !{[8 x i16]* %"buf_2d_in[1]"}, metadata !2950), !dbg !2949 ; [debug line = 124:10] [debug variable = buf_2d_in[1]]
  call void @llvm.dbg.declare(metadata !{[8 x i16]* %"buf_2d_in[2]"}, metadata !2951), !dbg !2949 ; [debug line = 124:10] [debug variable = buf_2d_in[2]]
  call void @llvm.dbg.declare(metadata !{[8 x i16]* %"buf_2d_in[3]"}, metadata !2952), !dbg !2949 ; [debug line = 124:10] [debug variable = buf_2d_in[3]]
  call void @llvm.dbg.declare(metadata !{[8 x i16]* %"buf_2d_in[4]"}, metadata !2953), !dbg !2949 ; [debug line = 124:10] [debug variable = buf_2d_in[4]]
  call void @llvm.dbg.declare(metadata !{[8 x i16]* %"buf_2d_in[5]"}, metadata !2954), !dbg !2949 ; [debug line = 124:10] [debug variable = buf_2d_in[5]]
  call void @llvm.dbg.declare(metadata !{[8 x i16]* %"buf_2d_in[6]"}, metadata !2955), !dbg !2949 ; [debug line = 124:10] [debug variable = buf_2d_in[6]]
  call void @llvm.dbg.declare(metadata !{[8 x i16]* %"buf_2d_in[7]"}, metadata !2956), !dbg !2949 ; [debug line = 124:10] [debug variable = buf_2d_in[7]]
  call void @llvm.dbg.declare(metadata !{[8 x [8 x i16]]* %buf_2d_out}, metadata !2957), !dbg !2958 ; [debug line = 125:10] [debug variable = buf_2d_out]
  call fastcc void @read_data([64 x i16]* %input, [8 x i16]* %"buf_2d_in[0]", [8 x i16]* %"buf_2d_in[1]", [8 x i16]* %"buf_2d_in[2]", [8 x i16]* %"buf_2d_in[3]", [8 x i16]* %"buf_2d_in[4]", [8 x i16]* %"buf_2d_in[5]", [8 x i16]* %"buf_2d_in[6]", [8 x i16]* %"buf_2d_in[7]") nounwind, !dbg !2959 ; [debug line = 128:4]
  ...
  call fastcc void @write_data([8 x [8 x i16]]* %buf_2d_out, [64 x i16]* %output) nounwind, !dbg !2960 ; [debug line = 133:4]
  ret void, !dbg !2961                            ; [debug line = 134:1]
}

; [#uses=1]
define internal fastcc void @write_data([8 x [8 x i16]]* nocapture %buf, [64 x i16]* nocapture %output) {
  call void @llvm.dbg.value(metadata !{[8 x [8 x i16]]* %buf}, i64 0, metadata !2962), !dbg !2963 ; [debug line = 110:23] [debug variable = buf]
  call void @llvm.dbg.value(metadata !{[64 x i16]* %output}, i64 0, metadata !2964), !dbg !2965 ; [debug line = 110:116] [debug variable = output]
  br label %1, !dbg !2966                         ; [debug line = 115:9]

; <label>:1                                       ; preds = %8, %0
  %r = phi i4 [ 0, %0 ], [ %r.1, %8 ]             ; [#uses=4 type=i4]
  %r.cast7 = zext i4 %r to i6, !dbg !2966         ; [#uses=1 type=i6] [debug line = 115:9]
  %exitcond1 = icmp eq i4 %r, -8, !dbg !2966      ; [#uses=1 type=i1] [debug line = 115:9]
  %2 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) ; [#uses=0 type=i32]
  br i1 %exitcond1, label %10, label %3, !dbg !2966 ; [debug line = 115:9]

; <label>:3                                       ; preds = %1
  call void (...)* @_ssdm_op_SpecLoopName([12 x i8]* @.str12) nounwind, !dbg !2969 ; [debug line = 115:67]
  %tmp.7 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @.str12), !dbg !2969 ; [#uses=1 type=i32] [debug line = 115:67]
  %tmp = zext i4 %r to i64, !dbg !2971            ; [#uses=1 type=i64] [debug line = 118:1]
  %tmp. = shl i6 %r.cast7, 3, !dbg !2971          ; [#uses=1 type=i6] [debug line = 118:1]
  br label %4, !dbg !2974                         ; [debug line = 117:12]

; <label>:4                                       ; preds = %6, %3
  %c = phi i4 [ 0, %3 ], [ %c.1, %6 ]             ; [#uses=4 type=i4]
  %c.cast6 = zext i4 %c to i6, !dbg !2974         ; [#uses=1 type=i6] [debug line = 117:12]
  %exitcond = icmp eq i4 %c, -8, !dbg !2974       ; [#uses=1 type=i1] [debug line = 117:12]
  %5 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) ; [#uses=0 type=i32]
  br i1 %exitcond, label %8, label %6, !dbg !2974 ; [debug line = 117:12]

; <label>:6                                       ; preds = %4
  call void (...)* @_ssdm_op_SpecLoopName([12 x i8]* @.str13) nounwind, !dbg !2975 ; [debug line = 118:2]
  %tmp.8 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @.str13), !dbg !2975 ; [#uses=1 type=i32] [debug line = 118:2]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, [1 x i8]* @.str1) nounwind, !dbg !2976 ; [debug line = 119:1]
  %tmp.4 = zext i4 %c to i64, !dbg !2971          ; [#uses=1 type=i64] [debug line = 118:1]
  %buf.addr = getelementptr [8 x [8 x i16]]* %buf, i64 0, i64 %tmp, i64 %tmp.4, !dbg !2971 ; [#uses=1 type=i16*] [debug line = 118:1]
  %buf.load = load i16* %buf.addr, align 2, !dbg !2971 ; [#uses=1 type=i16] [debug line = 118:1]
  %tmp.5 = add i6 %c.cast6, %tmp., !dbg !2971     ; [#uses=1 type=i6] [debug line = 118:1]
  %tmp.6 = zext i6 %tmp.5 to i64, !dbg !2971      ; [#uses=1 type=i64] [debug line = 118:1]
  %output.addr = getelementptr [64 x i16]* %output, i64 0, i64 %tmp.6, !dbg !2971 ; [#uses=1 type=i16*] [debug line = 118:1]
  store i16 %buf.load, i16* %output.addr, align 2, !dbg !2971 ; [debug line = 118:1]
  %7 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @.str13, i32 %tmp.8), !dbg !2977 ; [#uses=0 type=i32] [debug line = 118:67]
  %c.1 = add i4 %c, 1, !dbg !2978                 ; [#uses=1 type=i4] [debug line = 117:64]
  call void @llvm.dbg.value(metadata !{i4 %c.1}, i64 0, metadata !2979), !dbg !2978 ; [debug line = 117:64] [debug variable = c]
  br label %4, !dbg !2978                         ; [debug line = 117:64]

; <label>:8                                       ; preds = %4
  %9 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @.str12, i32 %tmp.7), !dbg !2980 ; [#uses=0 type=i32] [debug line = 119:4]
  %r.1 = add i4 %r, 1, !dbg !2981                 ; [#uses=1 type=i4] [debug line = 115:61]
  call void @llvm.dbg.value(metadata !{i4 %r.1}, i64 0, metadata !2982), !dbg !2981 ; [debug line = 115:61] [debug variable = r]
  br label %1, !dbg !2981                         ; [debug line = 115:61]

; <label>:10                                      ; preds = %1
  ret void, !dbg !2983                            ; [debug line = 120:1]
}
...
define internal fastcc void @read_data([64 x i16]* nocapture %input, [8 x i16]* nocapture %"buf[0]", [8 x i16]* nocapture %"buf[1]", [8 x i16]* nocapture %"buf[2]", [8 x i16]* nocapture %"buf[3]", [8 x i16]* nocapture %"buf[4]", [8 x i16]* nocapture %"buf[5]", [8 x i16]* nocapture %"buf[6]", [8 x i16]* nocapture %"buf[7]") {
  call void @llvm.dbg.value(metadata !{[64 x i16]* %input}, i64 0, metadata !2984), !dbg !2985 ; [debug line = 98:22] [debug variable = input]
  call void @llvm.dbg.value(metadata !{[8 x i16]* %"buf[0]"}, i64 0, metadata !2986), !dbg !2988 ; [debug line = 98:44] [debug variable = buf[0]]
  call void @llvm.dbg.value(metadata !{[8 x i16]* %"buf[1]"}, i64 0, metadata !2989), !dbg !2988 ; [debug line = 98:44] [debug variable = buf[1]]
  call void @llvm.dbg.value(metadata !{[8 x i16]* %"buf[2]"}, i64 0, metadata !2990), !dbg !2988 ; [debug line = 98:44] [debug variable = buf[2]]
  call void @llvm.dbg.value(metadata !{[8 x i16]* %"buf[3]"}, i64 0, metadata !2991), !dbg !2988 ; [debug line = 98:44] [debug variable = buf[3]]
  call void @llvm.dbg.value(metadata !{[8 x i16]* %"buf[4]"}, i64 0, metadata !2992), !dbg !2988 ; [debug line = 98:44] [debug variable = buf[4]]
  call void @llvm.dbg.value(metadata !{[8 x i16]* %"buf[5]"}, i64 0, metadata !2993), !dbg !2988 ; [debug line = 98:44] [debug variable = buf[5]]
  call void @llvm.dbg.value(metadata !{[8 x i16]* %"buf[6]"}, i64 0, metadata !2994), !dbg !2988 ; [debug line = 98:44] [debug variable = buf[6]]
  call void @llvm.dbg.value(metadata !{[8 x i16]* %"buf[7]"}, i64 0, metadata !2995), !dbg !2988 ; [debug line = 98:44] [debug variable = buf[7]]
  br label %1, !dbg !2996                         ; [debug line = 103:9]

; <label>:1                                       ; preds = %9, %0
  %r = phi i4 [ 0, %0 ], [ %r.1, %9 ]             ; [#uses=4 type=i4]
  %r.cast = zext i4 %r to i6, !dbg !2996          ; [#uses=1 type=i6] [debug line = 103:9]
  %exitcond1 = icmp eq i4 %r, -8, !dbg !2996      ; [#uses=1 type=i1] [debug line = 103:9]
  %2 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) ; [#uses=0 type=i32]
  br i1 %exitcond1, label %11, label %3, !dbg !2996 ; [debug line = 103:9]

; <label>:3                                       ; preds = %1
  call void (...)* @_ssdm_op_SpecLoopName([12 x i8]* @.str10) nounwind, !dbg !2999 ; [debug line = 103:67]
  %tmp.9 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @.str10), !dbg !2999 ; [#uses=1 type=i32] [debug line = 103:67]
  %tmp = shl i6 %r.cast, 3, !dbg !3001            ; [#uses=1 type=i6] [debug line = 106:1]
  %tmp. = zext i4 %r to i64, !dbg !3001           ; [#uses=8 type=i64] [debug line = 106:1]
  br label %4, !dbg !3004                         ; [debug line = 105:12]

; <label>:4                                       ; preds = %7, %3
  %c = phi i4 [ 0, %3 ], [ %c.1, %7 ]             ; [#uses=4 type=i4]
  %c.cast = zext i4 %c to i6, !dbg !3004          ; [#uses=1 type=i6] [debug line = 105:12]
  %exitcond = icmp eq i4 %c, -8, !dbg !3004       ; [#uses=1 type=i1] [debug line = 105:12]
  %5 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) ; [#uses=0 type=i32]
  br i1 %exitcond, label %9, label %6, !dbg !3004 ; [debug line = 105:12]

; <label>:6                                       ; preds = %4
  call void (...)* @_ssdm_op_SpecLoopName([12 x i8]* @.str11) nounwind, !dbg !3005 ; [debug line = 106:2]
  %tmp.3 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @.str11), !dbg !3005 ; [#uses=1 type=i32] [debug line = 106:2]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, [1 x i8]* @.str1) nounwind, !dbg !3006 ; [debug line = 107:1]
  %tmp.1 = add i6 %c.cast, %tmp, !dbg !3001       ; [#uses=1 type=i6] [debug line = 106:1]
  %tmp.2 = zext i6 %tmp.1 to i64, !dbg !3001      ; [#uses=1 type=i64] [debug line = 106:1]
  %input.addr = getelementptr [64 x i16]* %input, i64 0, i64 %tmp.2, !dbg !3001 ; [#uses=1 type=i16*] [debug line = 106:1]
  %input.load = load i16* %input.addr, align 2, !dbg !3001 ; [#uses=8 type=i16] [debug line = 106:1]
  %c.t = trunc i4 %c to i3                        ; [#uses=1 type=i3]
  %"buf[0].addr" = getelementptr [8 x i16]* %"buf[0]", i64 0, i64 %tmp., !dbg !3001 ; [#uses=1 type=i16*] [debug line = 106:1]
  %"buf[1].addr" = getelementptr [8 x i16]* %"buf[1]", i64 0, i64 %tmp., !dbg !3001 ; [#uses=1 type=i16*] [debug line = 106:1]
  %"buf[2].addr" = getelementptr [8 x i16]* %"buf[2]", i64 0, i64 %tmp., !dbg !3001 ; [#uses=1 type=i16*] [debug line = 106:1]
  %"buf[3].addr" = getelementptr [8 x i16]* %"buf[3]", i64 0, i64 %tmp., !dbg !3001 ; [#uses=1 type=i16*] [debug line = 106:1]
  %"buf[4].addr" = getelementptr [8 x i16]* %"buf[4]", i64 0, i64 %tmp., !dbg !3001 ; [#uses=1 type=i16*] [debug line = 106:1]
  %"buf[5].addr" = getelementptr [8 x i16]* %"buf[5]", i64 0, i64 %tmp., !dbg !3001 ; [#uses=1 type=i16*] [debug line = 106:1]
  %"buf[6].addr" = getelementptr [8 x i16]* %"buf[6]", i64 0, i64 %tmp., !dbg !3001 ; [#uses=1 type=i16*] [debug line = 106:1]
  %"buf[7].addr" = getelementptr [8 x i16]* %"buf[7]", i64 0, i64 %tmp., !dbg !3001 ; [#uses=1 type=i16*] [debug line = 106:1]
  switch i3 %c.t, label %branch7 [
    ...
    i3 -3, label %branch5
    i3 -2, label %branch6
  ], !dbg !3001                                   ; [debug line = 106:1]

; <label>:7                                       ; preds = %branch7, %branch6, %branch5, %branch4, %branch3, %branch2, %branch1, %branch0
  %8 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @.str11, i32 %tmp.3), !dbg !3007 ; [#uses=0 type=i32] [debug line = 106:66]
  %c.1 = add i4 %c, 1, !dbg !3008                 ; [#uses=1 type=i4] [debug line = 105:64]
  call void @llvm.dbg.value(metadata !{i4 %c.1}, i64 0, metadata !3009), !dbg !3008 ; [debug line = 105:64] [debug variable = c]
  br label %4, !dbg !3008                         ; [debug line = 105:64]

; <label>:9                                       ; preds = %4
  %10 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @.str10, i32 %tmp.9), !dbg !3010 ; [#uses=0 type=i32] [debug line = 107:4]
  %r.1 = add i4 %r, 1, !dbg !3011                 ; [#uses=1 type=i4] [debug line = 103:61]
  call void @llvm.dbg.value(metadata !{i4 %r.1}, i64 0, metadata !3012), !dbg !3011 ; [debug line = 103:61] [debug variable = r]
  br label %1, !dbg !3011                         ; [debug line = 103:61]

; <label>:11                                      ; preds = %1
  ret void, !dbg !3013                            ; [debug line = 108:1]

branch0:                                          ; preds = %6
  store i16 %input.load, i16* %"buf[0].addr", align 2, !dbg !3001 ; [debug line = 106:1]
  br label %7, !dbg !3001                         ; [debug line = 106:1]

branch1:                                          ; preds = %6
  store i16 %input.load, i16* %"buf[1].addr", align 2, !dbg !3001 ; [debug line = 106:1]
  br label %7, !dbg !3001                         ; [debug line = 106:1]

branch2:                                          ; preds = %6
  store i16 %input.load, i16* %"buf[2].addr", align 2, !dbg !3001 ; [debug line = 106:1]
  br label %7, !dbg !3001                         ; [debug line = 106:1]

branch3:                                          ; preds = %6
  store i16 %input.load, i16* %"buf[3].addr", align 2, !dbg !3001 ; [debug line = 106:1]
  br label %7, !dbg !3001                         ; [debug line = 106:1]

branch4:                                          ; preds = %6
  store i16 %input.load, i16* %"buf[4].addr", align 2, !dbg !3001 ; [debug line = 106:1]
  br label %7, !dbg !3001                         ; [debug line = 106:1]

branch5:                                          ; preds = %6
  store i16 %input.load, i16* %"buf[5].addr", align 2, !dbg !3001 ; [debug line = 106:1]
  br label %7, !dbg !3001                         ; [debug line = 106:1]

branch6:                                          ; preds = %6
  store i16 %input.load, i16* %"buf[6].addr", align 2, !dbg !3001 ; [debug line = 106:1]
  br label %7, !dbg !3001                         ; [debug line = 106:1]

branch7:                                          ; preds = %6
  store i16 %input.load, i16* %"buf[7].addr", align 2, !dbg !3001 ; [debug line = 106:1]
  br label %7, !dbg !3001                         ; [debug line = 106:1]
}
...
newFuncRoot:
  br label %0, !dbg !3014                         ; [debug line = 76:8@130:4]
...
; <label>:0                                       ; preds = %dct_1d.exit, %newFuncRoot
  ...
  %exitcond5.i = icmp eq i4 %i.0.i, -8, !dbg !3014 ; [#uses=1 type=i1] [debug line = 76:8@130:4]
  %1 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) nounwind ; [#uses=0 type=i32]
  br i1 %exitcond5.i, label %.preheader7.i.exitStub, label %2, !dbg !3014 ; [debug line = 76:8@130:4]

; <label>:2                                       ; preds = %0
  call void (...)* @_ssdm_op_SpecLoopName([13 x i8]* @.str4) nounwind, !dbg !3016 ; [debug line = 76:66@130:4]
  call void (...)* @_ssdm_SpecKeepAssert(i4 %i.0.i) nounwind, !hlsrange !3018
  call void (...)* @_ssdm_SpecKeepAssert(i4 %i.0.i) nounwind, !hlsrange !3018
  %tmp.71.cast.i = zext i4 %i.0.i to i64          ; [#uses=1 type=i64]
  %tmp.7.cast.i = zext i4 %i.0.i to i64           ; [#uses=8 type=i64]
  call void @llvm.dbg.value(metadata !{[8 x [8 x i16]]* %row_outbuf.i}, i64 0, metadata !3019) nounwind, !dbg !3022 ; [debug line = 48:81@77:7@130:4] [debug variable = dst]
  br label %3, !dbg !3023                         ; [debug line = 57:9@77:7@130:4]

; <label>:3                                       ; preds = %5, %2
  %k.i = phi i4 [ 0, %2 ], [ %k, %5 ]             ; [#uses=3 type=i4]
  %exitcond1.i = icmp eq i4 %k.i, -8, !dbg !3023  ; [#uses=1 type=i1] [debug line = 57:9@77:7@130:4]
  %4 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) nounwind ; [#uses=0 type=i32]
  br i1 %exitcond1.i, label %dct_1d.exit, label %5, !dbg !3023 ; [debug line = 57:9@77:7@130:4]

; <label>:5                                       ; preds = %3
  call void (...)* @_ssdm_op_SpecLoopName([15 x i8]* @.str) nounwind, !dbg !3026 ; [debug line = 57:67@77:7@130:4]
  %tmp..i = call i32 (...)* @_ssdm_op_SpecRegionBegin([15 x i8]* @.str) nounwind, !dbg !3026 ; [#uses=1 type=i32] [debug line = 57:67@77:7@130:4]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, [1 x i8]* @.str1) nounwind, !dbg !3028 ; [debug line = 58:1@77:7@130:4]
  %tmp.i = zext i4 %k.i to i64, !dbg !3029        ; [#uses=9 type=i64] [debug line = 60:48@77:7@130:4]
  %dct_coeff_table.0.addr = getelementptr [8 x i14]* @dct_coeff_table.0, i64 0, i64 %tmp.i, !dbg !3029 ; [#uses=1 type=i14*] [debug line = 60:48@77:7@130:4]
  %dct_coeff_table.0.load = load i14* %dct_coeff_table.0.addr, align 2, !dbg !3029 ; [#uses=1 type=i14] [debug line = 60:48@77:7@130:4]
  %coeff.cast.i = zext i14 %dct_coeff_table.0.load to i29 ; [#uses=1 type=i29]
  %"buf_2d_in[0].addr" = getelementptr [8 x i16]* %"buf_2d_in[0]", i64 0, i64 %tmp.7.cast.i ; [#uses=1 type=i16*]
  %"buf_2d_in[0].load" = load i16* %"buf_2d_in[0].addr", align 2 ; [#uses=1 type=i16]
  %tmp.72.cast.i = sext i16 %"buf_2d_in[0].load" to i29, !dbg !3032 ; [#uses=1 type=i29] [debug line = 61:10@77:7@130:4]
  %tmp.8.i = mul i29 %coeff.cast.i, %tmp.72.cast.i, !dbg !3032 ; [#uses=1 type=i29] [debug line = 61:10@77:7@130:4]
  %dct_coeff_table.1.addr = getelementptr [8 x i15]* @dct_coeff_table.1, i64 0, i64 %tmp.i, !dbg !3029 ; [#uses=1 type=i15*] [debug line = 60:48@77:7@130:4]
  %dct_coeff_table.1.load = load i15* %dct_coeff_table.1.addr, align 2, !dbg !3029 ; [#uses=1 type=i15] [debug line = 60:48@77:7@130:4]
  %coeff.1.cast.i = sext i15 %dct_coeff_table.1.load to i29 ; [#uses=1 type=i29]
  %"buf_2d_in[1].addr" = getelementptr [8 x i16]* %"buf_2d_in[1]", i64 0, i64 %tmp.7.cast.i ; [#uses=1 type=i16*]
  %"buf_2d_in[1].load" = load i16* %"buf_2d_in[1].addr", align 2 ; [#uses=1 type=i16]
  %tmp.72.1.cast.i = sext i16 %"buf_2d_in[1].load" to i29, !dbg !3032 ; [#uses=1 type=i29] [debug line = 61:10@77:7@130:4]
  %tmp.8.1.i = mul i29 %coeff.1.cast.i, %tmp.72.1.cast.i, !dbg !3032 ; [#uses=1 type=i29] [debug line = 61:10@77:7@130:4]
  %dct_coeff_table.2.addr = getelementptr [8 x i15]* @dct_coeff_table.2, i64 0, i64 %tmp.i, !dbg !3029 ; [#uses=1 type=i15*] [debug line = 60:48@77:7@130:4]
  %dct_coeff_table.2.load = load i15* %dct_coeff_table.2.addr, align 2, !dbg !3029 ; [#uses=1 type=i15] [debug line = 60:48@77:7@130:4]
  %coeff.2.cast.i = sext i15 %dct_coeff_table.2.load to i29 ; [#uses=1 type=i29]
  %"buf_2d_in[2].addr" = getelementptr [8 x i16]* %"buf_2d_in[2]", i64 0, i64 %tmp.7.cast.i ; [#uses=1 type=i16*]
  %"buf_2d_in[2].load" = load i16* %"buf_2d_in[2].addr", align 2 ; [#uses=1 type=i16]
  %tmp.72.2.cast.i = sext i16 %"buf_2d_in[2].load" to i29, !dbg !3032 ; [#uses=1 type=i29] [debug line = 61:10@77:7@130:4]
  %tmp.8.2.i = mul i29 %coeff.2.cast.i, %tmp.72.2.cast.i, !dbg !3032 ; [#uses=1 type=i29] [debug line = 61:10@77:7@130:4]
  %dct_coeff_table.3.addr = getelementptr [8 x i15]* @dct_coeff_table.3, i64 0, i64 %tmp.i, !dbg !3029 ; [#uses=1 type=i15*] [debug line = 60:48@77:7@130:4]
  %dct_coeff_table.3.load = load i15* %dct_coeff_table.3.addr, align 2, !dbg !3029 ; [#uses=1 type=i15] [debug line = 60:48@77:7@130:4]
  %coeff.3.cast.i = sext i15 %dct_coeff_table.3.load to i29 ; [#uses=1 type=i29]
  %"buf_2d_in[3].addr" = getelementptr [8 x i16]* %"buf_2d_in[3]", i64 0, i64 %tmp.7.cast.i ; [#uses=1 type=i16*]
  %"buf_2d_in[3].load" = load i16* %"buf_2d_in[3].addr", align 2 ; [#uses=1 type=i16]
  %tmp.72.3.cast.i = sext i16 %"buf_2d_in[3].load" to i29, !dbg !3032 ; [#uses=1 type=i29] [debug line = 61:10@77:7@130:4]
  %tmp.8.3.i = mul i29 %coeff.3.cast.i, %tmp.72.3.cast.i, !dbg !3032 ; [#uses=1 type=i29] [debug line = 61:10@77:7@130:4]
  %dct_coeff_table.4.addr = getelementptr [8 x i15]* @dct_coeff_table.4, i64 0, i64 %tmp.i, !dbg !3029 ; [#uses=1 type=i15*] [debug line = 60:48@77:7@130:4]
  %dct_coeff_table.4.load = load i15* %dct_coeff_table.4.addr, align 2, !dbg !3029 ; [#uses=1 type=i15] [debug line = 60:48@77:7@130:4]
  %coeff.4.cast.i = sext i15 %dct_coeff_table.4.load to i29 ; [#uses=1 type=i29]
  %"buf_2d_in[4].addr" = getelementptr [8 x i16]* %"buf_2d_in[4]", i64 0, i64 %tmp.7.cast.i ; [#uses=1 type=i16*]
  %"buf_2d_in[4].load" = load i16* %"buf_2d_in[4].addr", align 2 ; [#uses=1 type=i16]
  %tmp.72.4.cast.i = sext i16 %"buf_2d_in[4].load" to i29, !dbg !3032 ; [#uses=1 type=i29] [debug line = 61:10@77:7@130:4]
  %tmp.8.4.i = mul i29 %coeff.4.cast.i, %tmp.72.4.cast.i, !dbg !3032 ; [#uses=1 type=i29] [debug line = 61:10@77:7@130:4]
  %dct_coeff_table.5.addr = getelementptr [8 x i15]* @dct_coeff_table.5, i64 0, i64 %tmp.i, !dbg !3029 ; [#uses=1 type=i15*] [debug line = 60:48@77:7@130:4]
  %dct_coeff_table.5.load = load i15* %dct_coeff_table.5.addr, align 2, !dbg !3029 ; [#uses=1 type=i15] [debug line = 60:48@77:7@130:4]
  %coeff.5.cast.i = sext i15 %dct_coeff_table.5.load to i29 ; [#uses=1 type=i29]
  %"buf_2d_in[5].addr" = getelementptr [8 x i16]* %"buf_2d_in[5]", i64 0, i64 %tmp.7.cast.i ; [#uses=1 type=i16*]
  %"buf_2d_in[5].load" = load i16* %"buf_2d_in[5].addr", align 2 ; [#uses=1 type=i16]
  %tmp.72.5.cast.i = sext i16 %"buf_2d_in[5].load" to i29, !dbg !3032 ; [#uses=1 type=i29] [debug line = 61:10@77:7@130:4]
  %tmp.8.5.i = mul i29 %coeff.5.cast.i, %tmp.72.5.cast.i, !dbg !3032 ; [#uses=1 type=i29] [debug line = 61:10@77:7@130:4]
  %dct_coeff_table.6.addr = getelementptr [8 x i15]* @dct_coeff_table.6, i64 0, i64 %tmp.i, !dbg !3029 ; [#uses=1 type=i15*] [debug line = 60:48@77:7@130:4]
  %dct_coeff_table.6.load = load i15* %dct_coeff_table.6.addr, align 2, !dbg !3029 ; [#uses=1 type=i15] [debug line = 60:48@77:7@130:4]
  %coeff.6.cast.i = sext i15 %dct_coeff_table.6.load to i29 ; [#uses=1 type=i29]
  %"buf_2d_in[6].addr" = getelementptr [8 x i16]* %"buf_2d_in[6]", i64 0, i64 %tmp.7.cast.i ; [#uses=1 type=i16*]
  %"buf_2d_in[6].load" = load i16* %"buf_2d_in[6].addr", align 2 ; [#uses=1 type=i16]
  %tmp.72.6.cast.i = sext i16 %"buf_2d_in[6].load" to i29, !dbg !3032 ; [#uses=1 type=i29] [debug line = 61:10@77:7@130:4]
  %tmp.8.6.i = mul i29 %coeff.6.cast.i, %tmp.72.6.cast.i, !dbg !3032 ; [#uses=1 type=i29] [debug line = 61:10@77:7@130:4]
  %dct_coeff_table.7.addr = getelementptr [8 x i15]* @dct_coeff_table.7, i64 0, i64 %tmp.i, !dbg !3029 ; [#uses=1 type=i15*] [debug line = 60:48@77:7@130:4]
  %dct_coeff_table.7.load = load i15* %dct_coeff_table.7.addr, align 2, !dbg !3029 ; [#uses=1 type=i15] [debug line = 60:48@77:7@130:4]
  %coeff.7.cast.i = sext i15 %dct_coeff_table.7.load to i29 ; [#uses=1 type=i29]
  %"buf_2d_in[7].addr" = getelementptr [8 x i16]* %"buf_2d_in[7]", i64 0, i64 %tmp.7.cast.i ; [#uses=1 type=i16*]
  %"buf_2d_in[7].load" = load i16* %"buf_2d_in[7].addr", align 2 ; [#uses=1 type=i16]
  %tmp.72.7.cast.i = sext i16 %"buf_2d_in[7].load" to i29, !dbg !3032 ; [#uses=1 type=i29] [debug line = 61:10@77:7@130:4]
  %tmp.8.7.i = mul i29 %coeff.7.cast.i, %tmp.72.7.cast.i, !dbg !3032 ; [#uses=1 type=i29] [debug line = 61:10@77:7@130:4]
  %tmp1 = add i29 %tmp.8.1.i, %tmp.8.i, !dbg !3033 ; [#uses=1 type=i29] [debug line = 63:7@77:7@130:4]
  %tmp2 = add i29 %tmp.8.3.i, %tmp.8.2.i, !dbg !3033 ; [#uses=1 type=i29] [debug line = 63:7@77:7@130:4]
  %tmp = add i29 %tmp1, %tmp2, !dbg !3033         ; [#uses=1 type=i29] [debug line = 63:7@77:7@130:4]
  %tmp4 = add i29 %tmp.8.5.i, %tmp.8.4.i, !dbg !3033 ; [#uses=1 type=i29] [debug line = 63:7@77:7@130:4]
  %tmp6 = add i29 %tmp.8.7.i, 4096, !dbg !3033    ; [#uses=1 type=i29] [debug line = 63:7@77:7@130:4]
  %tmp5 = add i29 %tmp.8.6.i, %tmp6, !dbg !3033   ; [#uses=1 type=i29] [debug line = 63:7@77:7@130:4]
  %tmp3 = add i29 %tmp4, %tmp5, !dbg !3033        ; [#uses=1 type=i29] [debug line = 63:7@77:7@130:4]
  %tmp.2.i = add i29 %tmp, %tmp3, !dbg !3033      ; [#uses=1 type=i29] [debug line = 63:7@77:7@130:4]
  %tmp.3.i = lshr i29 %tmp.2.i, 13, !dbg !3033    ; [#uses=1 type=i29] [debug line = 63:7@77:7@130:4]
  %tmp.4.i = trunc i29 %tmp.3.i to i16, !dbg !3033 ; [#uses=1 type=i16] [debug line = 63:7@77:7@130:4]
  %row_outbuf.i.addr = getelementptr [8 x [8 x i16]]* %row_outbuf.i, i64 0, i64 %tmp.71.cast.i, i64 %tmp.i, !dbg !3033 ; [#uses=1 type=i16*] [debug line = 63:7@77:7@130:4]
  store i16 %tmp.4.i, i16* %row_outbuf.i.addr, align 2, !dbg !3033 ; [debug line = 63:7@77:7@130:4]
  %6 = call i32 (...)* @_ssdm_op_SpecRegionEnd([15 x i8]* @.str, i32 %tmp..i) nounwind, !dbg !3034 ; [#uses=0 type=i32] [debug line = 64:4@77:7@130:4]
  %k = add i4 %k.i, 1, !dbg !3035                 ; [#uses=1 type=i4] [debug line = 57:61@77:7@130:4]
  call void @llvm.dbg.value(metadata !{i4 %k}, i64 0, metadata !3036) nounwind, !dbg !3035 ; [debug line = 57:61@77:7@130:4] [debug variable = k]
  br label %3, !dbg !3035                         ; [debug line = 57:61@77:7@130:4]

dct_1d.exit:                                      ; preds = %3
  %i = add i4 %i.0.i, 1, !dbg !3037               ; [#uses=1 type=i4] [debug line = 76:60@130:4]
  call void @llvm.dbg.value(metadata !{i4 %i}, i64 0, metadata !3038) nounwind, !dbg !3037 ; [debug line = 76:60@130:4] [debug variable = i]
  br label %0, !dbg !3037                         ; [debug line = 76:60@130:4]
}
...
.preheader7.i:                                    ; preds = %1, %newFuncRoot
  ...
  %exitcond4.i = icmp eq i4 %j.0.i, -8, !dbg !3039 ; [#uses=1 type=i1] [debug line = 81:9@130:4]
  %0 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) nounwind ; [#uses=0 type=i32]
  br i1 %exitcond4.i, label %.preheader6.i.exitStub, label %5, !dbg !3039 ; [debug line = 81:9@130:4]

; <label>:1                                       ; preds = %3
  %2 = call i32 (...)* @_ssdm_op_SpecRegionEnd([21 x i8]* @.str5, i32 %tmp.2) nounwind, !dbg !3041 ; [#uses=0 type=i32] [debug line = 84:34@130:4]
  %j = add i4 %j.0.i, 1, !dbg !3044               ; [#uses=1 type=i4] [debug line = 81:61@130:4]
  call void @llvm.dbg.value(metadata !{i4 %j}, i64 0, metadata !3045) nounwind, !dbg !3044 ; [debug line = 81:61@130:4] [debug variable = j]
  br label %.preheader7.i, !dbg !3044             ; [debug line = 81:61@130:4]

; <label>:3                                       ; preds = %6, %5
  %i.1.i = phi i4 [ 0, %5 ], [ %i, %6 ]           ; [#uses=4 type=i4]
  %exitcond3.i = icmp eq i4 %i.1.i, -8, !dbg !3046 ; [#uses=1 type=i1] [debug line = 83:11@130:4]
  %4 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) nounwind ; [#uses=0 type=i32]
  br i1 %exitcond3.i, label %1, label %8, !dbg !3046 ; [debug line = 83:11@130:4]

; <label>:5                                       ; preds = %.preheader7.i
  call void (...)* @_ssdm_op_SpecLoopName([21 x i8]* @.str5) nounwind, !dbg !3047 ; [debug line = 82:1@130:4]
  %tmp.2 = call i32 (...)* @_ssdm_op_SpecRegionBegin([21 x i8]* @.str5) nounwind, !dbg !3047 ; [#uses=1 type=i32] [debug line = 82:1@130:4]
  %tmp. = zext i4 %j.0.i to i64, !dbg !3048       ; [#uses=9 type=i64] [debug line = 84:1@130:4]
  br label %3, !dbg !3046                         ; [debug line = 83:11@130:4]

; <label>:6                                       ; preds = %branch7, %branch6, %branch5, %branch4, %branch3, %branch2, %branch1, %branch0
  %7 = call i32 (...)* @_ssdm_op_SpecRegionEnd([21 x i8]* @.str6, i32 %tmp.5) nounwind, !dbg !3050 ; [#uses=0 type=i32] [debug line = 84:34@130:4]
  %i = add i4 %i.1.i, 1, !dbg !3051               ; [#uses=1 type=i4] [debug line = 83:63@130:4]
  call void @llvm.dbg.value(metadata !{i4 %i}, i64 0, metadata !3038) nounwind, !dbg !3051 ; [debug line = 83:63@130:4] [debug variable = i]
  br label %3, !dbg !3051                         ; [debug line = 83:63@130:4]

branch0:                                          ; preds = %8
  store i16 %row_outbuf.i.load, i16* %"col_inbuf[0].addr", align 2, !dbg !3048 ; [debug line = 84:1@130:4]
  br label %6, !dbg !3048                         ; [debug line = 84:1@130:4]

; <label>:8                                       ; preds = %3
  call void (...)* @_ssdm_op_SpecLoopName([21 x i8]* @.str6) nounwind, !dbg !3052 ; [debug line = 84:2@130:4]
  %tmp.5 = call i32 (...)* @_ssdm_op_SpecRegionBegin([21 x i8]* @.str6) nounwind, !dbg !3052 ; [#uses=1 type=i32] [debug line = 84:2@130:4]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, [1 x i8]* @.str1) nounwind, !dbg !3053 ; [debug line = 85:1@130:4]
  %tmp.8 = zext i4 %i.1.i to i64, !dbg !3048      ; [#uses=1 type=i64] [debug line = 84:1@130:4]
  %row_outbuf.i.addr = getelementptr inbounds [8 x [8 x i16]]* %row_outbuf.i, i64 0, i64 %tmp.8, i64 %tmp., !dbg !3048 ; [#uses=1 type=i16*] [debug line = 84:1@130:4]
  %row_outbuf.i.load = load i16* %row_outbuf.i.addr, align 2, !dbg !3048 ; [#uses=8 type=i16] [debug line = 84:1@130:4]
  %"col_inbuf[0].addr" = getelementptr [8 x i16]* %"col_inbuf[0]", i64 0, i64 %tmp., !dbg !3048 ; [#uses=1 type=i16*] [debug line = 84:1@130:4]
  %"col_inbuf[1].addr" = getelementptr [8 x i16]* %"col_inbuf[1]", i64 0, i64 %tmp., !dbg !3048 ; [#uses=1 type=i16*] [debug line = 84:1@130:4]
  %"col_inbuf[2].addr" = getelementptr [8 x i16]* %"col_inbuf[2]", i64 0, i64 %tmp., !dbg !3048 ; [#uses=1 type=i16*] [debug line = 84:1@130:4]
  %"col_inbuf[3].addr" = getelementptr [8 x i16]* %"col_inbuf[3]", i64 0, i64 %tmp., !dbg !3048 ; [#uses=1 type=i16*] [debug line = 84:1@130:4]
  %"col_inbuf[4].addr" = getelementptr [8 x i16]* %"col_inbuf[4]", i64 0, i64 %tmp., !dbg !3048 ; [#uses=1 type=i16*] [debug line = 84:1@130:4]
  %"col_inbuf[5].addr" = getelementptr [8 x i16]* %"col_inbuf[5]", i64 0, i64 %tmp., !dbg !3048 ; [#uses=1 type=i16*] [debug line = 84:1@130:4]
  %"col_inbuf[6].addr" = getelementptr [8 x i16]* %"col_inbuf[6]", i64 0, i64 %tmp., !dbg !3048 ; [#uses=1 type=i16*] [debug line = 84:1@130:4]
  %"col_inbuf[7].addr" = getelementptr [8 x i16]* %"col_inbuf[7]", i64 0, i64 %tmp., !dbg !3048 ; [#uses=1 type=i16*] [debug line = 84:1@130:4]
  ...
  switch i3 %i.1.i.t, label %branch7 [
    ...
    i3 -3, label %branch5
    i3 -2, label %branch6
  ], !dbg !3048                                   ; [debug line = 84:1@130:4]

branch1:                                          ; preds = %8
  store i16 %row_outbuf.i.load, i16* %"col_inbuf[1].addr", align 2, !dbg !3048 ; [debug line = 84:1@130:4]
  br label %6, !dbg !3048                         ; [debug line = 84:1@130:4]

branch2:                                          ; preds = %8
  store i16 %row_outbuf.i.load, i16* %"col_inbuf[2].addr", align 2, !dbg !3048 ; [debug line = 84:1@130:4]
  br label %6, !dbg !3048                         ; [debug line = 84:1@130:4]

branch3:                                          ; preds = %8
  store i16 %row_outbuf.i.load, i16* %"col_inbuf[3].addr", align 2, !dbg !3048 ; [debug line = 84:1@130:4]
  br label %6, !dbg !3048                         ; [debug line = 84:1@130:4]

branch4:                                          ; preds = %8
  store i16 %row_outbuf.i.load, i16* %"col_inbuf[4].addr", align 2, !dbg !3048 ; [debug line = 84:1@130:4]
  br label %6, !dbg !3048                         ; [debug line = 84:1@130:4]

branch5:                                          ; preds = %8
  store i16 %row_outbuf.i.load, i16* %"col_inbuf[5].addr", align 2, !dbg !3048 ; [debug line = 84:1@130:4]
  br label %6, !dbg !3048                         ; [debug line = 84:1@130:4]

branch6:                                          ; preds = %8
  store i16 %row_outbuf.i.load, i16* %"col_inbuf[6].addr", align 2, !dbg !3048 ; [debug line = 84:1@130:4]
  br label %6, !dbg !3048                         ; [debug line = 84:1@130:4]

branch7:                                          ; preds = %8
  store i16 %row_outbuf.i.load, i16* %"col_inbuf[7].addr", align 2, !dbg !3048 ; [debug line = 84:1@130:4]
  br label %6, !dbg !3048                         ; [debug line = 84:1@130:4]
}
...
.preheader6.i:                                    ; preds = %dct_1d.exit, %newFuncRoot
  ...
  %exitcond2.i = icmp eq i4 %i.2.i, -8, !dbg !3054 ; [#uses=1 type=i1] [debug line = 87:9@130:4]
  %0 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) nounwind ; [#uses=0 type=i32]
  br i1 %exitcond2.i, label %.preheader.i.exitStub, label %1, !dbg !3054 ; [debug line = 87:9@130:4]

; <label>:1                                       ; preds = %.preheader6.i
  call void (...)* @_ssdm_op_SpecLoopName([13 x i8]* @.str7) nounwind, !dbg !3056 ; [debug line = 87:67@130:4]
  call void (...)* @_ssdm_SpecKeepAssert(i4 %i.2.i) nounwind, !hlsrange !3018
  call void (...)* @_ssdm_SpecKeepAssert(i4 %i.2.i) nounwind, !hlsrange !3018
  %tmp.71.cast.i = zext i4 %i.2.i to i64          ; [#uses=1 type=i64]
  %tmp.7.cast.i = zext i4 %i.2.i to i64           ; [#uses=8 type=i64]
  call void @llvm.dbg.value(metadata !{[8 x [8 x i16]]* %col_outbuf.i}, i64 0, metadata !3058) nounwind, !dbg !3060 ; [debug line = 48:81@88:7@130:4] [debug variable = dst]
  br label %2, !dbg !3061                         ; [debug line = 57:9@88:7@130:4]

; <label>:2                                       ; preds = %4, %1
  %k.i = phi i4 [ 0, %1 ], [ %k, %4 ]             ; [#uses=3 type=i4]
  %exitcond1.i = icmp eq i4 %k.i, -8, !dbg !3061  ; [#uses=1 type=i1] [debug line = 57:9@88:7@130:4]
  %3 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) nounwind ; [#uses=0 type=i32]
  br i1 %exitcond1.i, label %dct_1d.exit, label %4, !dbg !3061 ; [debug line = 57:9@88:7@130:4]

; <label>:4                                       ; preds = %2
  call void (...)* @_ssdm_op_SpecLoopName([15 x i8]* @.str) nounwind, !dbg !3062 ; [debug line = 57:67@88:7@130:4]
  %tmp..i = call i32 (...)* @_ssdm_op_SpecRegionBegin([15 x i8]* @.str) nounwind, !dbg !3062 ; [#uses=1 type=i32] [debug line = 57:67@88:7@130:4]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, [1 x i8]* @.str1) nounwind, !dbg !3063 ; [debug line = 58:1@88:7@130:4]
  %tmp.i = zext i4 %k.i to i64, !dbg !3064        ; [#uses=9 type=i64] [debug line = 60:48@88:7@130:4]
  %dct_coeff_table.0.addr = getelementptr [8 x i14]* @dct_coeff_table.0, i64 0, i64 %tmp.i, !dbg !3064 ; [#uses=1 type=i14*] [debug line = 60:48@88:7@130:4]
  %dct_coeff_table.0.load = load i14* %dct_coeff_table.0.addr, align 2, !dbg !3064 ; [#uses=1 type=i14] [debug line = 60:48@88:7@130:4]
  %coeff.cast.i = zext i14 %dct_coeff_table.0.load to i29 ; [#uses=1 type=i29]
  %"col_inbuf[0].addr" = getelementptr [8 x i16]* %"col_inbuf[0]", i64 0, i64 %tmp.7.cast.i ; [#uses=1 type=i16*]
  %"col_inbuf[0].load" = load i16* %"col_inbuf[0].addr", align 2 ; [#uses=1 type=i16]
  %tmp.72.cast.i = sext i16 %"col_inbuf[0].load" to i29, !dbg !3065 ; [#uses=1 type=i29] [debug line = 61:10@88:7@130:4]
  %tmp.8.i = mul i29 %coeff.cast.i, %tmp.72.cast.i, !dbg !3065 ; [#uses=1 type=i29] [debug line = 61:10@88:7@130:4]
  %dct_coeff_table.1.addr = getelementptr [8 x i15]* @dct_coeff_table.1, i64 0, i64 %tmp.i, !dbg !3064 ; [#uses=1 type=i15*] [debug line = 60:48@88:7@130:4]
  %dct_coeff_table.1.load = load i15* %dct_coeff_table.1.addr, align 2, !dbg !3064 ; [#uses=1 type=i15] [debug line = 60:48@88:7@130:4]
  %coeff.1.cast.i = sext i15 %dct_coeff_table.1.load to i29 ; [#uses=1 type=i29]
  %"col_inbuf[1].addr" = getelementptr [8 x i16]* %"col_inbuf[1]", i64 0, i64 %tmp.7.cast.i ; [#uses=1 type=i16*]
  %"col_inbuf[1].load" = load i16* %"col_inbuf[1].addr", align 2 ; [#uses=1 type=i16]
  %tmp.72.1.cast.i = sext i16 %"col_inbuf[1].load" to i29, !dbg !3065 ; [#uses=1 type=i29] [debug line = 61:10@88:7@130:4]
  %tmp.8.1.i = mul i29 %coeff.1.cast.i, %tmp.72.1.cast.i, !dbg !3065 ; [#uses=1 type=i29] [debug line = 61:10@88:7@130:4]
  %dct_coeff_table.2.addr = getelementptr [8 x i15]* @dct_coeff_table.2, i64 0, i64 %tmp.i, !dbg !3064 ; [#uses=1 type=i15*] [debug line = 60:48@88:7@130:4]
  %dct_coeff_table.2.load = load i15* %dct_coeff_table.2.addr, align 2, !dbg !3064 ; [#uses=1 type=i15] [debug line = 60:48@88:7@130:4]
  %coeff.2.cast.i = sext i15 %dct_coeff_table.2.load to i29 ; [#uses=1 type=i29]
  %"col_inbuf[2].addr" = getelementptr [8 x i16]* %"col_inbuf[2]", i64 0, i64 %tmp.7.cast.i ; [#uses=1 type=i16*]
  %"col_inbuf[2].load" = load i16* %"col_inbuf[2].addr", align 2 ; [#uses=1 type=i16]
  %tmp.72.2.cast.i = sext i16 %"col_inbuf[2].load" to i29, !dbg !3065 ; [#uses=1 type=i29] [debug line = 61:10@88:7@130:4]
  %tmp.8.2.i = mul i29 %coeff.2.cast.i, %tmp.72.2.cast.i, !dbg !3065 ; [#uses=1 type=i29] [debug line = 61:10@88:7@130:4]
  %dct_coeff_table.3.addr = getelementptr [8 x i15]* @dct_coeff_table.3, i64 0, i64 %tmp.i, !dbg !3064 ; [#uses=1 type=i15*] [debug line = 60:48@88:7@130:4]
  %dct_coeff_table.3.load = load i15* %dct_coeff_table.3.addr, align 2, !dbg !3064 ; [#uses=1 type=i15] [debug line = 60:48@88:7@130:4]
  %coeff.3.cast.i = sext i15 %dct_coeff_table.3.load to i29 ; [#uses=1 type=i29]
  %"col_inbuf[3].addr" = getelementptr [8 x i16]* %"col_inbuf[3]", i64 0, i64 %tmp.7.cast.i ; [#uses=1 type=i16*]
  %"col_inbuf[3].load" = load i16* %"col_inbuf[3].addr", align 2 ; [#uses=1 type=i16]
  %tmp.72.3.cast.i = sext i16 %"col_inbuf[3].load" to i29, !dbg !3065 ; [#uses=1 type=i29] [debug line = 61:10@88:7@130:4]
  %tmp.8.3.i = mul i29 %coeff.3.cast.i, %tmp.72.3.cast.i, !dbg !3065 ; [#uses=1 type=i29] [debug line = 61:10@88:7@130:4]
  %dct_coeff_table.4.addr = getelementptr [8 x i15]* @dct_coeff_table.4, i64 0, i64 %tmp.i, !dbg !3064 ; [#uses=1 type=i15*] [debug line = 60:48@88:7@130:4]
  %dct_coeff_table.4.load = load i15* %dct_coeff_table.4.addr, align 2, !dbg !3064 ; [#uses=1 type=i15] [debug line = 60:48@88:7@130:4]
  %coeff.4.cast.i = sext i15 %dct_coeff_table.4.load to i29 ; [#uses=1 type=i29]
  %"col_inbuf[4].addr" = getelementptr [8 x i16]* %"col_inbuf[4]", i64 0, i64 %tmp.7.cast.i ; [#uses=1 type=i16*]
  %"col_inbuf[4].load" = load i16* %"col_inbuf[4].addr", align 2 ; [#uses=1 type=i16]
  %tmp.72.4.cast.i = sext i16 %"col_inbuf[4].load" to i29, !dbg !3065 ; [#uses=1 type=i29] [debug line = 61:10@88:7@130:4]
  %tmp.8.4.i = mul i29 %coeff.4.cast.i, %tmp.72.4.cast.i, !dbg !3065 ; [#uses=1 type=i29] [debug line = 61:10@88:7@130:4]
  %dct_coeff_table.5.addr = getelementptr [8 x i15]* @dct_coeff_table.5, i64 0, i64 %tmp.i, !dbg !3064 ; [#uses=1 type=i15*] [debug line = 60:48@88:7@130:4]
  %dct_coeff_table.5.load = load i15* %dct_coeff_table.5.addr, align 2, !dbg !3064 ; [#uses=1 type=i15] [debug line = 60:48@88:7@130:4]
  %coeff.5.cast.i = sext i15 %dct_coeff_table.5.load to i29 ; [#uses=1 type=i29]
  %"col_inbuf[5].addr" = getelementptr [8 x i16]* %"col_inbuf[5]", i64 0, i64 %tmp.7.cast.i ; [#uses=1 type=i16*]
  %"col_inbuf[5].load" = load i16* %"col_inbuf[5].addr", align 2 ; [#uses=1 type=i16]
  %tmp.72.5.cast.i = sext i16 %"col_inbuf[5].load" to i29, !dbg !3065 ; [#uses=1 type=i29] [debug line = 61:10@88:7@130:4]
  %tmp.8.5.i = mul i29 %coeff.5.cast.i, %tmp.72.5.cast.i, !dbg !3065 ; [#uses=1 type=i29] [debug line = 61:10@88:7@130:4]
  %dct_coeff_table.6.addr = getelementptr [8 x i15]* @dct_coeff_table.6, i64 0, i64 %tmp.i, !dbg !3064 ; [#uses=1 type=i15*] [debug line = 60:48@88:7@130:4]
  %dct_coeff_table.6.load = load i15* %dct_coeff_table.6.addr, align 2, !dbg !3064 ; [#uses=1 type=i15] [debug line = 60:48@88:7@130:4]
  %coeff.6.cast.i = sext i15 %dct_coeff_table.6.load to i29 ; [#uses=1 type=i29]
  %"col_inbuf[6].addr" = getelementptr [8 x i16]* %"col_inbuf[6]", i64 0, i64 %tmp.7.cast.i ; [#uses=1 type=i16*]
  %"col_inbuf[6].load" = load i16* %"col_inbuf[6].addr", align 2 ; [#uses=1 type=i16]
  %tmp.72.6.cast.i = sext i16 %"col_inbuf[6].load" to i29, !dbg !3065 ; [#uses=1 type=i29] [debug line = 61:10@88:7@130:4]
  %tmp.8.6.i = mul i29 %coeff.6.cast.i, %tmp.72.6.cast.i, !dbg !3065 ; [#uses=1 type=i29] [debug line = 61:10@88:7@130:4]
  %dct_coeff_table.7.addr = getelementptr [8 x i15]* @dct_coeff_table.7, i64 0, i64 %tmp.i, !dbg !3064 ; [#uses=1 type=i15*] [debug line = 60:48@88:7@130:4]
  %dct_coeff_table.7.load = load i15* %dct_coeff_table.7.addr, align 2, !dbg !3064 ; [#uses=1 type=i15] [debug line = 60:48@88:7@130:4]
  %coeff.7.cast.i = sext i15 %dct_coeff_table.7.load to i29 ; [#uses=1 type=i29]
  %"col_inbuf[7].addr" = getelementptr [8 x i16]* %"col_inbuf[7]", i64 0, i64 %tmp.7.cast.i ; [#uses=1 type=i16*]
  %"col_inbuf[7].load" = load i16* %"col_inbuf[7].addr", align 2 ; [#uses=1 type=i16]
  %tmp.72.7.cast.i = sext i16 %"col_inbuf[7].load" to i29, !dbg !3065 ; [#uses=1 type=i29] [debug line = 61:10@88:7@130:4]
  %tmp.8.7.i = mul i29 %coeff.7.cast.i, %tmp.72.7.cast.i, !dbg !3065 ; [#uses=1 type=i29] [debug line = 61:10@88:7@130:4]
  %tmp1 = add i29 %tmp.8.1.i, %tmp.8.i, !dbg !3066 ; [#uses=1 type=i29] [debug line = 63:7@88:7@130:4]
  %tmp2 = add i29 %tmp.8.3.i, %tmp.8.2.i, !dbg !3066 ; [#uses=1 type=i29] [debug line = 63:7@88:7@130:4]
  %tmp = add i29 %tmp1, %tmp2, !dbg !3066         ; [#uses=1 type=i29] [debug line = 63:7@88:7@130:4]
  %tmp4 = add i29 %tmp.8.5.i, %tmp.8.4.i, !dbg !3066 ; [#uses=1 type=i29] [debug line = 63:7@88:7@130:4]
  %tmp6 = add i29 %tmp.8.7.i, 4096, !dbg !3066    ; [#uses=1 type=i29] [debug line = 63:7@88:7@130:4]
  %tmp5 = add i29 %tmp.8.6.i, %tmp6, !dbg !3066   ; [#uses=1 type=i29] [debug line = 63:7@88:7@130:4]
  %tmp3 = add i29 %tmp4, %tmp5, !dbg !3066        ; [#uses=1 type=i29] [debug line = 63:7@88:7@130:4]
  %tmp.2.i = add i29 %tmp, %tmp3, !dbg !3066      ; [#uses=1 type=i29] [debug line = 63:7@88:7@130:4]
  %tmp.3.i = lshr i29 %tmp.2.i, 13, !dbg !3066    ; [#uses=1 type=i29] [debug line = 63:7@88:7@130:4]
  %tmp.4.i = trunc i29 %tmp.3.i to i16, !dbg !3066 ; [#uses=1 type=i16] [debug line = 63:7@88:7@130:4]
  %col_outbuf.i.addr = getelementptr [8 x [8 x i16]]* %col_outbuf.i, i64 0, i64 %tmp.71.cast.i, i64 %tmp.i, !dbg !3066 ; [#uses=1 type=i16*] [debug line = 63:7@88:7@130:4]
  store i16 %tmp.4.i, i16* %col_outbuf.i.addr, align 2, !dbg !3066 ; [debug line = 63:7@88:7@130:4]
  %5 = call i32 (...)* @_ssdm_op_SpecRegionEnd([15 x i8]* @.str, i32 %tmp..i) nounwind, !dbg !3067 ; [#uses=0 type=i32] [debug line = 64:4@88:7@130:4]
  %k = add i4 %k.i, 1, !dbg !3068                 ; [#uses=1 type=i4] [debug line = 57:61@88:7@130:4]
  call void @llvm.dbg.value(metadata !{i4 %k}, i64 0, metadata !3069) nounwind, !dbg !3068 ; [debug line = 57:61@88:7@130:4] [debug variable = k]
  br label %2, !dbg !3068                         ; [debug line = 57:61@88:7@130:4]

dct_1d.exit:                                      ; preds = %2
  %i = add i4 %i.2.i, 1, !dbg !3070               ; [#uses=1 type=i4] [debug line = 87:61@130:4]
  call void @llvm.dbg.value(metadata !{i4 %i}, i64 0, metadata !3038) nounwind, !dbg !3070 ; [debug line = 87:61@130:4] [debug variable = i]
  br label %.preheader6.i, !dbg !3070             ; [debug line = 87:61@130:4]
}
...
.preheader.i:                                     ; preds = %1, %newFuncRoot
  ...
  %exitcond1.i = icmp eq i4 %j.1.i, -8, !dbg !3071 ; [#uses=1 type=i1] [debug line = 92:9@130:4]
  %0 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) nounwind ; [#uses=0 type=i32]
  br i1 %exitcond1.i, label %dct_2d.exit.exitStub, label %5, !dbg !3071 ; [debug line = 92:9@130:4]

; <label>:1                                       ; preds = %3
  %2 = call i32 (...)* @_ssdm_op_SpecRegionEnd([21 x i8]* @.str8, i32 %tmp.4) nounwind, !dbg !3073 ; [#uses=0 type=i32] [debug line = 95:34@130:4]
  %j = add i4 %j.1.i, 1, !dbg !3076               ; [#uses=1 type=i4] [debug line = 92:61@130:4]
  call void @llvm.dbg.value(metadata !{i4 %j}, i64 0, metadata !3045) nounwind, !dbg !3076 ; [debug line = 92:61@130:4] [debug variable = j]
  br label %.preheader.i, !dbg !3076              ; [debug line = 92:61@130:4]

; <label>:3                                       ; preds = %6, %5
  %i.3.i = phi i4 [ 0, %5 ], [ %i, %6 ]           ; [#uses=3 type=i4]
  %exitcond.i = icmp eq i4 %i.3.i, -8, !dbg !3077 ; [#uses=1 type=i1] [debug line = 94:11@130:4]
  %4 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) nounwind ; [#uses=0 type=i32]
  br i1 %exitcond.i, label %1, label %6, !dbg !3077 ; [debug line = 94:11@130:4]

; <label>:5                                       ; preds = %.preheader.i
  call void (...)* @_ssdm_op_SpecLoopName([21 x i8]* @.str8) nounwind, !dbg !3078 ; [debug line = 93:1@130:4]
  %tmp.4 = call i32 (...)* @_ssdm_op_SpecRegionBegin([21 x i8]* @.str8) nounwind, !dbg !3078 ; [#uses=1 type=i32] [debug line = 93:1@130:4]
  %tmp.9 = zext i4 %j.1.i to i64, !dbg !3079      ; [#uses=2 type=i64] [debug line = 95:1@130:4]
  br label %3, !dbg !3077                         ; [debug line = 94:11@130:4]

; <label>:6                                       ; preds = %3
  call void (...)* @_ssdm_op_SpecLoopName([21 x i8]* @.str9) nounwind, !dbg !3081 ; [debug line = 95:2@130:4]
  %tmp.6 = call i32 (...)* @_ssdm_op_SpecRegionBegin([21 x i8]* @.str9) nounwind, !dbg !3081 ; [#uses=1 type=i32] [debug line = 95:2@130:4]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, [1 x i8]* @.str1) nounwind, !dbg !3082 ; [debug line = 96:1@130:4]
  %tmp. = zext i4 %i.3.i to i64, !dbg !3079       ; [#uses=2 type=i64] [debug line = 95:1@130:4]
  %col_outbuf.i.addr = getelementptr inbounds [8 x [8 x i16]]* %col_outbuf.i, i64 0, i64 %tmp., i64 %tmp.9, !dbg !3079 ; [#uses=1 type=i16*] [debug line = 95:1@130:4]
  %col_outbuf.i.load = load i16* %col_outbuf.i.addr, align 2, !dbg !3079 ; [#uses=1 type=i16] [debug line = 95:1@130:4]
  %buf_2d_out.addr = getelementptr inbounds [8 x [8 x i16]]* %buf_2d_out, i64 0, i64 %tmp.9, i64 %tmp., !dbg !3079 ; [#uses=1 type=i16*] [debug line = 95:1@130:4]
  store i16 %col_outbuf.i.load, i16* %buf_2d_out.addr, align 2, !dbg !3079 ; [debug line = 95:1@130:4]
  %7 = call i32 (...)* @_ssdm_op_SpecRegionEnd([21 x i8]* @.str9, i32 %tmp.6) nounwind, !dbg !3083 ; [#uses=0 type=i32] [debug line = 95:34@130:4]
  %i = add i4 %i.3.i, 1, !dbg !3084               ; [#uses=1 type=i4] [debug line = 94:63@130:4]
  call void @llvm.dbg.value(metadata !{i4 %i}, i64 0, metadata !3038) nounwind, !dbg !3084 ; [debug line = 94:63@130:4] [debug variable = i]
  br label %3, !dbg !3084                         ; [debug line = 94:63@130:4]
}
...
!1792 = metadata !{i32 786478, i32 0, metadata !1557, metadata !"_M_insert<long long>", metadata !"_M_insert<long long>", metadata !"_ZNSo9_M_insertIxEERSoT_", metadata !1563, i32 365, metadata !1742, i1 false, i1 false, i32 0, i32 0, null, i32 258, i1 false, null, metadata !1793, i32 0, metadata !86, i32 365} ; [ DW_TAG_subprogram ]
!1793 = metadata !{metadata !1794}
!1794 = metadata !{i32 786479, null, metadata !"_ValueT", metadata !61, null, i32 0, i32 0} ; [ DW_TAG_template_type_parameter ]
!1795 = metadata !{i32 786478, i32 0, metadata !1557, metadata !"_M_insert<long double>", metadata !"_M_insert<long double>", metadata !"_ZNSo9_M_insertIeEERSoT_", metadata !1563, i32 365, metadata !1756, i1 false, i1 false, i32 0, i32 0, null, i32 258, i1 false, null, metadata !1796, i32 0, metadata !86, i32 365} ; [ DW_TAG_subprogram ]
!1796 = metadata !{metadata !1797}
!1797 = metadata !{i32 786479, null, metadata !"_ValueT", metadata !1758, null, i32 0, i32 0} ; [ DW_TAG_template_type_parameter ]
...
!1800 = metadata !{i32 786479, null, metadata !"_ValueT", metadata !138, null, i32 0, i32 0} ; [ DW_TAG_template_type_parameter ]
!1801 = metadata !{i32 786478, i32 0, metadata !1557, metadata !"_M_insert<bool>", metadata !"_M_insert<bool>", metadata !"_ZNSo9_M_insertIbEERSoT_", metadata !1563, i32 365, metadata !1727, i1 false, i1 false, i32 0, i32 0, null, i32 258, i1 false, null, metadata !1802, i32 0, metadata !86, i32 365} ; [ DW_TAG_subprogram ]
!1802 = metadata !{metadata !1803}
!1803 = metadata !{i32 786479, null, metadata !"_ValueT", metadata !212, null, i32 0, i32 0} ; [ DW_TAG_template_type_parameter ]
...
!1810 = metadata !{i32 786478, i32 0, metadata !1557, metadata !"_M_insert<const void *>", metadata !"_M_insert<const void *>", metadata !"_ZNSo9_M_insertIPKvEERSoT_", metadata !1563, i32 365, metadata !1760, i1 false, i1 false, i32 0, i32 0, null, i32 258, i1 false, null, metadata !1811, i32 0, metadata !86, i32 365} ; [ DW_TAG_subprogram ]
!1811 = metadata !{metadata !1812}
!1812 = metadata !{i32 786479, null, metadata !"_ValueT", metadata !325, null, i32 0, i32 0} ; [ DW_TAG_template_type_parameter ]
!1813 = metadata !{i32 786478, i32 0, metadata !1557, metadata !"_M_insert<double>", metadata !"_M_insert<double>", metadata !"_ZNSo9_M_insertIdEERSoT_", metadata !1563, i32 365, metadata !1748, i1 false, i1 false, i32 0, i32 0, null, i32 258, i1 false, null, metadata !1814, i32 0, metadata !86, i32 365} ; [ DW_TAG_subprogram ]
!1814 = metadata !{metadata !1815}
!1815 = metadata !{i32 786479, null, metadata !"_ValueT", metadata !1750, null, i32 0, i32 0} ; [ DW_TAG_template_type_parameter ]
...
!2188 = metadata !{i32 786478, i32 0, metadata !1546, metadata !"_M_extract<long long>", metadata !"_M_extract<long long>", metadata !"_ZNSi10_M_extractIxEERSiRT_", metadata !2053, i32 587, metadata !2105, i1 false, i1 false, i32 0, i32 0, null, i32 258, i1 false, null, metadata !1793, i32 0, metadata !86, i32 587} ; [ DW_TAG_subprogram ]
!2189 = metadata !{i32 786478, i32 0, metadata !1546, metadata !"_M_extract<long double>", metadata !"_M_extract<long double>", metadata !"_ZNSi10_M_extractIeEERSiRT_", metadata !2053, i32 587, metadata !2117, i1 false, i1 false, i32 0, i32 0, null, i32 258, i1 false, null, metadata !1796, i32 0, metadata !86, i32 587} ; [ DW_TAG_subprogram ]
!2190 = metadata !{i32 786478, i32 0, metadata !1546, metadata !"_M_extract<unsigned int>", metadata !"_M_extract<unsigned int>", metadata !"_ZNSi10_M_extractIjEERSiRT_", metadata !2053, i32 587, metadata !2096, i1 false, i1 false, i32 0, i32 0, null, i32 258, i1 false, null, metadata !2191, i32 0, metadata !86, i32 587} ; [ DW_TAG_subprogram ]
!2191 = metadata !{metadata !2192}
!2192 = metadata !{i32 786479, null, metadata !"_ValueT", metadata !979, null, i32 0, i32 0} ; [ DW_TAG_template_type_parameter ]
...
!2197 = metadata !{i32 786478, i32 0, metadata !1546, metadata !"_M_extract<bool>", metadata !"_M_extract<bool>", metadata !"_ZNSi10_M_extractIbEERSiRT_", metadata !2053, i32 587, metadata !2083, i1 false, i1 false, i32 0, i32 0, null, i32 258, i1 false, null, metadata !1802, i32 0, metadata !86, i32 587} ; [ DW_TAG_subprogram ]
!2198 = metadata !{i32 786478, i32 0, metadata !1546, metadata !"_M_extract<float>", metadata !"_M_extract<float>", metadata !"_ZNSi10_M_extractIfEERSiRT_", metadata !2053, i32 587, metadata !2111, i1 false, i1 false, i32 0, i32 0, null, i32 258, i1 false, null, metadata !2199, i32 0, metadata !86, i32 587} ; [ DW_TAG_subprogram ]
!2199 = metadata !{metadata !2200}
!2200 = metadata !{i32 786479, null, metadata !"_ValueT", metadata !1754, null, i32 0, i32 0} ; [ DW_TAG_template_type_parameter ]
!2201 = metadata !{i32 786478, i32 0, metadata !1546, metadata !"_M_extract<unsigned long>", metadata !"_M_extract<unsigned long>", metadata !"_ZNSi10_M_extractImEERSiRT_", metadata !2053, i32 587, metadata !2102, i1 false, i1 false, i32 0, i32 0, null, i32 258, i1 false, null, metadata !1805, i32 0, metadata !86, i32 587} ; [ DW_TAG_subprogram ]
!2202 = metadata !{i32 786478, i32 0, metadata !1546, metadata !"_M_extract<long>", metadata !"_M_extract<long>", metadata !"_ZNSi10_M_extractIlEERSiRT_", metadata !2053, i32 587, metadata !2099, i1 false, i1 false, i32 0, i32 0, null, i32 258, i1 false, null, metadata !1808, i32 0, metadata !86, i32 587} ; [ DW_TAG_subprogram ]
!2203 = metadata !{i32 786478, i32 0, metadata !1546, metadata !"_M_extract<void *>", metadata !"_M_extract<void *>", metadata !"_ZNSi10_M_extractIPvEERSiRT_", metadata !2053, i32 587, metadata !2120, i1 false, i1 false, i32 0, i32 0, null, i32 258, i1 false, null, metadata !2204, i32 0, metadata !86, i32 587} ; [ DW_TAG_subprogram ]
!2204 = metadata !{metadata !2205}
!2205 = metadata !{i32 786479, null, metadata !"_ValueT", metadata !98, null, i32 0, i32 0} ; [ DW_TAG_template_type_parameter ]
!2206 = metadata !{i32 786478, i32 0, metadata !1546, metadata !"_M_extract<double>", metadata !"_M_extract<double>", metadata !"_ZNSi10_M_extractIdEERSiRT_", metadata !2053, i32 587, metadata !2114, i1 false, i1 false, i32 0, i32 0, null, i32 258, i1 false, null, metadata !1814, i32 0, metadata !86, i32 587} ; [ DW_TAG_subprogram ]
...
!2912 = metadata !{i32 124, i32 1, metadata !2913, null}
!2913 = metadata !{i32 786443, metadata !896, i32 123, i32 1, metadata !876, i32 28} ; [ DW_TAG_lexical_block ]
!2914 = metadata !{metadata !2915}
!2915 = metadata !{i32 0, i32 15, metadata !2916}
!2916 = metadata !{metadata !2917}
!2917 = metadata !{metadata !"input", metadata !2918, metadata !"short", i32 0, i32 15}
!2918 = metadata !{metadata !2919}
!2919 = metadata !{i32 0, i32 63, i32 1}
!2920 = metadata !{metadata !2921}
!2921 = metadata !{i32 0, i32 15, metadata !2922}
!2922 = metadata !{metadata !2923}
!2923 = metadata !{metadata !"output", metadata !2918, metadata !"short", i32 0, i32 15}
!2924 = metadata !{i32 786689, metadata !896, metadata !"input", null, i32 122, metadata !2925, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2925 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 1024, i64 16, i32 0, i32 0, metadata !881, metadata !2926, i32 0, i32 0} ; [ DW_TAG_array_type ]
!2926 = metadata !{metadata !2927}
!2927 = metadata !{i32 786465, i64 0, i64 63}     ; [ DW_TAG_subrange_type ]
!2928 = metadata !{i32 122, i32 16, metadata !896, null}
!2929 = metadata !{i32 786689, metadata !896, metadata !"output", null, i32 122, metadata !2925, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2930 = metadata !{i32 122, i32 38, metadata !896, null}
!2931 = metadata !{i32 790529, metadata !2932, metadata !"col_inbuf[0]", null, i32 71, metadata !2935, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2932 = metadata !{i32 786688, metadata !2933, metadata !"col_inbuf", metadata !876, i32 71, metadata !2934, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2933 = metadata !{i32 786443, metadata !882, i32 69, i32 1, metadata !876, i32 5} ; [ DW_TAG_lexical_block ]
!2934 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 1024, i64 16, i32 0, i32 0, metadata !880, metadata !904, i32 0, i32 0} ; [ DW_TAG_array_type ]
!2935 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 128, i64 16, i32 0, i32 0, metadata !880, metadata !904, i32 0, i32 0} ; [ DW_TAG_array_type ]
!2936 = metadata !{i32 71, i32 109, metadata !2933, metadata !2937}
!2937 = metadata !{i32 130, i32 4, metadata !2913, null}
!2938 = metadata !{i32 790529, metadata !2932, metadata !"col_inbuf[1]", null, i32 71, metadata !2935, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2939 = metadata !{i32 790529, metadata !2932, metadata !"col_inbuf[2]", null, i32 71, metadata !2935, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2940 = metadata !{i32 790529, metadata !2932, metadata !"col_inbuf[3]", null, i32 71, metadata !2935, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2941 = metadata !{i32 790529, metadata !2932, metadata !"col_inbuf[4]", null, i32 71, metadata !2935, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2942 = metadata !{i32 790529, metadata !2932, metadata !"col_inbuf[5]", null, i32 71, metadata !2935, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2943 = metadata !{i32 790529, metadata !2932, metadata !"col_inbuf[6]", null, i32 71, metadata !2935, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2944 = metadata !{i32 790529, metadata !2932, metadata !"col_inbuf[7]", null, i32 71, metadata !2935, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2945 = metadata !{i32 790529, metadata !2946, metadata !"buf_2d_in[0]", null, i32 124, metadata !2948, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2946 = metadata !{i32 786688, metadata !2913, metadata !"buf_2d_in", metadata !876, i32 124, metadata !2947, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2947 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 1024, i64 16, i32 0, i32 0, metadata !881, metadata !904, i32 0, i32 0} ; [ DW_TAG_array_type ]
!2948 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 128, i64 16, i32 0, i32 0, metadata !881, metadata !904, i32 0, i32 0} ; [ DW_TAG_array_type ]
!2949 = metadata !{i32 124, i32 10, metadata !2913, null}
!2950 = metadata !{i32 790529, metadata !2946, metadata !"buf_2d_in[1]", null, i32 124, metadata !2948, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2951 = metadata !{i32 790529, metadata !2946, metadata !"buf_2d_in[2]", null, i32 124, metadata !2948, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2952 = metadata !{i32 790529, metadata !2946, metadata !"buf_2d_in[3]", null, i32 124, metadata !2948, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2953 = metadata !{i32 790529, metadata !2946, metadata !"buf_2d_in[4]", null, i32 124, metadata !2948, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2954 = metadata !{i32 790529, metadata !2946, metadata !"buf_2d_in[5]", null, i32 124, metadata !2948, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2955 = metadata !{i32 790529, metadata !2946, metadata !"buf_2d_in[6]", null, i32 124, metadata !2948, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2956 = metadata !{i32 790529, metadata !2946, metadata !"buf_2d_in[7]", null, i32 124, metadata !2948, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2957 = metadata !{i32 786688, metadata !2913, metadata !"buf_2d_out", metadata !876, i32 125, metadata !2947, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2958 = metadata !{i32 125, i32 10, metadata !2913, null}
!2959 = metadata !{i32 128, i32 4, metadata !2913, null}
!2960 = metadata !{i32 133, i32 4, metadata !2913, null}
!2961 = metadata !{i32 134, i32 1, metadata !2913, null}
!2962 = metadata !{i32 786689, metadata !893, metadata !"buf", null, i32 110, metadata !2947, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2963 = metadata !{i32 110, i32 23, metadata !893, null}
!2964 = metadata !{i32 786689, metadata !893, metadata !"output", null, i32 110, metadata !2925, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2965 = metadata !{i32 110, i32 116, metadata !893, null}
!2966 = metadata !{i32 115, i32 9, metadata !2967, null}
!2967 = metadata !{i32 786443, metadata !2968, i32 115, i32 4, metadata !876, i32 24} ; [ DW_TAG_lexical_block ]
!2968 = metadata !{i32 786443, metadata !893, i32 111, i32 1, metadata !876, i32 23} ; [ DW_TAG_lexical_block ]
!2969 = metadata !{i32 115, i32 67, metadata !2970, null}
!2970 = metadata !{i32 786443, metadata !2967, i32 115, i32 66, metadata !876, i32 25} ; [ DW_TAG_lexical_block ]
!2971 = metadata !{i32 118, i32 1, metadata !2972, null}
!2972 = metadata !{i32 786443, metadata !2973, i32 118, i32 1, metadata !876, i32 27} ; [ DW_TAG_lexical_block ]
!2973 = metadata !{i32 786443, metadata !2970, i32 117, i32 7, metadata !876, i32 26} ; [ DW_TAG_lexical_block ]
!2974 = metadata !{i32 117, i32 12, metadata !2973, null}
!2975 = metadata !{i32 118, i32 2, metadata !2972, null}
!2976 = metadata !{i32 119, i32 1, metadata !2972, null}
!2977 = metadata !{i32 118, i32 67, metadata !2972, null}
!2978 = metadata !{i32 117, i32 64, metadata !2973, null}
!2979 = metadata !{i32 786688, metadata !2968, metadata !"c", metadata !876, i32 112, metadata !55, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2980 = metadata !{i32 119, i32 4, metadata !2970, null}
!2981 = metadata !{i32 115, i32 61, metadata !2967, null}
!2982 = metadata !{i32 786688, metadata !2968, metadata !"r", metadata !876, i32 112, metadata !55, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2983 = metadata !{i32 120, i32 1, metadata !2968, null}
!2984 = metadata !{i32 786689, metadata !887, metadata !"input", null, i32 98, metadata !2925, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2985 = metadata !{i32 98, i32 22, metadata !887, null}
!2986 = metadata !{i32 790531, metadata !2987, metadata !"buf[0]", null, i32 98, metadata !2948, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2987 = metadata !{i32 786689, metadata !887, metadata !"buf", null, i32 98, metadata !2947, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2988 = metadata !{i32 98, i32 44, metadata !887, null}
!2989 = metadata !{i32 790531, metadata !2987, metadata !"buf[1]", null, i32 98, metadata !2948, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2990 = metadata !{i32 790531, metadata !2987, metadata !"buf[2]", null, i32 98, metadata !2948, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2991 = metadata !{i32 790531, metadata !2987, metadata !"buf[3]", null, i32 98, metadata !2948, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2992 = metadata !{i32 790531, metadata !2987, metadata !"buf[4]", null, i32 98, metadata !2948, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2993 = metadata !{i32 790531, metadata !2987, metadata !"buf[5]", null, i32 98, metadata !2948, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2994 = metadata !{i32 790531, metadata !2987, metadata !"buf[6]", null, i32 98, metadata !2948, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2995 = metadata !{i32 790531, metadata !2987, metadata !"buf[7]", null, i32 98, metadata !2948, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2996 = metadata !{i32 103, i32 9, metadata !2997, null}
!2997 = metadata !{i32 786443, metadata !2998, i32 103, i32 4, metadata !876, i32 19} ; [ DW_TAG_lexical_block ]
!2998 = metadata !{i32 786443, metadata !887, i32 99, i32 1, metadata !876, i32 18} ; [ DW_TAG_lexical_block ]
!2999 = metadata !{i32 103, i32 67, metadata !3000, null}
!3000 = metadata !{i32 786443, metadata !2997, i32 103, i32 66, metadata !876, i32 20} ; [ DW_TAG_lexical_block ]
!3001 = metadata !{i32 106, i32 1, metadata !3002, null}
!3002 = metadata !{i32 786443, metadata !3003, i32 106, i32 1, metadata !876, i32 22} ; [ DW_TAG_lexical_block ]
!3003 = metadata !{i32 786443, metadata !3000, i32 105, i32 7, metadata !876, i32 21} ; [ DW_TAG_lexical_block ]
!3004 = metadata !{i32 105, i32 12, metadata !3003, null}
!3005 = metadata !{i32 106, i32 2, metadata !3002, null}
!3006 = metadata !{i32 107, i32 1, metadata !3002, null}
!3007 = metadata !{i32 106, i32 66, metadata !3002, null}
!3008 = metadata !{i32 105, i32 64, metadata !3003, null}
!3009 = metadata !{i32 786688, metadata !2998, metadata !"c", metadata !876, i32 100, metadata !55, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3010 = metadata !{i32 107, i32 4, metadata !3000, null}
!3011 = metadata !{i32 103, i32 61, metadata !2997, null}
!3012 = metadata !{i32 786688, metadata !2998, metadata !"r", metadata !876, i32 100, metadata !55, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3013 = metadata !{i32 108, i32 1, metadata !2998, null}
!3014 = metadata !{i32 76, i32 8, metadata !3015, metadata !2937}
!3015 = metadata !{i32 786443, metadata !2933, i32 76, i32 4, metadata !876, i32 6} ; [ DW_TAG_lexical_block ]
!3016 = metadata !{i32 76, i32 66, metadata !3017, metadata !2937}
!3017 = metadata !{i32 786443, metadata !3015, i32 76, i32 65, metadata !876, i32 7} ; [ DW_TAG_lexical_block ]
!3018 = metadata !{i4 0, i4 7, i4 0, i4 7}        
!3019 = metadata !{i32 786689, metadata !875, metadata !"dst", null, i32 48, metadata !3020, i32 0, metadata !3021} ; [ DW_TAG_arg_variable ]
!3020 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 0, i64 0, i32 0, i32 0, metadata !880, metadata !107, i32 0, i32 0} ; [ DW_TAG_array_type ]
!3021 = metadata !{i32 77, i32 7, metadata !3017, metadata !2937}
!3022 = metadata !{i32 48, i32 81, metadata !875, metadata !3021}
!3023 = metadata !{i32 57, i32 9, metadata !3024, metadata !3021}
!3024 = metadata !{i32 786443, metadata !3025, i32 57, i32 4, metadata !876, i32 1} ; [ DW_TAG_lexical_block ]
!3025 = metadata !{i32 786443, metadata !875, i32 49, i32 1, metadata !876, i32 0} ; [ DW_TAG_lexical_block ]
!3026 = metadata !{i32 57, i32 67, metadata !3027, metadata !3021}
!3027 = metadata !{i32 786443, metadata !3024, i32 57, i32 66, metadata !876, i32 2} ; [ DW_TAG_lexical_block ]
!3028 = metadata !{i32 58, i32 1, metadata !3027, metadata !3021}
!3029 = metadata !{i32 60, i32 48, metadata !3030, metadata !3021}
!3030 = metadata !{i32 786443, metadata !3031, i32 59, i32 77, metadata !876, i32 4} ; [ DW_TAG_lexical_block ]
!3031 = metadata !{i32 786443, metadata !3027, i32 59, i32 7, metadata !876, i32 3} ; [ DW_TAG_lexical_block ]
!3032 = metadata !{i32 61, i32 10, metadata !3030, metadata !3021}
!3033 = metadata !{i32 63, i32 7, metadata !3027, metadata !3021}
!3034 = metadata !{i32 64, i32 4, metadata !3027, metadata !3021}
!3035 = metadata !{i32 57, i32 61, metadata !3024, metadata !3021}
!3036 = metadata !{i32 786688, metadata !3025, metadata !"k", metadata !876, i32 50, metadata !979, i32 0, metadata !3021} ; [ DW_TAG_auto_variable ]
!3037 = metadata !{i32 76, i32 60, metadata !3015, metadata !2937}
!3038 = metadata !{i32 786688, metadata !2933, metadata !"i", metadata !876, i32 72, metadata !979, i32 0, metadata !2937} ; [ DW_TAG_auto_variable ]
!3039 = metadata !{i32 81, i32 9, metadata !3040, metadata !2937}
!3040 = metadata !{i32 786443, metadata !2933, i32 81, i32 4, metadata !876, i32 8} ; [ DW_TAG_lexical_block ]
!3041 = metadata !{i32 84, i32 34, metadata !3042, metadata !2937}
!3042 = metadata !{i32 786443, metadata !3043, i32 83, i32 7, metadata !876, i32 10} ; [ DW_TAG_lexical_block ]
!3043 = metadata !{i32 786443, metadata !3040, i32 82, i32 1, metadata !876, i32 9} ; [ DW_TAG_lexical_block ]
!3044 = metadata !{i32 81, i32 61, metadata !3040, metadata !2937}
!3045 = metadata !{i32 786688, metadata !2933, metadata !"j", metadata !876, i32 72, metadata !979, i32 0, metadata !2937} ; [ DW_TAG_auto_variable ]
!3046 = metadata !{i32 83, i32 11, metadata !3042, metadata !2937}
!3047 = metadata !{i32 82, i32 1, metadata !3043, metadata !2937}
!3048 = metadata !{i32 84, i32 1, metadata !3049, metadata !2937}
!3049 = metadata !{i32 786443, metadata !3042, i32 84, i32 1, metadata !876, i32 11} ; [ DW_TAG_lexical_block ]
!3050 = metadata !{i32 84, i32 34, metadata !3049, metadata !2937}
!3051 = metadata !{i32 83, i32 63, metadata !3042, metadata !2937}
!3052 = metadata !{i32 84, i32 2, metadata !3049, metadata !2937}
!3053 = metadata !{i32 85, i32 1, metadata !3049, metadata !2937}
!3054 = metadata !{i32 87, i32 9, metadata !3055, metadata !2937}
!3055 = metadata !{i32 786443, metadata !2933, i32 87, i32 4, metadata !876, i32 12} ; [ DW_TAG_lexical_block ]
!3056 = metadata !{i32 87, i32 67, metadata !3057, metadata !2937}
!3057 = metadata !{i32 786443, metadata !3055, i32 87, i32 66, metadata !876, i32 13} ; [ DW_TAG_lexical_block ]
!3058 = metadata !{i32 786689, metadata !875, metadata !"dst", null, i32 48, metadata !3020, i32 0, metadata !3059} ; [ DW_TAG_arg_variable ]
!3059 = metadata !{i32 88, i32 7, metadata !3057, metadata !2937}
!3060 = metadata !{i32 48, i32 81, metadata !875, metadata !3059}
!3061 = metadata !{i32 57, i32 9, metadata !3024, metadata !3059}
!3062 = metadata !{i32 57, i32 67, metadata !3027, metadata !3059}
!3063 = metadata !{i32 58, i32 1, metadata !3027, metadata !3059}
!3064 = metadata !{i32 60, i32 48, metadata !3030, metadata !3059}
!3065 = metadata !{i32 61, i32 10, metadata !3030, metadata !3059}
!3066 = metadata !{i32 63, i32 7, metadata !3027, metadata !3059}
!3067 = metadata !{i32 64, i32 4, metadata !3027, metadata !3059}
!3068 = metadata !{i32 57, i32 61, metadata !3024, metadata !3059}
!3069 = metadata !{i32 786688, metadata !3025, metadata !"k", metadata !876, i32 50, metadata !979, i32 0, metadata !3059} ; [ DW_TAG_auto_variable ]
!3070 = metadata !{i32 87, i32 61, metadata !3055, metadata !2937}
!3071 = metadata !{i32 92, i32 9, metadata !3072, metadata !2937}
!3072 = metadata !{i32 786443, metadata !2933, i32 92, i32 4, metadata !876, i32 14} ; [ DW_TAG_lexical_block ]
!3073 = metadata !{i32 95, i32 34, metadata !3074, metadata !2937}
!3074 = metadata !{i32 786443, metadata !3075, i32 94, i32 7, metadata !876, i32 16} ; [ DW_TAG_lexical_block ]
!3075 = metadata !{i32 786443, metadata !3072, i32 93, i32 1, metadata !876, i32 15} ; [ DW_TAG_lexical_block ]
!3076 = metadata !{i32 92, i32 61, metadata !3072, metadata !2937}
!3077 = metadata !{i32 94, i32 11, metadata !3074, metadata !2937}
!3078 = metadata !{i32 93, i32 1, metadata !3075, metadata !2937}
!3079 = metadata !{i32 95, i32 1, metadata !3080, metadata !2937}
!3080 = metadata !{i32 786443, metadata !3074, i32 95, i32 1, metadata !876, i32 17} ; [ DW_TAG_lexical_block ]
!3081 = metadata !{i32 95, i32 2, metadata !3080, metadata !2937}
!3082 = metadata !{i32 96, i32 1, metadata !3080, metadata !2937}
!3083 = metadata !{i32 95, i32 34, metadata !3080, metadata !2937}
!3084 = metadata !{i32 94, i32 63, metadata !3074, metadata !2937}

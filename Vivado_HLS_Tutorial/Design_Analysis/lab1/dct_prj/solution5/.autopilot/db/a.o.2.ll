...
define void @dct([64 x i16]* %input, [64 x i16]* %output) nounwind uwtable {
  ...
  call void @llvm.dbg.declare(metadata !{[8 x i16]* %"buf_2d_in[0]"}, metadata !2931), !dbg !2935 ; [debug line = 124:10] [debug variable = buf_2d_in[0]]
  call void @llvm.dbg.declare(metadata !{[8 x i16]* %"buf_2d_in[1]"}, metadata !2936), !dbg !2935 ; [debug line = 124:10] [debug variable = buf_2d_in[1]]
  call void @llvm.dbg.declare(metadata !{[8 x i16]* %"buf_2d_in[2]"}, metadata !2937), !dbg !2935 ; [debug line = 124:10] [debug variable = buf_2d_in[2]]
  call void @llvm.dbg.declare(metadata !{[8 x i16]* %"buf_2d_in[3]"}, metadata !2938), !dbg !2935 ; [debug line = 124:10] [debug variable = buf_2d_in[3]]
  call void @llvm.dbg.declare(metadata !{[8 x i16]* %"buf_2d_in[4]"}, metadata !2939), !dbg !2935 ; [debug line = 124:10] [debug variable = buf_2d_in[4]]
  call void @llvm.dbg.declare(metadata !{[8 x i16]* %"buf_2d_in[5]"}, metadata !2940), !dbg !2935 ; [debug line = 124:10] [debug variable = buf_2d_in[5]]
  call void @llvm.dbg.declare(metadata !{[8 x i16]* %"buf_2d_in[6]"}, metadata !2941), !dbg !2935 ; [debug line = 124:10] [debug variable = buf_2d_in[6]]
  call void @llvm.dbg.declare(metadata !{[8 x i16]* %"buf_2d_in[7]"}, metadata !2942), !dbg !2935 ; [debug line = 124:10] [debug variable = buf_2d_in[7]]
  call void @llvm.dbg.declare(metadata !{[8 x [8 x i16]]* %buf_2d_out}, metadata !2943), !dbg !2944 ; [debug line = 125:10] [debug variable = buf_2d_out]
  call fastcc void @read_data([64 x i16]* %input, [8 x i16]* %"buf_2d_in[0]", [8 x i16]* %"buf_2d_in[1]", [8 x i16]* %"buf_2d_in[2]", [8 x i16]* %"buf_2d_in[3]", [8 x i16]* %"buf_2d_in[4]", [8 x i16]* %"buf_2d_in[5]", [8 x i16]* %"buf_2d_in[6]", [8 x i16]* %"buf_2d_in[7]") nounwind, !dbg !2945 ; [debug line = 128:4]
  call fastcc void @dct_2d([8 x i16]* %"buf_2d_in[0]", [8 x i16]* %"buf_2d_in[1]", [8 x i16]* %"buf_2d_in[2]", [8 x i16]* %"buf_2d_in[3]", [8 x i16]* %"buf_2d_in[4]", [8 x i16]* %"buf_2d_in[5]", [8 x i16]* %"buf_2d_in[6]", [8 x i16]* %"buf_2d_in[7]", [8 x [8 x i16]]* %buf_2d_out) nounwind, !dbg !2946 ; [debug line = 130:4]
  call fastcc void @write_data([8 x [8 x i16]]* %buf_2d_out, [64 x i16]* %output) nounwind, !dbg !2947 ; [debug line = 133:4]
  ret void, !dbg !2948                            ; [debug line = 134:1]
}

; [#uses=1]
define internal fastcc void @write_data([8 x [8 x i16]]* nocapture %buf, [64 x i16]* nocapture %output) {
  call void @llvm.dbg.value(metadata !{[8 x [8 x i16]]* %buf}, i64 0, metadata !2949), !dbg !2950 ; [debug line = 110:23] [debug variable = buf]
  call void @llvm.dbg.value(metadata !{[64 x i16]* %output}, i64 0, metadata !2951), !dbg !2952 ; [debug line = 110:116] [debug variable = output]
  br label %1, !dbg !2953                         ; [debug line = 115:9]

; <label>:1                                       ; preds = %8, %0
  %r = phi i4 [ 0, %0 ], [ %r.1, %8 ]             ; [#uses=4 type=i4]
  %r.cast7 = zext i4 %r to i6, !dbg !2953         ; [#uses=1 type=i6] [debug line = 115:9]
  %exitcond1 = icmp eq i4 %r, -8, !dbg !2953      ; [#uses=1 type=i1] [debug line = 115:9]
  %2 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) ; [#uses=0 type=i32]
  br i1 %exitcond1, label %10, label %3, !dbg !2953 ; [debug line = 115:9]

; <label>:3                                       ; preds = %1
  call void (...)* @_ssdm_op_SpecLoopName([12 x i8]* @.str12) nounwind, !dbg !2956 ; [debug line = 115:67]
  %tmp.1 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @.str12), !dbg !2956 ; [#uses=1 type=i32] [debug line = 115:67]
  %tmp = zext i4 %r to i64, !dbg !2958            ; [#uses=1 type=i64] [debug line = 118:1]
  %tmp. = shl i6 %r.cast7, 3, !dbg !2958          ; [#uses=1 type=i6] [debug line = 118:1]
  br label %4, !dbg !2961                         ; [debug line = 117:12]

; <label>:4                                       ; preds = %6, %3
  %c = phi i4 [ 0, %3 ], [ %c.1, %6 ]             ; [#uses=4 type=i4]
  %c.cast6 = zext i4 %c to i6, !dbg !2961         ; [#uses=1 type=i6] [debug line = 117:12]
  %exitcond = icmp eq i4 %c, -8, !dbg !2961       ; [#uses=1 type=i1] [debug line = 117:12]
  %5 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) ; [#uses=0 type=i32]
  br i1 %exitcond, label %8, label %6, !dbg !2961 ; [debug line = 117:12]

; <label>:6                                       ; preds = %4
  call void (...)* @_ssdm_op_SpecLoopName([12 x i8]* @.str13) nounwind, !dbg !2962 ; [debug line = 118:2]
  %tmp.2 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @.str13), !dbg !2962 ; [#uses=1 type=i32] [debug line = 118:2]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, [1 x i8]* @.str1) nounwind, !dbg !2963 ; [debug line = 119:1]
  %tmp.8 = zext i4 %c to i64, !dbg !2958          ; [#uses=1 type=i64] [debug line = 118:1]
  %buf.addr = getelementptr [8 x [8 x i16]]* %buf, i64 0, i64 %tmp, i64 %tmp.8, !dbg !2958 ; [#uses=1 type=i16*] [debug line = 118:1]
  %buf.load = load i16* %buf.addr, align 2, !dbg !2958 ; [#uses=1 type=i16] [debug line = 118:1]
  %tmp.9 = add i6 %c.cast6, %tmp., !dbg !2958     ; [#uses=1 type=i6] [debug line = 118:1]
  %tmp.3 = zext i6 %tmp.9 to i64, !dbg !2958      ; [#uses=1 type=i64] [debug line = 118:1]
  %output.addr = getelementptr [64 x i16]* %output, i64 0, i64 %tmp.3, !dbg !2958 ; [#uses=1 type=i16*] [debug line = 118:1]
  store i16 %buf.load, i16* %output.addr, align 2, !dbg !2958 ; [debug line = 118:1]
  %7 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @.str13, i32 %tmp.2), !dbg !2964 ; [#uses=0 type=i32] [debug line = 118:67]
  %c.1 = add i4 %c, 1, !dbg !2965                 ; [#uses=1 type=i4] [debug line = 117:64]
  call void @llvm.dbg.value(metadata !{i4 %c.1}, i64 0, metadata !2966), !dbg !2965 ; [debug line = 117:64] [debug variable = c]
  br label %4, !dbg !2965                         ; [debug line = 117:64]

; <label>:8                                       ; preds = %4
  %9 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @.str12, i32 %tmp.1), !dbg !2967 ; [#uses=0 type=i32] [debug line = 119:4]
  %r.1 = add i4 %r, 1, !dbg !2968                 ; [#uses=1 type=i4] [debug line = 115:61]
  call void @llvm.dbg.value(metadata !{i4 %r.1}, i64 0, metadata !2969), !dbg !2968 ; [debug line = 115:61] [debug variable = r]
  br label %1, !dbg !2968                         ; [debug line = 115:61]

; <label>:10                                      ; preds = %1
  ret void, !dbg !2970                            ; [debug line = 120:1]
}
...
define internal fastcc void @dct_2d([8 x i16]* nocapture %"in_block[0]", [8 x i16]* nocapture %"in_block[1]", [8 x i16]* nocapture %"in_block[2]", [8 x i16]* nocapture %"in_block[3]", [8 x i16]* nocapture %"in_block[4]", [8 x i16]* nocapture %"in_block[5]", [8 x i16]* nocapture %"in_block[6]", [8 x i16]* nocapture %"in_block[7]", [8 x [8 x i16]]* nocapture %out_block) {
  ...
  call void @llvm.dbg.value(metadata !{[8 x i16]* %"in_block[0]"}, i64 0, metadata !2971), !dbg !2975 ; [debug line = 67:24] [debug variable = in_block[0]]
  call void @llvm.dbg.value(metadata !{[8 x i16]* %"in_block[1]"}, i64 0, metadata !2976), !dbg !2975 ; [debug line = 67:24] [debug variable = in_block[1]]
  call void @llvm.dbg.value(metadata !{[8 x i16]* %"in_block[2]"}, i64 0, metadata !2977), !dbg !2975 ; [debug line = 67:24] [debug variable = in_block[2]]
  call void @llvm.dbg.value(metadata !{[8 x i16]* %"in_block[3]"}, i64 0, metadata !2978), !dbg !2975 ; [debug line = 67:24] [debug variable = in_block[3]]
  call void @llvm.dbg.value(metadata !{[8 x i16]* %"in_block[4]"}, i64 0, metadata !2979), !dbg !2975 ; [debug line = 67:24] [debug variable = in_block[4]]
  call void @llvm.dbg.value(metadata !{[8 x i16]* %"in_block[5]"}, i64 0, metadata !2980), !dbg !2975 ; [debug line = 67:24] [debug variable = in_block[5]]
  call void @llvm.dbg.value(metadata !{[8 x i16]* %"in_block[6]"}, i64 0, metadata !2981), !dbg !2975 ; [debug line = 67:24] [debug variable = in_block[6]]
  call void @llvm.dbg.value(metadata !{[8 x i16]* %"in_block[7]"}, i64 0, metadata !2982), !dbg !2975 ; [debug line = 67:24] [debug variable = in_block[7]]
  call void @llvm.dbg.value(metadata !{[8 x [8 x i16]]* %out_block}, i64 0, metadata !2983), !dbg !2984 ; [debug line = 68:18] [debug variable = out_block]
  call void @llvm.dbg.declare(metadata !{[8 x i16]* %"col_inbuf[0]"}, metadata !2985), !dbg !2988 ; [debug line = 71:109] [debug variable = col_inbuf[0]]
  call void @llvm.dbg.declare(metadata !{[8 x i16]* %"col_inbuf[1]"}, metadata !2989), !dbg !2988 ; [debug line = 71:109] [debug variable = col_inbuf[1]]
  call void @llvm.dbg.declare(metadata !{[8 x i16]* %"col_inbuf[2]"}, metadata !2990), !dbg !2988 ; [debug line = 71:109] [debug variable = col_inbuf[2]]
  call void @llvm.dbg.declare(metadata !{[8 x i16]* %"col_inbuf[3]"}, metadata !2991), !dbg !2988 ; [debug line = 71:109] [debug variable = col_inbuf[3]]
  call void @llvm.dbg.declare(metadata !{[8 x i16]* %"col_inbuf[4]"}, metadata !2992), !dbg !2988 ; [debug line = 71:109] [debug variable = col_inbuf[4]]
  call void @llvm.dbg.declare(metadata !{[8 x i16]* %"col_inbuf[5]"}, metadata !2993), !dbg !2988 ; [debug line = 71:109] [debug variable = col_inbuf[5]]
  call void @llvm.dbg.declare(metadata !{[8 x i16]* %"col_inbuf[6]"}, metadata !2994), !dbg !2988 ; [debug line = 71:109] [debug variable = col_inbuf[6]]
  call void @llvm.dbg.declare(metadata !{[8 x i16]* %"col_inbuf[7]"}, metadata !2995), !dbg !2988 ; [debug line = 71:109] [debug variable = col_inbuf[7]]
  br label %1, !dbg !2996                         ; [debug line = 76:8]

; <label>:1                                       ; preds = %3, %0
  %i = phi i4 [ 0, %0 ], [ %i.4, %3 ]             ; [#uses=4 type=i4]
  %exitcond5 = icmp eq i4 %i, -8, !dbg !2996      ; [#uses=1 type=i1] [debug line = 76:8]
  %2 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) ; [#uses=0 type=i32]
  br i1 %exitcond5, label %.preheader7, label %3, !dbg !2996 ; [debug line = 76:8]

; <label>:3                                       ; preds = %1
  call void (...)* @_ssdm_op_SpecLoopName([13 x i8]* @.str4) nounwind, !dbg !2998 ; [debug line = 76:66]
  call fastcc void @dct_1d([8 x i16]* %"in_block[0]", [8 x i16]* %"in_block[1]", [8 x i16]* %"in_block[2]", [8 x i16]* %"in_block[3]", [8 x i16]* %"in_block[4]", [8 x i16]* %"in_block[5]", [8 x i16]* %"in_block[6]", [8 x i16]* %"in_block[7]", i4 %i, [8 x [8 x i16]]* %row_outbuf, i4 %i), !dbg !3000 ; [debug line = 77:7]
  %i.4 = add i4 %i, 1, !dbg !3001                 ; [#uses=1 type=i4] [debug line = 76:60]
  call void @llvm.dbg.value(metadata !{i4 %i.4}, i64 0, metadata !3002), !dbg !3001 ; [debug line = 76:60] [debug variable = i]
  br label %1, !dbg !3001                         ; [debug line = 76:60]

.preheader7:                                      ; preds = %11, %1
  %j = phi i4 [ %j.2, %11 ], [ 0, %1 ]            ; [#uses=3 type=i4]
  %exitcond4 = icmp eq i4 %j, -8, !dbg !3003      ; [#uses=1 type=i1] [debug line = 81:9]
  %4 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) ; [#uses=0 type=i32]
  br i1 %exitcond4, label %.preheader6, label %5, !dbg !3003 ; [debug line = 81:9]

; <label>:5                                       ; preds = %.preheader7
  call void (...)* @_ssdm_op_SpecLoopName([21 x i8]* @.str5) nounwind, !dbg !3005 ; [debug line = 82:1]
  %tmp.6 = call i32 (...)* @_ssdm_op_SpecRegionBegin([21 x i8]* @.str5), !dbg !3005 ; [#uses=1 type=i32] [debug line = 82:1]
  %tmp. = zext i4 %j to i64, !dbg !3007           ; [#uses=9 type=i64] [debug line = 84:1]
  br label %6, !dbg !3010                         ; [debug line = 83:11]

; <label>:6                                       ; preds = %9, %5
  %i.1 = phi i4 [ 0, %5 ], [ %i.6, %9 ]           ; [#uses=4 type=i4]
  %exitcond3 = icmp eq i4 %i.1, -8, !dbg !3010    ; [#uses=1 type=i1] [debug line = 83:11]
  %7 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) ; [#uses=0 type=i32]
  br i1 %exitcond3, label %11, label %8, !dbg !3010 ; [debug line = 83:11]

; <label>:8                                       ; preds = %6
  call void (...)* @_ssdm_op_SpecLoopName([21 x i8]* @.str6) nounwind, !dbg !3011 ; [debug line = 84:2]
  %tmp.9 = call i32 (...)* @_ssdm_op_SpecRegionBegin([21 x i8]* @.str6), !dbg !3011 ; [#uses=1 type=i32] [debug line = 84:2]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, [1 x i8]* @.str1) nounwind, !dbg !3012 ; [debug line = 85:1]
  %tmp.2 = zext i4 %i.1 to i64, !dbg !3007        ; [#uses=1 type=i64] [debug line = 84:1]
  %row_outbuf.addr = getelementptr inbounds [8 x [8 x i16]]* %row_outbuf, i64 0, i64 %tmp.2, i64 %tmp., !dbg !3007 ; [#uses=1 type=i16*] [debug line = 84:1]
  %row_outbuf.load = load i16* %row_outbuf.addr, align 2, !dbg !3007 ; [#uses=8 type=i16] [debug line = 84:1]
  %i.1.t = trunc i4 %i.1 to i3                    ; [#uses=1 type=i3]
  %"col_inbuf[0].addr" = getelementptr [8 x i16]* %"col_inbuf[0]", i64 0, i64 %tmp., !dbg !3007 ; [#uses=1 type=i16*] [debug line = 84:1]
  %"col_inbuf[1].addr" = getelementptr [8 x i16]* %"col_inbuf[1]", i64 0, i64 %tmp., !dbg !3007 ; [#uses=1 type=i16*] [debug line = 84:1]
  %"col_inbuf[2].addr" = getelementptr [8 x i16]* %"col_inbuf[2]", i64 0, i64 %tmp., !dbg !3007 ; [#uses=1 type=i16*] [debug line = 84:1]
  %"col_inbuf[3].addr" = getelementptr [8 x i16]* %"col_inbuf[3]", i64 0, i64 %tmp., !dbg !3007 ; [#uses=1 type=i16*] [debug line = 84:1]
  %"col_inbuf[4].addr" = getelementptr [8 x i16]* %"col_inbuf[4]", i64 0, i64 %tmp., !dbg !3007 ; [#uses=1 type=i16*] [debug line = 84:1]
  %"col_inbuf[5].addr" = getelementptr [8 x i16]* %"col_inbuf[5]", i64 0, i64 %tmp., !dbg !3007 ; [#uses=1 type=i16*] [debug line = 84:1]
  %"col_inbuf[6].addr" = getelementptr [8 x i16]* %"col_inbuf[6]", i64 0, i64 %tmp., !dbg !3007 ; [#uses=1 type=i16*] [debug line = 84:1]
  %"col_inbuf[7].addr" = getelementptr [8 x i16]* %"col_inbuf[7]", i64 0, i64 %tmp., !dbg !3007 ; [#uses=1 type=i16*] [debug line = 84:1]
  switch i3 %i.1.t, label %branch7 [
    ...
    i3 -3, label %branch5
    i3 -2, label %branch6
  ], !dbg !3007                                   ; [debug line = 84:1]

; <label>:9                                       ; preds = %branch7, %branch6, %branch5, %branch4, %branch3, %branch2, %branch1, %branch0
  %10 = call i32 (...)* @_ssdm_op_SpecRegionEnd([21 x i8]* @.str6, i32 %tmp.9), !dbg !3013 ; [#uses=0 type=i32] [debug line = 84:34]
  %i.6 = add i4 %i.1, 1, !dbg !3014               ; [#uses=1 type=i4] [debug line = 83:63]
  call void @llvm.dbg.value(metadata !{i4 %i.6}, i64 0, metadata !3002), !dbg !3014 ; [debug line = 83:63] [debug variable = i]
  br label %6, !dbg !3014                         ; [debug line = 83:63]

; <label>:11                                      ; preds = %6
  %12 = call i32 (...)* @_ssdm_op_SpecRegionEnd([21 x i8]* @.str5, i32 %tmp.6), !dbg !3015 ; [#uses=0 type=i32] [debug line = 84:34]
  %j.2 = add i4 %j, 1, !dbg !3016                 ; [#uses=1 type=i4] [debug line = 81:61]
  call void @llvm.dbg.value(metadata !{i4 %j.2}, i64 0, metadata !3017), !dbg !3016 ; [debug line = 81:61] [debug variable = j]
  br label %.preheader7, !dbg !3016               ; [debug line = 81:61]

.preheader6:                                      ; preds = %14, %.preheader7
  %i.2 = phi i4 [ %i.5, %14 ], [ 0, %.preheader7 ] ; [#uses=4 type=i4]
  %exitcond2 = icmp eq i4 %i.2, -8, !dbg !3018    ; [#uses=1 type=i1] [debug line = 87:9]
  %13 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) ; [#uses=0 type=i32]
  br i1 %exitcond2, label %.preheader, label %14, !dbg !3018 ; [debug line = 87:9]

; <label>:14                                      ; preds = %.preheader6
  call void (...)* @_ssdm_op_SpecLoopName([13 x i8]* @.str7) nounwind, !dbg !3020 ; [debug line = 87:67]
  call fastcc void @dct_1d([8 x i16]* %"col_inbuf[0]", [8 x i16]* %"col_inbuf[1]", [8 x i16]* %"col_inbuf[2]", [8 x i16]* %"col_inbuf[3]", [8 x i16]* %"col_inbuf[4]", [8 x i16]* %"col_inbuf[5]", [8 x i16]* %"col_inbuf[6]", [8 x i16]* %"col_inbuf[7]", i4 %i.2, [8 x [8 x i16]]* %col_outbuf, i4 %i.2), !dbg !3022 ; [debug line = 88:7]
  %i.5 = add i4 %i.2, 1, !dbg !3023               ; [#uses=1 type=i4] [debug line = 87:61]
  call void @llvm.dbg.value(metadata !{i4 %i.5}, i64 0, metadata !3002), !dbg !3023 ; [debug line = 87:61] [debug variable = i]
  br label %.preheader6, !dbg !3023               ; [debug line = 87:61]

.preheader:                                       ; preds = %21, %.preheader6
  %j.1 = phi i4 [ %j.3, %21 ], [ 0, %.preheader6 ] ; [#uses=3 type=i4]
  %exitcond1 = icmp eq i4 %j.1, -8, !dbg !3024    ; [#uses=1 type=i1] [debug line = 92:9]
  %15 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) ; [#uses=0 type=i32]
  br i1 %exitcond1, label %23, label %16, !dbg !3024 ; [debug line = 92:9]

; <label>:16                                      ; preds = %.preheader
  call void (...)* @_ssdm_op_SpecLoopName([21 x i8]* @.str8) nounwind, !dbg !3026 ; [debug line = 93:1]
  %tmp.8 = call i32 (...)* @_ssdm_op_SpecRegionBegin([21 x i8]* @.str8), !dbg !3026 ; [#uses=1 type=i32] [debug line = 93:1]
  %tmp.3 = zext i4 %j.1 to i64, !dbg !3028        ; [#uses=2 type=i64] [debug line = 95:1]
  br label %17, !dbg !3031                        ; [debug line = 94:11]

; <label>:17                                      ; preds = %19, %16
  %i.3 = phi i4 [ 0, %16 ], [ %i.7, %19 ]         ; [#uses=3 type=i4]
  %exitcond = icmp eq i4 %i.3, -8, !dbg !3031     ; [#uses=1 type=i1] [debug line = 94:11]
  %18 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) ; [#uses=0 type=i32]
  br i1 %exitcond, label %21, label %19, !dbg !3031 ; [debug line = 94:11]

; <label>:19                                      ; preds = %17
  call void (...)* @_ssdm_op_SpecLoopName([21 x i8]* @.str9) nounwind, !dbg !3032 ; [debug line = 95:2]
  %tmp.1 = call i32 (...)* @_ssdm_op_SpecRegionBegin([21 x i8]* @.str9), !dbg !3032 ; [#uses=1 type=i32] [debug line = 95:2]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, [1 x i8]* @.str1) nounwind, !dbg !3033 ; [debug line = 96:1]
  %tmp.4 = zext i4 %i.3 to i64, !dbg !3028        ; [#uses=2 type=i64] [debug line = 95:1]
  %col_outbuf.addr = getelementptr inbounds [8 x [8 x i16]]* %col_outbuf, i64 0, i64 %tmp.4, i64 %tmp.3, !dbg !3028 ; [#uses=1 type=i16*] [debug line = 95:1]
  %col_outbuf.load = load i16* %col_outbuf.addr, align 2, !dbg !3028 ; [#uses=1 type=i16] [debug line = 95:1]
  %out_block.addr = getelementptr [8 x [8 x i16]]* %out_block, i64 0, i64 %tmp.3, i64 %tmp.4, !dbg !3028 ; [#uses=1 type=i16*] [debug line = 95:1]
  store i16 %col_outbuf.load, i16* %out_block.addr, align 2, !dbg !3028 ; [debug line = 95:1]
  %20 = call i32 (...)* @_ssdm_op_SpecRegionEnd([21 x i8]* @.str9, i32 %tmp.1), !dbg !3034 ; [#uses=0 type=i32] [debug line = 95:34]
  %i.7 = add i4 %i.3, 1, !dbg !3035               ; [#uses=1 type=i4] [debug line = 94:63]
  call void @llvm.dbg.value(metadata !{i4 %i.7}, i64 0, metadata !3002), !dbg !3035 ; [debug line = 94:63] [debug variable = i]
  br label %17, !dbg !3035                        ; [debug line = 94:63]

; <label>:21                                      ; preds = %17
  %22 = call i32 (...)* @_ssdm_op_SpecRegionEnd([21 x i8]* @.str8, i32 %tmp.8), !dbg !3036 ; [#uses=0 type=i32] [debug line = 95:34]
  %j.3 = add i4 %j.1, 1, !dbg !3037               ; [#uses=1 type=i4] [debug line = 92:61]
  call void @llvm.dbg.value(metadata !{i4 %j.3}, i64 0, metadata !3017), !dbg !3037 ; [debug line = 92:61] [debug variable = j]
  br label %.preheader, !dbg !3037                ; [debug line = 92:61]

; <label>:23                                      ; preds = %.preheader
  ret void, !dbg !3038                            ; [debug line = 96:1]

branch0:                                          ; preds = %8
  store i16 %row_outbuf.load, i16* %"col_inbuf[0].addr", align 2, !dbg !3007 ; [debug line = 84:1]
  br label %9, !dbg !3007                         ; [debug line = 84:1]

branch1:                                          ; preds = %8
  store i16 %row_outbuf.load, i16* %"col_inbuf[1].addr", align 2, !dbg !3007 ; [debug line = 84:1]
  br label %9, !dbg !3007                         ; [debug line = 84:1]

branch2:                                          ; preds = %8
  store i16 %row_outbuf.load, i16* %"col_inbuf[2].addr", align 2, !dbg !3007 ; [debug line = 84:1]
  br label %9, !dbg !3007                         ; [debug line = 84:1]

branch3:                                          ; preds = %8
  store i16 %row_outbuf.load, i16* %"col_inbuf[3].addr", align 2, !dbg !3007 ; [debug line = 84:1]
  br label %9, !dbg !3007                         ; [debug line = 84:1]

branch4:                                          ; preds = %8
  store i16 %row_outbuf.load, i16* %"col_inbuf[4].addr", align 2, !dbg !3007 ; [debug line = 84:1]
  br label %9, !dbg !3007                         ; [debug line = 84:1]

branch5:                                          ; preds = %8
  store i16 %row_outbuf.load, i16* %"col_inbuf[5].addr", align 2, !dbg !3007 ; [debug line = 84:1]
  br label %9, !dbg !3007                         ; [debug line = 84:1]

branch6:                                          ; preds = %8
  store i16 %row_outbuf.load, i16* %"col_inbuf[6].addr", align 2, !dbg !3007 ; [debug line = 84:1]
  br label %9, !dbg !3007                         ; [debug line = 84:1]

branch7:                                          ; preds = %8
  store i16 %row_outbuf.load, i16* %"col_inbuf[7].addr", align 2, !dbg !3007 ; [debug line = 84:1]
  br label %9, !dbg !3007                         ; [debug line = 84:1]
}
...
define internal fastcc void @read_data([64 x i16]* nocapture %input, [8 x i16]* nocapture %"buf[0]", [8 x i16]* nocapture %"buf[1]", [8 x i16]* nocapture %"buf[2]", [8 x i16]* nocapture %"buf[3]", [8 x i16]* nocapture %"buf[4]", [8 x i16]* nocapture %"buf[5]", [8 x i16]* nocapture %"buf[6]", [8 x i16]* nocapture %"buf[7]") {
  call void @llvm.dbg.value(metadata !{[64 x i16]* %input}, i64 0, metadata !3039), !dbg !3040 ; [debug line = 98:22] [debug variable = input]
  call void @llvm.dbg.value(metadata !{[8 x i16]* %"buf[0]"}, i64 0, metadata !3041), !dbg !3043 ; [debug line = 98:44] [debug variable = buf[0]]
  call void @llvm.dbg.value(metadata !{[8 x i16]* %"buf[1]"}, i64 0, metadata !3044), !dbg !3043 ; [debug line = 98:44] [debug variable = buf[1]]
  call void @llvm.dbg.value(metadata !{[8 x i16]* %"buf[2]"}, i64 0, metadata !3045), !dbg !3043 ; [debug line = 98:44] [debug variable = buf[2]]
  call void @llvm.dbg.value(metadata !{[8 x i16]* %"buf[3]"}, i64 0, metadata !3046), !dbg !3043 ; [debug line = 98:44] [debug variable = buf[3]]
  call void @llvm.dbg.value(metadata !{[8 x i16]* %"buf[4]"}, i64 0, metadata !3047), !dbg !3043 ; [debug line = 98:44] [debug variable = buf[4]]
  call void @llvm.dbg.value(metadata !{[8 x i16]* %"buf[5]"}, i64 0, metadata !3048), !dbg !3043 ; [debug line = 98:44] [debug variable = buf[5]]
  call void @llvm.dbg.value(metadata !{[8 x i16]* %"buf[6]"}, i64 0, metadata !3049), !dbg !3043 ; [debug line = 98:44] [debug variable = buf[6]]
  call void @llvm.dbg.value(metadata !{[8 x i16]* %"buf[7]"}, i64 0, metadata !3050), !dbg !3043 ; [debug line = 98:44] [debug variable = buf[7]]
  br label %1, !dbg !3051                         ; [debug line = 103:9]

; <label>:1                                       ; preds = %9, %0
  %r = phi i4 [ 0, %0 ], [ %r.1, %9 ]             ; [#uses=4 type=i4]
  %r.cast = zext i4 %r to i6, !dbg !3051          ; [#uses=1 type=i6] [debug line = 103:9]
  %exitcond1 = icmp eq i4 %r, -8, !dbg !3051      ; [#uses=1 type=i1] [debug line = 103:9]
  %2 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) ; [#uses=0 type=i32]
  br i1 %exitcond1, label %11, label %3, !dbg !3051 ; [debug line = 103:9]

; <label>:3                                       ; preds = %1
  call void (...)* @_ssdm_op_SpecLoopName([12 x i8]* @.str10) nounwind, !dbg !3054 ; [debug line = 103:67]
  %tmp.2 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @.str10), !dbg !3054 ; [#uses=1 type=i32] [debug line = 103:67]
  %tmp = shl i6 %r.cast, 3, !dbg !3056            ; [#uses=1 type=i6] [debug line = 106:1]
  %tmp. = zext i4 %r to i64, !dbg !3056           ; [#uses=8 type=i64] [debug line = 106:1]
  br label %4, !dbg !3059                         ; [debug line = 105:12]

; <label>:4                                       ; preds = %7, %3
  %c = phi i4 [ 0, %3 ], [ %c.1, %7 ]             ; [#uses=4 type=i4]
  %c.cast = zext i4 %c to i6, !dbg !3059          ; [#uses=1 type=i6] [debug line = 105:12]
  %exitcond = icmp eq i4 %c, -8, !dbg !3059       ; [#uses=1 type=i1] [debug line = 105:12]
  %5 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) ; [#uses=0 type=i32]
  br i1 %exitcond, label %9, label %6, !dbg !3059 ; [debug line = 105:12]

; <label>:6                                       ; preds = %4
  call void (...)* @_ssdm_op_SpecLoopName([12 x i8]* @.str11) nounwind, !dbg !3060 ; [debug line = 106:2]
  %tmp.3 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @.str11), !dbg !3060 ; [#uses=1 type=i32] [debug line = 106:2]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, [1 x i8]* @.str1) nounwind, !dbg !3061 ; [debug line = 107:1]
  %tmp.5 = add i6 %c.cast, %tmp, !dbg !3056       ; [#uses=1 type=i6] [debug line = 106:1]
  %tmp.6 = zext i6 %tmp.5 to i64, !dbg !3056      ; [#uses=1 type=i64] [debug line = 106:1]
  %input.addr = getelementptr [64 x i16]* %input, i64 0, i64 %tmp.6, !dbg !3056 ; [#uses=1 type=i16*] [debug line = 106:1]
  %input.load = load i16* %input.addr, align 2, !dbg !3056 ; [#uses=8 type=i16] [debug line = 106:1]
  %c.t = trunc i4 %c to i3                        ; [#uses=1 type=i3]
  %"buf[0].addr" = getelementptr [8 x i16]* %"buf[0]", i64 0, i64 %tmp., !dbg !3056 ; [#uses=1 type=i16*] [debug line = 106:1]
  %"buf[1].addr" = getelementptr [8 x i16]* %"buf[1]", i64 0, i64 %tmp., !dbg !3056 ; [#uses=1 type=i16*] [debug line = 106:1]
  %"buf[2].addr" = getelementptr [8 x i16]* %"buf[2]", i64 0, i64 %tmp., !dbg !3056 ; [#uses=1 type=i16*] [debug line = 106:1]
  %"buf[3].addr" = getelementptr [8 x i16]* %"buf[3]", i64 0, i64 %tmp., !dbg !3056 ; [#uses=1 type=i16*] [debug line = 106:1]
  %"buf[4].addr" = getelementptr [8 x i16]* %"buf[4]", i64 0, i64 %tmp., !dbg !3056 ; [#uses=1 type=i16*] [debug line = 106:1]
  %"buf[5].addr" = getelementptr [8 x i16]* %"buf[5]", i64 0, i64 %tmp., !dbg !3056 ; [#uses=1 type=i16*] [debug line = 106:1]
  %"buf[6].addr" = getelementptr [8 x i16]* %"buf[6]", i64 0, i64 %tmp., !dbg !3056 ; [#uses=1 type=i16*] [debug line = 106:1]
  %"buf[7].addr" = getelementptr [8 x i16]* %"buf[7]", i64 0, i64 %tmp., !dbg !3056 ; [#uses=1 type=i16*] [debug line = 106:1]
  switch i3 %c.t, label %branch7 [
    ...
    i3 -3, label %branch5
    i3 -2, label %branch6
  ], !dbg !3056                                   ; [debug line = 106:1]

; <label>:7                                       ; preds = %branch7, %branch6, %branch5, %branch4, %branch3, %branch2, %branch1, %branch0
  %8 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @.str11, i32 %tmp.3), !dbg !3062 ; [#uses=0 type=i32] [debug line = 106:66]
  %c.1 = add i4 %c, 1, !dbg !3063                 ; [#uses=1 type=i4] [debug line = 105:64]
  call void @llvm.dbg.value(metadata !{i4 %c.1}, i64 0, metadata !3064), !dbg !3063 ; [debug line = 105:64] [debug variable = c]
  br label %4, !dbg !3063                         ; [debug line = 105:64]

; <label>:9                                       ; preds = %4
  %10 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @.str10, i32 %tmp.2), !dbg !3065 ; [#uses=0 type=i32] [debug line = 107:4]
  %r.1 = add i4 %r, 1, !dbg !3066                 ; [#uses=1 type=i4] [debug line = 103:61]
  call void @llvm.dbg.value(metadata !{i4 %r.1}, i64 0, metadata !3067), !dbg !3066 ; [debug line = 103:61] [debug variable = r]
  br label %1, !dbg !3066                         ; [debug line = 103:61]

; <label>:11                                      ; preds = %1
  ret void, !dbg !3068                            ; [debug line = 108:1]

branch0:                                          ; preds = %6
  store i16 %input.load, i16* %"buf[0].addr", align 2, !dbg !3056 ; [debug line = 106:1]
  br label %7, !dbg !3056                         ; [debug line = 106:1]

branch1:                                          ; preds = %6
  store i16 %input.load, i16* %"buf[1].addr", align 2, !dbg !3056 ; [debug line = 106:1]
  br label %7, !dbg !3056                         ; [debug line = 106:1]

branch2:                                          ; preds = %6
  store i16 %input.load, i16* %"buf[2].addr", align 2, !dbg !3056 ; [debug line = 106:1]
  br label %7, !dbg !3056                         ; [debug line = 106:1]

branch3:                                          ; preds = %6
  store i16 %input.load, i16* %"buf[3].addr", align 2, !dbg !3056 ; [debug line = 106:1]
  br label %7, !dbg !3056                         ; [debug line = 106:1]

branch4:                                          ; preds = %6
  store i16 %input.load, i16* %"buf[4].addr", align 2, !dbg !3056 ; [debug line = 106:1]
  br label %7, !dbg !3056                         ; [debug line = 106:1]

branch5:                                          ; preds = %6
  store i16 %input.load, i16* %"buf[5].addr", align 2, !dbg !3056 ; [debug line = 106:1]
  br label %7, !dbg !3056                         ; [debug line = 106:1]

branch6:                                          ; preds = %6
  store i16 %input.load, i16* %"buf[6].addr", align 2, !dbg !3056 ; [debug line = 106:1]
  br label %7, !dbg !3056                         ; [debug line = 106:1]

branch7:                                          ; preds = %6
  store i16 %input.load, i16* %"buf[7].addr", align 2, !dbg !3056 ; [debug line = 106:1]
  br label %7, !dbg !3056                         ; [debug line = 106:1]
}
...
define internal fastcc void @dct_1d([8 x i16]* nocapture %src, [8 x i16]* nocapture %src1, [8 x i16]* nocapture %src2, [8 x i16]* nocapture %src3, [8 x i16]* nocapture %src4, [8 x i16]* nocapture %src5, [8 x i16]* nocapture %src6, [8 x i16]* nocapture %src7, i4 %tmp.1, [8 x [8 x i16]]* nocapture %dst, i4 %tmp.11) {
  call void (...)* @_ssdm_SpecKeepAssert(i4 %tmp.1), !hlsrange !3069
  call void (...)* @_ssdm_SpecKeepAssert(i4 %tmp.11), !hlsrange !3069
  %tmp.11.cast = zext i4 %tmp.11 to i64           ; [#uses=1 type=i64]
  %tmp.1.cast = zext i4 %tmp.1 to i64             ; [#uses=8 type=i64]
  call void @llvm.dbg.value(metadata !{[8 x [8 x i16]]* %dst}, i64 0, metadata !3070), !dbg !3072 ; [debug line = 48:81] [debug variable = dst]
  br label %1, !dbg !3073                         ; [debug line = 57:9]

; <label>:1                                       ; preds = %3, %0
  %k = phi i4 [ 0, %0 ], [ %k.1, %3 ]             ; [#uses=3 type=i4]
  %exitcond1 = icmp eq i4 %k, -8, !dbg !3073      ; [#uses=1 type=i1] [debug line = 57:9]
  %2 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) ; [#uses=0 type=i32]
  br i1 %exitcond1, label %5, label %3, !dbg !3073 ; [debug line = 57:9]

; <label>:3                                       ; preds = %1
  call void (...)* @_ssdm_op_SpecLoopName([15 x i8]* @.str) nounwind, !dbg !3076 ; [debug line = 57:67]
  %tmp. = call i32 (...)* @_ssdm_op_SpecRegionBegin([15 x i8]* @.str) nounwind, !dbg !3076 ; [#uses=1 type=i32] [debug line = 57:67]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, [1 x i8]* @.str1) nounwind, !dbg !3078 ; [debug line = 58:1]
  %tmp = zext i4 %k to i64, !dbg !3079            ; [#uses=9 type=i64] [debug line = 60:48]
  %dct_coeff_table.0.addr = getelementptr [8 x i14]* @dct_coeff_table.0, i64 0, i64 %tmp, !dbg !3079 ; [#uses=1 type=i14*] [debug line = 60:48]
  %dct_coeff_table.0.load = load i14* %dct_coeff_table.0.addr, align 2, !dbg !3079 ; [#uses=1 type=i14] [debug line = 60:48]
  ...
  %tmp.7.cast = sext i16 %src.load to i29, !dbg !3082 ; [#uses=1 type=i29] [debug line = 61:10]
  %tmp.8 = mul i29 %coeff.cast, %tmp.7.cast, !dbg !3082 ; [#uses=1 type=i29] [debug line = 61:10]
  %dct_coeff_table.1.addr = getelementptr [8 x i15]* @dct_coeff_table.1, i64 0, i64 %tmp, !dbg !3079 ; [#uses=1 type=i15*] [debug line = 60:48]
  %dct_coeff_table.1.load = load i15* %dct_coeff_table.1.addr, align 2, !dbg !3079 ; [#uses=1 type=i15] [debug line = 60:48]
  ...
  %tmp.7.1.cast = sext i16 %src1.load to i29, !dbg !3082 ; [#uses=1 type=i29] [debug line = 61:10]
  %tmp.8.1 = mul i29 %coeff.1.cast, %tmp.7.1.cast, !dbg !3082 ; [#uses=1 type=i29] [debug line = 61:10]
  %dct_coeff_table.2.addr = getelementptr [8 x i15]* @dct_coeff_table.2, i64 0, i64 %tmp, !dbg !3079 ; [#uses=1 type=i15*] [debug line = 60:48]
  %dct_coeff_table.2.load = load i15* %dct_coeff_table.2.addr, align 2, !dbg !3079 ; [#uses=1 type=i15] [debug line = 60:48]
  ...
  %tmp.7.2.cast = sext i16 %src2.load to i29, !dbg !3082 ; [#uses=1 type=i29] [debug line = 61:10]
  %tmp.8.2 = mul i29 %coeff.2.cast, %tmp.7.2.cast, !dbg !3082 ; [#uses=1 type=i29] [debug line = 61:10]
  %dct_coeff_table.3.addr = getelementptr [8 x i15]* @dct_coeff_table.3, i64 0, i64 %tmp, !dbg !3079 ; [#uses=1 type=i15*] [debug line = 60:48]
  %dct_coeff_table.3.load = load i15* %dct_coeff_table.3.addr, align 2, !dbg !3079 ; [#uses=1 type=i15] [debug line = 60:48]
  ...
  %tmp.7.3.cast = sext i16 %src3.load to i29, !dbg !3082 ; [#uses=1 type=i29] [debug line = 61:10]
  %tmp.8.3 = mul i29 %coeff.3.cast, %tmp.7.3.cast, !dbg !3082 ; [#uses=1 type=i29] [debug line = 61:10]
  %dct_coeff_table.4.addr = getelementptr [8 x i15]* @dct_coeff_table.4, i64 0, i64 %tmp, !dbg !3079 ; [#uses=1 type=i15*] [debug line = 60:48]
  %dct_coeff_table.4.load = load i15* %dct_coeff_table.4.addr, align 2, !dbg !3079 ; [#uses=1 type=i15] [debug line = 60:48]
  ...
  %tmp.7.4.cast = sext i16 %src4.load to i29, !dbg !3082 ; [#uses=1 type=i29] [debug line = 61:10]
  %tmp.8.4 = mul i29 %coeff.4.cast, %tmp.7.4.cast, !dbg !3082 ; [#uses=1 type=i29] [debug line = 61:10]
  %dct_coeff_table.5.addr = getelementptr [8 x i15]* @dct_coeff_table.5, i64 0, i64 %tmp, !dbg !3079 ; [#uses=1 type=i15*] [debug line = 60:48]
  %dct_coeff_table.5.load = load i15* %dct_coeff_table.5.addr, align 2, !dbg !3079 ; [#uses=1 type=i15] [debug line = 60:48]
  ...
  %tmp.7.5.cast = sext i16 %src5.load to i29, !dbg !3082 ; [#uses=1 type=i29] [debug line = 61:10]
  %tmp.8.5 = mul i29 %coeff.5.cast, %tmp.7.5.cast, !dbg !3082 ; [#uses=1 type=i29] [debug line = 61:10]
  %dct_coeff_table.6.addr = getelementptr [8 x i15]* @dct_coeff_table.6, i64 0, i64 %tmp, !dbg !3079 ; [#uses=1 type=i15*] [debug line = 60:48]
  %dct_coeff_table.6.load = load i15* %dct_coeff_table.6.addr, align 2, !dbg !3079 ; [#uses=1 type=i15] [debug line = 60:48]
  ...
  %tmp.7.6.cast = sext i16 %src6.load to i29, !dbg !3082 ; [#uses=1 type=i29] [debug line = 61:10]
  %tmp.8.6 = mul i29 %coeff.6.cast, %tmp.7.6.cast, !dbg !3082 ; [#uses=1 type=i29] [debug line = 61:10]
  %dct_coeff_table.7.addr = getelementptr [8 x i15]* @dct_coeff_table.7, i64 0, i64 %tmp, !dbg !3079 ; [#uses=1 type=i15*] [debug line = 60:48]
  %dct_coeff_table.7.load = load i15* %dct_coeff_table.7.addr, align 2, !dbg !3079 ; [#uses=1 type=i15] [debug line = 60:48]
  ...
  %tmp.7.7.cast = sext i16 %src7.load to i29, !dbg !3082 ; [#uses=1 type=i29] [debug line = 61:10]
  %tmp.8.7 = mul i29 %coeff.7.cast, %tmp.7.7.cast, !dbg !3082 ; [#uses=1 type=i29] [debug line = 61:10]
  %tmp2 = add i29 %tmp.8.1, %tmp.8, !dbg !3083    ; [#uses=1 type=i29] [debug line = 63:7]
  %tmp3 = add i29 %tmp.8.3, %tmp.8.2, !dbg !3083  ; [#uses=1 type=i29] [debug line = 63:7]
  %tmp1 = add i29 %tmp2, %tmp3, !dbg !3083        ; [#uses=1 type=i29] [debug line = 63:7]
  %tmp5 = add i29 %tmp.8.5, %tmp.8.4, !dbg !3083  ; [#uses=1 type=i29] [debug line = 63:7]
  %tmp7 = add i29 %tmp.8.7, 4096, !dbg !3083      ; [#uses=1 type=i29] [debug line = 63:7]
  %tmp6 = add i29 %tmp.8.6, %tmp7, !dbg !3083     ; [#uses=1 type=i29] [debug line = 63:7]
  %tmp4 = add i29 %tmp5, %tmp6, !dbg !3083        ; [#uses=1 type=i29] [debug line = 63:7]
  %tmp.2 = add i29 %tmp1, %tmp4, !dbg !3083       ; [#uses=1 type=i29] [debug line = 63:7]
  %tmp.3 = lshr i29 %tmp.2, 13, !dbg !3083        ; [#uses=1 type=i29] [debug line = 63:7]
  %tmp.4 = trunc i29 %tmp.3 to i16, !dbg !3083    ; [#uses=1 type=i16] [debug line = 63:7]
  %dst.addr = getelementptr [8 x [8 x i16]]* %dst, i64 0, i64 %tmp.11.cast, i64 %tmp, !dbg !3083 ; [#uses=1 type=i16*] [debug line = 63:7]
  store i16 %tmp.4, i16* %dst.addr, align 2, !dbg !3083 ; [debug line = 63:7]
  %4 = call i32 (...)* @_ssdm_op_SpecRegionEnd([15 x i8]* @.str, i32 %tmp.) nounwind, !dbg !3084 ; [#uses=0 type=i32] [debug line = 64:4]
  %k.1 = add i4 %k, 1, !dbg !3085                 ; [#uses=1 type=i4] [debug line = 57:61]
  call void @llvm.dbg.value(metadata !{i4 %k.1}, i64 0, metadata !3086), !dbg !3085 ; [debug line = 57:61] [debug variable = k]
  br label %1, !dbg !3085                         ; [debug line = 57:61]

; <label>:5                                       ; preds = %1
  ret void, !dbg !3087                            ; [debug line = 65:1]
}
...
!1795 = metadata !{i32 786478, i32 0, metadata !1557, metadata !"_M_insert<unsigned long>", metadata !"_M_insert<unsigned long>", metadata !"_ZNSo9_M_insertImEERSoT_", metadata !1563, i32 365, metadata !1724, i1 false, i1 false, i32 0, i32 0, null, i32 258, i1 false, null, metadata !1796, i32 0, metadata !86, i32 365} ; [ DW_TAG_subprogram ]
!1796 = metadata !{metadata !1797}
!1797 = metadata !{i32 786479, null, metadata !"_ValueT", metadata !983, null, i32 0, i32 0} ; [ DW_TAG_template_type_parameter ]
!1798 = metadata !{i32 786478, i32 0, metadata !1557, metadata !"_M_insert<long long>", metadata !"_M_insert<long long>", metadata !"_ZNSo9_M_insertIxEERSoT_", metadata !1563, i32 365, metadata !1742, i1 false, i1 false, i32 0, i32 0, null, i32 258, i1 false, null, metadata !1799, i32 0, metadata !86, i32 365} ; [ DW_TAG_subprogram ]
!1799 = metadata !{metadata !1800}
!1800 = metadata !{i32 786479, null, metadata !"_ValueT", metadata !61, null, i32 0, i32 0} ; [ DW_TAG_template_type_parameter ]
...
!1803 = metadata !{i32 786479, null, metadata !"_ValueT", metadata !138, null, i32 0, i32 0} ; [ DW_TAG_template_type_parameter ]
!1804 = metadata !{i32 786478, i32 0, metadata !1557, metadata !"_M_insert<const void *>", metadata !"_M_insert<const void *>", metadata !"_ZNSo9_M_insertIPKvEERSoT_", metadata !1563, i32 365, metadata !1760, i1 false, i1 false, i32 0, i32 0, null, i32 258, i1 false, null, metadata !1805, i32 0, metadata !86, i32 365} ; [ DW_TAG_subprogram ]
!1805 = metadata !{metadata !1806}
!1806 = metadata !{i32 786479, null, metadata !"_ValueT", metadata !325, null, i32 0, i32 0} ; [ DW_TAG_template_type_parameter ]
!1807 = metadata !{i32 786478, i32 0, metadata !1557, metadata !"_M_insert<long double>", metadata !"_M_insert<long double>", metadata !"_ZNSo9_M_insertIeEERSoT_", metadata !1563, i32 365, metadata !1756, i1 false, i1 false, i32 0, i32 0, null, i32 258, i1 false, null, metadata !1808, i32 0, metadata !86, i32 365} ; [ DW_TAG_subprogram ]
!1808 = metadata !{metadata !1809}
!1809 = metadata !{i32 786479, null, metadata !"_ValueT", metadata !1758, null, i32 0, i32 0} ; [ DW_TAG_template_type_parameter ]
!1810 = metadata !{i32 786478, i32 0, metadata !1557, metadata !"_M_insert<long>", metadata !"_M_insert<long>", metadata !"_ZNSo9_M_insertIlEERSoT_", metadata !1563, i32 365, metadata !1721, i1 false, i1 false, i32 0, i32 0, null, i32 258, i1 false, null, metadata !1811, i32 0, metadata !86, i32 365} ; [ DW_TAG_subprogram ]
!1811 = metadata !{metadata !1812}
!1812 = metadata !{i32 786479, null, metadata !"_ValueT", metadata !100, null, i32 0, i32 0} ; [ DW_TAG_template_type_parameter ]
...
!2189 = metadata !{i32 786478, i32 0, metadata !1546, metadata !"_M_extract<unsigned long>", metadata !"_M_extract<unsigned long>", metadata !"_ZNSi10_M_extractImEERSiRT_", metadata !2053, i32 587, metadata !2102, i1 false, i1 false, i32 0, i32 0, null, i32 258, i1 false, null, metadata !1796, i32 0, metadata !86, i32 587} ; [ DW_TAG_subprogram ]
!2190 = metadata !{i32 786478, i32 0, metadata !1546, metadata !"_M_extract<long long>", metadata !"_M_extract<long long>", metadata !"_ZNSi10_M_extractIxEERSiRT_", metadata !2053, i32 587, metadata !2105, i1 false, i1 false, i32 0, i32 0, null, i32 258, i1 false, null, metadata !1799, i32 0, metadata !86, i32 587} ; [ DW_TAG_subprogram ]
...
!2192 = metadata !{i32 786478, i32 0, metadata !1546, metadata !"_M_extract<long double>", metadata !"_M_extract<long double>", metadata !"_ZNSi10_M_extractIeEERSiRT_", metadata !2053, i32 587, metadata !2117, i1 false, i1 false, i32 0, i32 0, null, i32 258, i1 false, null, metadata !1808, i32 0, metadata !86, i32 587} ; [ DW_TAG_subprogram ]
!2193 = metadata !{i32 786478, i32 0, metadata !1546, metadata !"_M_extract<long>", metadata !"_M_extract<long>", metadata !"_ZNSi10_M_extractIlEERSiRT_", metadata !2053, i32 587, metadata !2099, i1 false, i1 false, i32 0, i32 0, null, i32 258, i1 false, null, metadata !1811, i32 0, metadata !86, i32 587} ; [ DW_TAG_subprogram ]
...
!2196 = metadata !{i32 786479, null, metadata !"_ValueT", metadata !992, null, i32 0, i32 0} ; [ DW_TAG_template_type_parameter ]
!2197 = metadata !{i32 786478, i32 0, metadata !1546, metadata !"_M_extract<double>", metadata !"_M_extract<double>", metadata !"_ZNSi10_M_extractIdEERSiRT_", metadata !2053, i32 587, metadata !2114, i1 false, i1 false, i32 0, i32 0, null, i32 258, i1 false, null, metadata !1814, i32 0, metadata !86, i32 587} ; [ DW_TAG_subprogram ]
!2198 = metadata !{i32 786478, i32 0, metadata !1546, metadata !"_M_extract<unsigned int>", metadata !"_M_extract<unsigned int>", metadata !"_ZNSi10_M_extractIjEERSiRT_", metadata !2053, i32 587, metadata !2096, i1 false, i1 false, i32 0, i32 0, null, i32 258, i1 false, null, metadata !2199, i32 0, metadata !86, i32 587} ; [ DW_TAG_subprogram ]
!2199 = metadata !{metadata !2200}
!2200 = metadata !{i32 786479, null, metadata !"_ValueT", metadata !979, null, i32 0, i32 0} ; [ DW_TAG_template_type_parameter ]
!2201 = metadata !{i32 786478, i32 0, metadata !1546, metadata !"_M_extract<float>", metadata !"_M_extract<float>", metadata !"_ZNSi10_M_extractIfEERSiRT_", metadata !2053, i32 587, metadata !2111, i1 false, i1 false, i32 0, i32 0, null, i32 258, i1 false, null, metadata !2202, i32 0, metadata !86, i32 587} ; [ DW_TAG_subprogram ]
!2202 = metadata !{metadata !2203}
!2203 = metadata !{i32 786479, null, metadata !"_ValueT", metadata !1754, null, i32 0, i32 0} ; [ DW_TAG_template_type_parameter ]
!2204 = metadata !{i32 786478, i32 0, metadata !1546, metadata !"_M_extract<void *>", metadata !"_M_extract<void *>", metadata !"_ZNSi10_M_extractIPvEERSiRT_", metadata !2053, i32 587, metadata !2120, i1 false, i1 false, i32 0, i32 0, null, i32 258, i1 false, null, metadata !2205, i32 0, metadata !86, i32 587} ; [ DW_TAG_subprogram ]
!2205 = metadata !{metadata !2206}
!2206 = metadata !{i32 786479, null, metadata !"_ValueT", metadata !98, null, i32 0, i32 0} ; [ DW_TAG_template_type_parameter ]
...
!2931 = metadata !{i32 790529, metadata !2932, metadata !"buf_2d_in[0]", null, i32 124, metadata !2934, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2932 = metadata !{i32 786688, metadata !2913, metadata !"buf_2d_in", metadata !876, i32 124, metadata !2933, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2933 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 1024, i64 16, i32 0, i32 0, metadata !881, metadata !904, i32 0, i32 0} ; [ DW_TAG_array_type ]
!2934 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 128, i64 16, i32 0, i32 0, metadata !881, metadata !904, i32 0, i32 0} ; [ DW_TAG_array_type ]
!2935 = metadata !{i32 124, i32 10, metadata !2913, null}
!2936 = metadata !{i32 790529, metadata !2932, metadata !"buf_2d_in[1]", null, i32 124, metadata !2934, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2937 = metadata !{i32 790529, metadata !2932, metadata !"buf_2d_in[2]", null, i32 124, metadata !2934, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2938 = metadata !{i32 790529, metadata !2932, metadata !"buf_2d_in[3]", null, i32 124, metadata !2934, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2939 = metadata !{i32 790529, metadata !2932, metadata !"buf_2d_in[4]", null, i32 124, metadata !2934, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2940 = metadata !{i32 790529, metadata !2932, metadata !"buf_2d_in[5]", null, i32 124, metadata !2934, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2941 = metadata !{i32 790529, metadata !2932, metadata !"buf_2d_in[6]", null, i32 124, metadata !2934, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2942 = metadata !{i32 790529, metadata !2932, metadata !"buf_2d_in[7]", null, i32 124, metadata !2934, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2943 = metadata !{i32 786688, metadata !2913, metadata !"buf_2d_out", metadata !876, i32 125, metadata !2933, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2944 = metadata !{i32 125, i32 10, metadata !2913, null}
!2945 = metadata !{i32 128, i32 4, metadata !2913, null}
!2946 = metadata !{i32 130, i32 4, metadata !2913, null}
!2947 = metadata !{i32 133, i32 4, metadata !2913, null}
!2948 = metadata !{i32 134, i32 1, metadata !2913, null}
!2949 = metadata !{i32 786689, metadata !893, metadata !"buf", null, i32 110, metadata !2933, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2950 = metadata !{i32 110, i32 23, metadata !893, null}
!2951 = metadata !{i32 786689, metadata !893, metadata !"output", null, i32 110, metadata !2925, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2952 = metadata !{i32 110, i32 116, metadata !893, null}
!2953 = metadata !{i32 115, i32 9, metadata !2954, null}
!2954 = metadata !{i32 786443, metadata !2955, i32 115, i32 4, metadata !876, i32 24} ; [ DW_TAG_lexical_block ]
!2955 = metadata !{i32 786443, metadata !893, i32 111, i32 1, metadata !876, i32 23} ; [ DW_TAG_lexical_block ]
!2956 = metadata !{i32 115, i32 67, metadata !2957, null}
!2957 = metadata !{i32 786443, metadata !2954, i32 115, i32 66, metadata !876, i32 25} ; [ DW_TAG_lexical_block ]
!2958 = metadata !{i32 118, i32 1, metadata !2959, null}
!2959 = metadata !{i32 786443, metadata !2960, i32 118, i32 1, metadata !876, i32 27} ; [ DW_TAG_lexical_block ]
!2960 = metadata !{i32 786443, metadata !2957, i32 117, i32 7, metadata !876, i32 26} ; [ DW_TAG_lexical_block ]
!2961 = metadata !{i32 117, i32 12, metadata !2960, null}
!2962 = metadata !{i32 118, i32 2, metadata !2959, null}
!2963 = metadata !{i32 119, i32 1, metadata !2959, null}
!2964 = metadata !{i32 118, i32 67, metadata !2959, null}
!2965 = metadata !{i32 117, i32 64, metadata !2960, null}
!2966 = metadata !{i32 786688, metadata !2955, metadata !"c", metadata !876, i32 112, metadata !55, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2967 = metadata !{i32 119, i32 4, metadata !2957, null}
!2968 = metadata !{i32 115, i32 61, metadata !2954, null}
!2969 = metadata !{i32 786688, metadata !2955, metadata !"r", metadata !876, i32 112, metadata !55, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2970 = metadata !{i32 120, i32 1, metadata !2955, null}
!2971 = metadata !{i32 790531, metadata !2972, metadata !"in_block[0]", null, i32 67, metadata !2974, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2972 = metadata !{i32 786689, metadata !882, metadata !"in_block", null, i32 67, metadata !2973, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2973 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 1024, i64 16, i32 0, i32 0, metadata !880, metadata !904, i32 0, i32 0} ; [ DW_TAG_array_type ]
!2974 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 128, i64 16, i32 0, i32 0, metadata !880, metadata !904, i32 0, i32 0} ; [ DW_TAG_array_type ]
!2975 = metadata !{i32 67, i32 24, metadata !882, null}
!2976 = metadata !{i32 790531, metadata !2972, metadata !"in_block[1]", null, i32 67, metadata !2974, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2977 = metadata !{i32 790531, metadata !2972, metadata !"in_block[2]", null, i32 67, metadata !2974, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2978 = metadata !{i32 790531, metadata !2972, metadata !"in_block[3]", null, i32 67, metadata !2974, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2979 = metadata !{i32 790531, metadata !2972, metadata !"in_block[4]", null, i32 67, metadata !2974, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2980 = metadata !{i32 790531, metadata !2972, metadata !"in_block[5]", null, i32 67, metadata !2974, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2981 = metadata !{i32 790531, metadata !2972, metadata !"in_block[6]", null, i32 67, metadata !2974, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2982 = metadata !{i32 790531, metadata !2972, metadata !"in_block[7]", null, i32 67, metadata !2974, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2983 = metadata !{i32 786689, metadata !882, metadata !"out_block", null, i32 68, metadata !2973, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2984 = metadata !{i32 68, i32 18, metadata !882, null}
!2985 = metadata !{i32 790529, metadata !2986, metadata !"col_inbuf[0]", null, i32 71, metadata !2974, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2986 = metadata !{i32 786688, metadata !2987, metadata !"col_inbuf", metadata !876, i32 71, metadata !2973, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2987 = metadata !{i32 786443, metadata !882, i32 69, i32 1, metadata !876, i32 5} ; [ DW_TAG_lexical_block ]
!2988 = metadata !{i32 71, i32 109, metadata !2987, null}
!2989 = metadata !{i32 790529, metadata !2986, metadata !"col_inbuf[1]", null, i32 71, metadata !2974, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2990 = metadata !{i32 790529, metadata !2986, metadata !"col_inbuf[2]", null, i32 71, metadata !2974, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2991 = metadata !{i32 790529, metadata !2986, metadata !"col_inbuf[3]", null, i32 71, metadata !2974, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2992 = metadata !{i32 790529, metadata !2986, metadata !"col_inbuf[4]", null, i32 71, metadata !2974, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2993 = metadata !{i32 790529, metadata !2986, metadata !"col_inbuf[5]", null, i32 71, metadata !2974, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2994 = metadata !{i32 790529, metadata !2986, metadata !"col_inbuf[6]", null, i32 71, metadata !2974, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2995 = metadata !{i32 790529, metadata !2986, metadata !"col_inbuf[7]", null, i32 71, metadata !2974, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2996 = metadata !{i32 76, i32 8, metadata !2997, null}
!2997 = metadata !{i32 786443, metadata !2987, i32 76, i32 4, metadata !876, i32 6} ; [ DW_TAG_lexical_block ]
!2998 = metadata !{i32 76, i32 66, metadata !2999, null}
!2999 = metadata !{i32 786443, metadata !2997, i32 76, i32 65, metadata !876, i32 7} ; [ DW_TAG_lexical_block ]
!3000 = metadata !{i32 77, i32 7, metadata !2999, null}
!3001 = metadata !{i32 76, i32 60, metadata !2997, null}
!3002 = metadata !{i32 786688, metadata !2987, metadata !"i", metadata !876, i32 72, metadata !979, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3003 = metadata !{i32 81, i32 9, metadata !3004, null}
!3004 = metadata !{i32 786443, metadata !2987, i32 81, i32 4, metadata !876, i32 8} ; [ DW_TAG_lexical_block ]
!3005 = metadata !{i32 82, i32 1, metadata !3006, null}
!3006 = metadata !{i32 786443, metadata !3004, i32 82, i32 1, metadata !876, i32 9} ; [ DW_TAG_lexical_block ]
!3007 = metadata !{i32 84, i32 1, metadata !3008, null}
!3008 = metadata !{i32 786443, metadata !3009, i32 84, i32 1, metadata !876, i32 11} ; [ DW_TAG_lexical_block ]
!3009 = metadata !{i32 786443, metadata !3006, i32 83, i32 7, metadata !876, i32 10} ; [ DW_TAG_lexical_block ]
!3010 = metadata !{i32 83, i32 11, metadata !3009, null}
!3011 = metadata !{i32 84, i32 2, metadata !3008, null}
!3012 = metadata !{i32 85, i32 1, metadata !3008, null}
!3013 = metadata !{i32 84, i32 34, metadata !3008, null}
!3014 = metadata !{i32 83, i32 63, metadata !3009, null}
!3015 = metadata !{i32 84, i32 34, metadata !3009, null}
!3016 = metadata !{i32 81, i32 61, metadata !3004, null}
!3017 = metadata !{i32 786688, metadata !2987, metadata !"j", metadata !876, i32 72, metadata !979, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3018 = metadata !{i32 87, i32 9, metadata !3019, null}
!3019 = metadata !{i32 786443, metadata !2987, i32 87, i32 4, metadata !876, i32 12} ; [ DW_TAG_lexical_block ]
!3020 = metadata !{i32 87, i32 67, metadata !3021, null}
!3021 = metadata !{i32 786443, metadata !3019, i32 87, i32 66, metadata !876, i32 13} ; [ DW_TAG_lexical_block ]
!3022 = metadata !{i32 88, i32 7, metadata !3021, null}
!3023 = metadata !{i32 87, i32 61, metadata !3019, null}
!3024 = metadata !{i32 92, i32 9, metadata !3025, null}
!3025 = metadata !{i32 786443, metadata !2987, i32 92, i32 4, metadata !876, i32 14} ; [ DW_TAG_lexical_block ]
!3026 = metadata !{i32 93, i32 1, metadata !3027, null}
!3027 = metadata !{i32 786443, metadata !3025, i32 93, i32 1, metadata !876, i32 15} ; [ DW_TAG_lexical_block ]
!3028 = metadata !{i32 95, i32 1, metadata !3029, null}
!3029 = metadata !{i32 786443, metadata !3030, i32 95, i32 1, metadata !876, i32 17} ; [ DW_TAG_lexical_block ]
!3030 = metadata !{i32 786443, metadata !3027, i32 94, i32 7, metadata !876, i32 16} ; [ DW_TAG_lexical_block ]
!3031 = metadata !{i32 94, i32 11, metadata !3030, null}
!3032 = metadata !{i32 95, i32 2, metadata !3029, null}
!3033 = metadata !{i32 96, i32 1, metadata !3029, null}
!3034 = metadata !{i32 95, i32 34, metadata !3029, null}
!3035 = metadata !{i32 94, i32 63, metadata !3030, null}
!3036 = metadata !{i32 95, i32 34, metadata !3030, null}
!3037 = metadata !{i32 92, i32 61, metadata !3025, null}
!3038 = metadata !{i32 96, i32 1, metadata !2987, null}
!3039 = metadata !{i32 786689, metadata !887, metadata !"input", null, i32 98, metadata !2925, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3040 = metadata !{i32 98, i32 22, metadata !887, null}
!3041 = metadata !{i32 790531, metadata !3042, metadata !"buf[0]", null, i32 98, metadata !2934, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!3042 = metadata !{i32 786689, metadata !887, metadata !"buf", null, i32 98, metadata !2933, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3043 = metadata !{i32 98, i32 44, metadata !887, null}
!3044 = metadata !{i32 790531, metadata !3042, metadata !"buf[1]", null, i32 98, metadata !2934, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!3045 = metadata !{i32 790531, metadata !3042, metadata !"buf[2]", null, i32 98, metadata !2934, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!3046 = metadata !{i32 790531, metadata !3042, metadata !"buf[3]", null, i32 98, metadata !2934, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!3047 = metadata !{i32 790531, metadata !3042, metadata !"buf[4]", null, i32 98, metadata !2934, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!3048 = metadata !{i32 790531, metadata !3042, metadata !"buf[5]", null, i32 98, metadata !2934, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!3049 = metadata !{i32 790531, metadata !3042, metadata !"buf[6]", null, i32 98, metadata !2934, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!3050 = metadata !{i32 790531, metadata !3042, metadata !"buf[7]", null, i32 98, metadata !2934, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!3051 = metadata !{i32 103, i32 9, metadata !3052, null}
!3052 = metadata !{i32 786443, metadata !3053, i32 103, i32 4, metadata !876, i32 19} ; [ DW_TAG_lexical_block ]
!3053 = metadata !{i32 786443, metadata !887, i32 99, i32 1, metadata !876, i32 18} ; [ DW_TAG_lexical_block ]
!3054 = metadata !{i32 103, i32 67, metadata !3055, null}
!3055 = metadata !{i32 786443, metadata !3052, i32 103, i32 66, metadata !876, i32 20} ; [ DW_TAG_lexical_block ]
!3056 = metadata !{i32 106, i32 1, metadata !3057, null}
!3057 = metadata !{i32 786443, metadata !3058, i32 106, i32 1, metadata !876, i32 22} ; [ DW_TAG_lexical_block ]
!3058 = metadata !{i32 786443, metadata !3055, i32 105, i32 7, metadata !876, i32 21} ; [ DW_TAG_lexical_block ]
!3059 = metadata !{i32 105, i32 12, metadata !3058, null}
!3060 = metadata !{i32 106, i32 2, metadata !3057, null}
!3061 = metadata !{i32 107, i32 1, metadata !3057, null}
!3062 = metadata !{i32 106, i32 66, metadata !3057, null}
!3063 = metadata !{i32 105, i32 64, metadata !3058, null}
!3064 = metadata !{i32 786688, metadata !3053, metadata !"c", metadata !876, i32 100, metadata !55, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3065 = metadata !{i32 107, i32 4, metadata !3055, null}
!3066 = metadata !{i32 103, i32 61, metadata !3052, null}
!3067 = metadata !{i32 786688, metadata !3053, metadata !"r", metadata !876, i32 100, metadata !55, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3068 = metadata !{i32 108, i32 1, metadata !3053, null}
!3069 = metadata !{i4 0, i4 7, i4 0, i4 7}        
!3070 = metadata !{i32 786689, metadata !875, metadata !"dst", null, i32 48, metadata !3071, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!3071 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 0, i64 0, i32 0, i32 0, metadata !880, metadata !107, i32 0, i32 0} ; [ DW_TAG_array_type ]
!3072 = metadata !{i32 48, i32 81, metadata !875, null}
!3073 = metadata !{i32 57, i32 9, metadata !3074, null}
!3074 = metadata !{i32 786443, metadata !3075, i32 57, i32 4, metadata !876, i32 1} ; [ DW_TAG_lexical_block ]
!3075 = metadata !{i32 786443, metadata !875, i32 49, i32 1, metadata !876, i32 0} ; [ DW_TAG_lexical_block ]
!3076 = metadata !{i32 57, i32 67, metadata !3077, null}
!3077 = metadata !{i32 786443, metadata !3074, i32 57, i32 66, metadata !876, i32 2} ; [ DW_TAG_lexical_block ]
!3078 = metadata !{i32 58, i32 1, metadata !3077, null}
!3079 = metadata !{i32 60, i32 48, metadata !3080, null}
!3080 = metadata !{i32 786443, metadata !3081, i32 59, i32 77, metadata !876, i32 4} ; [ DW_TAG_lexical_block ]
!3081 = metadata !{i32 786443, metadata !3077, i32 59, i32 7, metadata !876, i32 3} ; [ DW_TAG_lexical_block ]
!3082 = metadata !{i32 61, i32 10, metadata !3080, null}
!3083 = metadata !{i32 63, i32 7, metadata !3077, null}
!3084 = metadata !{i32 64, i32 4, metadata !3077, null}
!3085 = metadata !{i32 57, i32 61, metadata !3074, null}
!3086 = metadata !{i32 786688, metadata !3075, metadata !"k", metadata !876, i32 50, metadata !979, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3087 = metadata !{i32 65, i32 1, metadata !3075, null}
